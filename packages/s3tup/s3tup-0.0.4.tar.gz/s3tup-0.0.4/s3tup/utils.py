...
def key_diff(before, after):
    ...
    Return a dict representing the difference between two runs of Bucket.get_remote_keys(). Useful to see changes in the keys within a bucket after some operation.
    ...
    Be sure to call list() on the result of get_remote_keys before running this; because it's a generator, it won't actually fetch them from the server until you iterate through it (which, in the example above, would be after the 'after' you're trying to compare to)
    """
