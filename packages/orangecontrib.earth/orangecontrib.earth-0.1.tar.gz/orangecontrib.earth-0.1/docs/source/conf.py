...
extensions = [
    ...
    'sphinx.ext.mathjax', 'sphinx.ext.autosummary', 'numpydoc',
]
...
# Get the project meta info from the setup.py file
dirname = os.path.dirname(__file__)

setup_ast = ast.parse(
    open(os.path.join(dirname, "..", "..", "setup.py")).read(),
    "<source>")


def ast_global_string(tree, name):
    for stmt in tree.body:
        ...
        raise ValueError("Could not extract {0!r} from the ast".format(name))
...
version = ast_global_string(setup_ast, "VERSION")
# version = '0.0.1'
...
intersphinx_mapping = {
    ...
    'Orange': ('http://orange.biolab.si/docs/latest/',
               'http://orange.biolab.si/docs/latest/_objects')
}
