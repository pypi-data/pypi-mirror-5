...
from unice.portlet.mosaique import mosaiqueportlet

from unice.portlet.mosaique.tests.base import TestCase
...
class TestPortlet(TestCase):
    ...
    def test_portlet_type_registered(self):
        portlet = getUtility(
            IPortletType,
            name='unice.portlet.mosaique.MosaiquePortlet')
        self.assertEquals(portlet.addview,
                          'unice.portlet.mosaique.MosaiquePortlet')

    def test_interfaces(self):
        # TODO: Pass any keyword arguments to the Assignment constructor
        portlet = mosaiqueportlet.Assignment()
    ...
    def test_invoke_edit_view(self):
        ...
        mapping['foo'] = mosaiqueportlet.Assignment()
        editview = getMultiAdapter((mapping['foo'], request), name='edit')
        self.failUnless(isinstance(editview, mosaiqueportlet.EditForm))
    ...
    def test_obtain_renderer(self):
        ...
        # TODO: Pass any keyword arguments to the Assignment constructor
        assignment = mosaiqueportlet.Assignment()

        renderer = getMultiAdapter(
            (context, request, view, manager, assignment), IPortletRenderer)
        self.failUnless(isinstance(renderer, mosaiqueportlet.Renderer))
...
class TestRenderer(TestCase):
    ...
    def afterSetUp(self):
        ...
        self.mosaique_tmpl = """<p><a href="%s">Home</a></p>"""
        
        # make a document with some realistic mosaique
        ...
        self.portal['quick-links'].setText(
            self.mosaique_tmpl % self.portal.portal_url())
    ...
    def renderer(self, context=None, request=None, view=None, manager=None,
        ...
        assignment = assignment or mosaiqueportlet.Assignment()
    ...
    def test_render_body(self):
        r = self.renderer(
            context=self.portal,
            assignment=mosaiqueportlet.Assignment(
                mosaique=self.item_url_path[len(self.portal_url_path):],
                item_display=[u'body'],
            )
        )
        ...
        r.update()
        output = r.render()
        self.failUnless(self.mosaique_tmpl % self.portal.portal_url() in output)
    ...
    def test_i18n_render_body(self):
        ...
        ql_german.setText(self.mosaique_tmpl % self.portal.portal_url() + "DE")
        ...
        r.update()
        output = r.render()
        self.failUnless(self.mosaique_tmpl % self.portal.portal_url() + "DE" \
            in output)
