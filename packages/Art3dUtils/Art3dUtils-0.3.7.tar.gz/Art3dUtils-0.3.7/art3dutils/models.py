...
class Entity(object):
    ...
    def fetch_apartments(self, available_only=False, room_count=0):
    ...
    def available_detail(self):
        ...
        result = OrderedDict()
        result['t'] = self.available_total

        result['0'] = len(self.fetch_apartments(available_only=True,
                                                room_count=1))
        result['1'] = len(self.fetch_apartments(available_only=True,
                                                room_count=1))
        result['2'] = len(self.fetch_apartments(available_only=True,
                                                room_count=2))
        result['3'] = len(self.fetch_apartments(available_only=True,
                                                room_count=3))
        result['4'] = len(self.fetch_apartments(available_only=True,
                                                room_count=4))
        result['5'] = len(self.fetch_apartments(available_only=True,
                                                room_count=5))
        return result
