...
class SMTP_SSLHandler(SMTPHandler):
    ...
    def __init__(self, toaddrs, mailhost=None, fromaddr=None,
                 subject='', credentials=None, ssl=False, sender=None, server=None):

        mailhost = mailhost or server.socket
        fromaddr = fromaddr or sender.username
        credentials = credentials or sender.credentials

        SMTPHandler.__init__(self, mailhost, fromaddr,
                             toaddrs, subject, credentials)

        self.ssl = ssl or server.ssl
