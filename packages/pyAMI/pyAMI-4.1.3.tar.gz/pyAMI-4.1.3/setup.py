...
if use_tiny_xslt and os.getenv('PYAMI_NO_TINY_XSLT') not in ('1', 'true'):
    requires.append('tiny_xslt')
...
if afs_install or os.getenv('PYAMI_AFS_INSTALL') in ('1', 'true'):
    #kw['data_files'] = [('/afs/cern.ch/atlas/software/tools/atlasmeta/', ['version.txt'])]
    kw['data_files'].append(('/afs/cern.ch/atlas/software/tools/atlasmeta/', ['version.txt']))
