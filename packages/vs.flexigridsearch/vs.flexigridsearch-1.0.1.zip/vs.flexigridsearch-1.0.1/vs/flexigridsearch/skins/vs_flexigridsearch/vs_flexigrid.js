...
(function ($) {
	$.addFlex = function (t, p) {
		...
		p = $.extend({ //apply default properties
			...
			rpOptions: [10, 15, 20, 30, 50, 100, 250], //allowed per-page values 
			title: false,
		...
		var g = {
			...
			populate: function () { //get latest data
                ...
                /* added by avung 
                 * Inject SearchableText value into AJAX query
                 */

                var searchabletext = $('#SearchableText').val()
                param.push({name: 'SearchableText', value: searchabletext});
