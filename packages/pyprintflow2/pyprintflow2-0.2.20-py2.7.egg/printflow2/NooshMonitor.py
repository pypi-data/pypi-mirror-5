...
class NooshMonitor(pyinotify.ProcessEvent):
    ...
    def start(self):
        while self.ready:
            try:
                ...
                print 'done checking projects, about to save workgroup data with timie: "+this_check_time'
                if ok:
                    self.theWorkgroup['last_check'] = this_check_time
                    print 'here we go saving the workgroup with last_check time: '+self.theWorkgroup['last_check']
    ...
    def createDamProjectCategory(self, workgroup, project):
        ...
        print 'COLIN>>>>> project client account: '+project['client_account']
