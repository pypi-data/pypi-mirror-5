plotly
------
Plotly (https://plot.ly) is a web-application that creates interactive and publication quality plots all inside your browser. This API allows Python users to generate Plotly graphs from their Plotly environment.
