...
from pymstache.common import TemplateNotFoundError, client
...
class Locator(object):
    ...
    def _find_path(self, search_dirs, file_name, db='__main', collection='template'):
        """
        ...
        for dir_path in search_dirs:
            ...
            if client[db][collection].find_one({"path": file_path}):
                return file_path
