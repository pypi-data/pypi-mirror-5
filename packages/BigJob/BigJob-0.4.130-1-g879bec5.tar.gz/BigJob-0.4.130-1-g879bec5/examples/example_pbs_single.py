...
def main():
    ...
    queue="workq" # if None default queue is used
    project="loni_nkim_bio" # if None default allocation is used 
    walltime=10
    processes_per_node=8
    number_of_processes = 8
    #workingdirectory=os.path.join(os.getcwd(), "agent")  # working directory for agent
    #workingdirectory="agent"
    workingdirectory="/home/luckow/src/BigJob/examples/agent"
    ...
    """
    lrms_url = "pbs+ssh://qb3.loni.org" # resource url to run the jobs on localhost
