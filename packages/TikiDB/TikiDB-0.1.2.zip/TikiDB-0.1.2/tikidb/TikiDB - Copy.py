...
class Record(Persistent):
    """
    this is the base record class to be used as an object in the database.
    to use it subclass the other object with the data fields by using
    super(NewSubclass,self).__init__()

    """
    def __init__(self):
        self.objIsTikiRecord = True
        self.obj_id = ''
        self.data = {}
...
class DB(object):
    def __init__(self,db_name):
        ...
        self.valid_data_types = OOSet(('text','numeric','decimal','list','dict',
                                       'record'))
