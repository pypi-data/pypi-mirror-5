...
InfosDict = {
    ...
    'backup-block-size':            'Maximum block size in bytes when doing a backup.',
    ...
    'transport-cspace-key-id':      'CSpace provides a platform for secure, decentralized, user-to-user communication over the internet.<br>Go to <a href="https://code.google.com/p/cspace/" target=_blank>https://code.google.com/p/cspace/</a> for more details.<br>Enter your CSpace user id here.',
    'transport-cspace-username':    'CSpace provides a platform for secure, decentralized, user-to-user communication over the internet.<br>Go to <a href="https://code.google.com/p/cspace/" target=_blank>https://code.google.com/p/cspace/</a> for more details.<br>Enter your CSpace user name here.',
    'transport-cspace-password':    'CSpace provides a platform for secure, decentralized, user-to-user communication over the internet.<br>Go to <a href="https://code.google.com/p/cspace/" target=_blank>https://code.google.com/p/cspace/</a> for more details.<br>Enter your CSpace password here.',
...
LabelsDict = {
    ...
    'transport-cspace-username':            'CSpace user name',
    'transport-cspace-password':            'CSpace user password',
    'logs':                                 'logs',
...
6
 ...
 <transport>
  ...
  <transport-cspace>
   ...
   <transport-cspace-username>

   </transport-cspace-username>
   <transport-cspace-password>
