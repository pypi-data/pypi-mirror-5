...
class MVPolyCube(mvpoly.base.MVPoly) :
    ...
    def homdeg(self) :
        ...
        return np.max([sum(t) for t in zip(*nzis)])
    ...
    def int(self, *args) :
        ...
        as for :meth:`diff`.
        """
        return MVPolyCube(mvpoly.util.cube.int(self.coef, args))

    def maxmodnb(self, *args) :
        """
        ...
        """
        return mvpoly.util.cube.maxmodnb(self.coef, *args)
