...
application_version = "0.0.2"  #: The current version of the application.

application_description = "A TV series browser and tracker application."  #: A short description of the application.

application_url = "http://code.google.com/p/seriesmarker/"  #: The project-website of the application.
