...
# - a sequence of (_VarData, probability) pairs for each scenario instance at this node.
...
def scenario_tree_node_variables_generator(scenario_tree, includeDerivedVariables=True, includeLastStage=True):
    ...
    for stage in stages_to_iterate:
        ...
        for tree_node in stage._tree_nodes:
            ...
            for variable_id, variable_datas in iteritems(tree_node._variable_datas):
                ...
                yield stage, tree_node, variable_id, variable_datas, is_fixed, is_stale
