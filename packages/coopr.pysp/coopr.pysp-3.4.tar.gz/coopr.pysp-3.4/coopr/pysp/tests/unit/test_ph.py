...
class TestPH(unittest.TestCase):
    ...
    def test_farmer_maximize_quadratic_gurobi(self):
        ...
        instance_dir = farmer_examples_dir + os.sep + "scenariodata"
        argstring = "runph --verbose --solver=gurobi --solver-manager=serial --model-directory="+model_dir+" --instance-directory="+instance_dir+" -o max"
        print("Testing command: " + argstring)
    ...
    def test_linearized_farmer_maximize_cplex(self):
        ...
        model_dir = farmer_examples_dir + os.sep + "maxmodels"
        instance_dir = farmer_examples_dir + os.sep + "scenariodata"
        argstring = "runph --solver="+solver_string+" --solver-manager=serial --model-directory="+model_dir+" --instance-directory="+instance_dir+" -o max --linearize-nonbinary-penalty-terms=10"
        print("Testing command: " + argstring)
    ...
    def test_sizes10_quadratic_twobundles_cplex(self):
        ...
        pyutilib.misc.reset_redirect()
        self.cleanup()
        self.assertFileEqualsBaseline(this_test_file_directory+"sizes10_quadratic_twobundles_cplex.out",this_test_file_directory+"sizes10_quadratic_twobundles_cplex.baseline", filter=filter_time_and_data_dirs, tolerance=1e-5)            
    ...
    def test_farmer_ef_with_solve_cplex_with_csv_writer(self):
        ...
        argstring = "runef --verbose --model-directory="+model_dir+" --instance-directory="+instance_dir+" --output-file="+ef_output_file+" --solver=cplex --solve --solution-writer=coopr.pysp.csvsolutionwriter"
        print("Testing command: " + argstring)
    ...
    def test_sizes3_ef_with_solve_cplex(self):
        ...
        if os.sys.platform == "darwin":
            ...
            self.assertFileEqualsBaseline(this_test_file_directory+"sizes3_ef_with_solve_cplex.out",this_test_file_directory+"sizes3_ef_with_solve_cplex.baseline", filter=filter_time_and_data_dirs, tolerance=1e-4)                
    ...
    def test_cc_ef_networkflow1ef3_cplex(self):
        ...
        pyutilib.misc.reset_redirect()
        self.cleanup()
        self.assertFileEqualsBaseline(this_test_file_directory+"cc_ef_networkflow1ef3_cplex.out",this_test_file_directory+"cc_ef_networkflow1ef3_cplex.baseline", filter=filter_time_and_data_dirs, tolerance=1e-5)
    ...
    def test_lagrangian_cc_networkflow1ef3_cplex(self):
        ...
        model_dir = networkflow_example_dir + os.sep + "models-cc"
        instance_dir = networkflow_example_dir + os.sep + "1ef3-cc"
        argstring = "drive_lagrangian_cc.py --solver=cplex --model-directory="+model_dir+" --instance-directory="+instance_dir+ \
                    " --alpha-min=0.5" + \
                    " --alpha-max=0.5" + \
    ...
    def test_lagrangian_param_1cc_networkflow1ef3_cplex(self):
        ...
        model_dir = networkflow_example_dir + os.sep + "models-cc"
        instance_dir = networkflow_example_dir + os.sep + "1ef3-cc"
        argstring = "lagrangeParam.py --solver=cplex --model-directory="+model_dir+" --instance-directory="+instance_dir
        print("Testing command: " + argstring)
        args = argstring.split()
        ...
        pyutilib.misc.reset_redirect()
        self.cleanup()
        self.assertFileEqualsBaseline(this_test_file_directory+"lagrangian_param_1cc_networkflow1ef3_cplex.out",this_test_file_directory+"lagrangian_param_1cc_networkflow1ef3_cplex.baseline", filter=filter_time_and_data_dirs, tolerance=1e-5)
    ...
    def test_lagrangian_morepr_1cc_networkflow1ef3_cplex(self):
        ...
        model_dir = networkflow_example_dir + os.sep + "models-cc"
        instance_dir = networkflow_example_dir + os.sep + "1ef3-cc"
        argstring = "lagrangeMorePR.py --solver=cplex --model-directory="+model_dir+" --instance-directory="+instance_dir+" --csvPrefix=lagrange_pr_test"
        print("Testing command: " + argstring)
        args = argstring.split()
        ...
        pyutilib.misc.reset_redirect()
        self.cleanup()
        self.assertFileEqualsBaseline(this_test_file_directory+"lagrangian_morepr_1cc_networkflow1ef3_cplex.out",this_test_file_directory+"lagrangian_morepr_1cc_networkflow1ef3_cplex.baseline", filter=filter_time_and_data_dirs, tolerance=1e-5)
...
class TestPHParallel(unittest.TestCase):
    ...
    def test_farmer_quadratic_cplex_with_phpyro(self):
        ...
        model_dir = farmer_examples_dir + os.sep + "models"
        instance_dir = farmer_examples_dir + os.sep + "scenariodata"
        argstring = "mpirun -np 1 coopr_ns : -np 1 dispatch_srvr : -np 3 phsolverserver : -np 1 runph --solver=cplex --solver-manager=phpyro --shutdown-pyro --model-directory="+model_dir+" --instance-directory="+instance_dir+" >& "+this_test_file_directory+"farmer_quadratic_cplex_with_phpyro.out"
        print("Testing command: " + argstring)
    ...
    def test_farmer_quadratic_gurobi_with_phpyro(self):
        ...
        model_dir = farmer_examples_dir + os.sep + "models"
        instance_dir = farmer_examples_dir + os.sep + "scenariodata"
        argstring = "mpirun -np 1 coopr_ns : -np 1 dispatch_srvr : -np 3 phsolverserver : -np 1 runph --solver=gurobi --solver-manager=phpyro --shutdown-pyro --model-directory="+model_dir+" --instance-directory="+instance_dir+" >& "+this_test_file_directory+"farmer_quadratic_gurobi_with_phpyro.out"
        print("Testing command: " + argstring)
    ...
    def test_farmer_linearized_gurobi_with_phpyro(self):
        ...
        model_dir = farmer_examples_dir + os.sep + "models"
        instance_dir = farmer_examples_dir + os.sep + "scenariodata"
        argstring = "mpirun -np 1 coopr_ns : -np 1 dispatch_srvr : -np 3 phsolverserver : -np 1 runph --linearize-nonbinary-penalty-terms=10 --solver=gurobi --solver-manager=phpyro --shutdown-pyro --model-directory="+model_dir+" --instance-directory="+instance_dir+" >& "+this_test_file_directory+"farmer_linearized_gurobi_with_phpyro.out"
        print("Testing command: " + argstring)
    ...
    def test_farmer_quadratic_ipopt_with_phpyro(self):
        ...
        model_dir = farmer_examples_dir + os.sep + "models"
        instance_dir = farmer_examples_dir + os.sep + "scenariodata"
        argstring = "mpirun -np 1 coopr_ns : -np 1 dispatch_srvr : -np 3 phsolverserver : -np 1 runph --solver=ipopt --solver-manager=phpyro --shutdown-pyro --model-directory="+model_dir+" --instance-directory="+instance_dir+" >& "+this_test_file_directory+"farmer_quadratic_ipopt_with_phpyro.out"
        print("Testing command: " + argstring)
    ...
    def test_farmer_linearized_ipopt_with_phpyro(self):
        ...
        model_dir = farmer_examples_dir + os.sep + "models"
        instance_dir = farmer_examples_dir + os.sep + "scenariodata"
        argstring = "mpirun -np 1 coopr_ns : -np 1 dispatch_srvr : -np 3 phsolverserver : -np 1 runph --linearize-nonbinary-penalty-terms=10 --solver=ipopt --solver-manager=phpyro --shutdown-pyro --model-directory="+model_dir+" --instance-directory="+instance_dir+" >& "+this_test_file_directory+"farmer_linearized_ipopt_with_phpyro.out"
        print("Testing command: " + argstring)
    ...
    def test_farmer_quadratic_trivial_bundling_ipopt_with_phpyro(self):
        ...
        model_dir = farmer_examples_dir + os.sep + "models"
        instance_dir = farmer_examples_dir + os.sep + "scenariodataWithTrivialBundles"
        argstring = "mpirun -np 1 coopr_ns : -np 1 dispatch_srvr : -np 3 phsolverserver : -np 1 runph --solver=ipopt --solver-manager=phpyro --shutdown-pyro --model-directory="+model_dir+" --instance-directory="+instance_dir+" >& "+this_test_file_directory+"farmer_quadratic_trivial_bundling_ipopt_with_phpyro.out"
        print("Testing command: " + argstring)
    ...
    def test_farmer_quadratic_bundling_ipopt_with_phpyro(self):
        ...
        model_dir = farmer_examples_dir + os.sep + "models"
        instance_dir = farmer_examples_dir + os.sep + "scenariodataWithTwoBundles"
        argstring = "mpirun -np 1 coopr_ns : -np 1 dispatch_srvr : -np 2 phsolverserver : -np 1 runph --solver=ipopt --solver-manager=phpyro --shutdown-pyro --model-directory="+model_dir+" --instance-directory="+instance_dir+" >& "+this_test_file_directory+"farmer_quadratic_bundling_ipopt_with_phpyro.out"
        print("Testing command: " + argstring)
    ...
    def test_quadratic_sizes3_cplex_with_phpyro(self):
        ...
        argstring = "mpirun -np 1 coopr_ns : -np 1 dispatch_srvr : -np 3 phsolverserver : " + \
                    " -np 1 runph --solver=cplex --solver-manager=phpyro --shutdown-pyro --model-directory="+model_dir+" --instance-directory="+instance_dir+ \
                    " --max-iterations=40"+ \
                    " --rho-cfgfile="+sizes_example_dir+os.sep+"config"+os.sep+"rhosetter.cfg"+ \
                    " --scenario-solver-options=mip_tolerances_integrality=1e-7"+ \
                    " --enable-ww-extensions"+ \
    ...
    def test_quadratic_sizes3_gurobi_with_phpyro(self):
        ...
        instance_dir = sizes_example_dir + os.sep + "SIZES3"        
        argstring = "mpirun -np 1 coopr_ns : -np 1 dispatch_srvr : -np 3 phsolverserver : " + \
                    " -np 1 runph --solver=gurobi --solver-manager=phpyro --shutdown-pyro --model-directory="+model_dir+" --instance-directory="+instance_dir+ \
                    " --max-iterations=40"+ \
                    " --rho-cfgfile="+sizes_example_dir+os.sep+"config"+os.sep+"rhosetter.cfg"+ \
                    " --scenario-solver-options=mip_tolerances_integrality=1e-7"+ \
                    " --enable-ww-extensions"+ \
        ...
        if os.sys.platform == "darwin":
            [flag_a,lineno_a,diffs_a] = pyutilib.misc.compare_file(this_test_file_directory+"sizes3_quadratic_gurobi_with_phpyro.out", this_test_file_directory+"sizes3_quadratic_gurobi_with_phpyro_darwin.baseline-a", filter=filter_time_and_data_dirs, tolerance=1e-5)
            # TBD: We should see different baselines here (on darwin)        
            if (flag_a):
                self.fail("Differences identified relative to all baseline output file alternatives")               
        else:
            [flag_a,lineno_a,diffs_a] = pyutilib.misc.compare_file(this_test_file_directory+"sizes3_quadratic_gurobi_with_phpyro.out", this_test_file_directory+"sizes3_quadratic_gurobi_with_phpyro.baseline-a", filter=filter_time_and_data_dirs, tolerance=1e-5)
            [flag_b,lineno_b,diffs_b] = pyutilib.misc.compare_file(this_test_file_directory+"sizes3_quadratic_gurobi_with_phpyro.out", this_test_file_directory+"sizes3_quadratic_gurobi_with_phpyro.baseline-b", filter=filter_time_and_data_dirs, tolerance=1e-5)
            if (flag_a) and (flag_b):
                self.fail("Differences identified relative to all baseline output file alternatives")               
    ...
    def test_farmer_quadratic_async_ipopt_with_pyro(self):
        ...
        model_dir = farmer_examples_dir + os.sep + "models"
        instance_dir = farmer_examples_dir + os.sep + "scenariodata"
        argstring = "mpirun -np 1 coopr_ns : -np 1 dispatch_srvr : -np 1 pyro_mip_server : -np 1 runph --solver=ipopt --solver-manager=pyro --shutdown-pyro --model-directory="+model_dir+" --instance-directory="+instance_dir+" >& "+this_test_file_directory+"farmer_quadratic_async_ipopt_with_pyro.out"
        print("Testing command: " + argstring)
    ...
    def test_farmer_quadratic_async_gurobi_with_pyro(self):
        ...
        model_dir = farmer_examples_dir + os.sep + "models"
        instance_dir = farmer_examples_dir + os.sep + "scenariodata"
        argstring = "mpirun -np 1 coopr_ns : -np 1 dispatch_srvr : -np 1 pyro_mip_server : -np 1 runph --solver=gurobi --solver-manager=pyro --shutdown-pyro --model-directory="+model_dir+" --instance-directory="+instance_dir+" >& "+this_test_file_directory+"farmer_quadratic_async_gurobi_with_pyro.out"
        print("Testing command: " + argstring)
    ...
    def test_farmer_linearized_async_gurobi_with_pyro(self):
        ...
        model_dir = farmer_examples_dir + os.sep + "models"
        instance_dir = farmer_examples_dir + os.sep + "scenariodata"
        argstring = "mpirun -np 1 coopr_ns : -np 1 dispatch_srvr : -np 1 pyro_mip_server : -np 1 runph --solver=gurobi --solver-manager=pyro --shutdown-pyro --model-directory="+model_dir+" --instance-directory="+instance_dir+" --linearize-nonbinary-penalty-terms=10  "+" >& "+this_test_file_directory+"farmer_linearized_async_gurobi_with_pyro.out"
        print("Testing command: " + argstring)
    ...
    def test_farmer_linearized_async_ipopt_with_pyro(self):
        ...
        model_dir = farmer_examples_dir + os.sep + "models"
        instance_dir = farmer_examples_dir + os.sep + "scenariodata"
        argstring = "mpirun -np 1 coopr_ns : -np 1 dispatch_srvr : -np 1 pyro_mip_server : -np 1 runph --solver=ipopt --solver-manager=pyro --shutdown-pyro --model-directory="+model_dir+" --instance-directory="+instance_dir+" --linearize-nonbinary-penalty-terms=10  "+" >& "+this_test_file_directory+"farmer_linearized_async_ipopt_with_pyro.out"
