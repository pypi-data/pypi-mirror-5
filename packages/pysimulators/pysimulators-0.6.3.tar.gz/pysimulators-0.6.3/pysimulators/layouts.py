...
class LayoutGrid(Layout):
    ...
    index : array-like of int, optional
        ...
        def center():
            out = create_grid(
                self.shape, self.spacing, xreflection=self.layout_xreflection,
                yreflection=self.layout_yreflection, center=self.layout_center,
                angle=self.layout_angle)
            if self._unit:
        ...
        self.layout_center = layout_center
        self.layout_xreflection = xreflection
        self.layout_yreflection = yreflection
        self.layout_angle = angle
        self._unit = unit
    ...
    index : array-like of int, optional
        ...
        def vertex():
            out = create_grid_squares(
                ...
                xreflection=self.layout_xreflection,
                yreflection=self.layout_yreflection, center=self.layout_center,
                angle=self.layout_angle)
            if self._unit:
                out = Quantity(out, self._unit, copy=False)
