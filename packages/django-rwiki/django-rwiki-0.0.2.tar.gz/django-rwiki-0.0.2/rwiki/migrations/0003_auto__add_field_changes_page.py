...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Changes.page'
        db.add_column('rwiki_changes', 'page',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='page_from', to=orm['rwiki.Page']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Changes.page'
        db.delete_column('rwiki_changes', 'page_id')
    ...
    models = {
        ...
        'rwiki.page': {
            ...
            'category': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'category_from'", 'to': "orm['rwiki.Category']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
