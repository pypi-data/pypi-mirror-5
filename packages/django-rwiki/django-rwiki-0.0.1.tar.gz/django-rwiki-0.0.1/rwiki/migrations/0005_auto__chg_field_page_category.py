...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('rwiki_page', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['categories.Category'], null=True))

    def backwards(self, orm):

        # Changing field 'Page.category'
        db.alter_column('rwiki_page', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['categories.Category']))
