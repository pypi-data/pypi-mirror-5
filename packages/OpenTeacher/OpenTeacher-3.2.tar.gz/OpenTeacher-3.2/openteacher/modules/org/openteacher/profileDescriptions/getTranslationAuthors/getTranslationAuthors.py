...
class ProfileDescriptionModule(object):
	...
	def enable(self):
		if len(set(self._mm.mods(type="getTranslationAuthors"))) == 0: # pragma: no cover
			return #remain inactive

		self.desc = {
			"name": "get-translation-authors",
			"niceName": "Gathers a list of all translators of OpenTeacher in Python code format.",
			"advanced": True,
		}
