...
class ProfileDescriptionModule(object):
	def __init__(self, moduleManager, *args, **kwargs):
		...
		self.filesWithTranslations = ("help.py",)
	...
	def _retranslate(self):
		...
		self.desc = {
			"name": "help",
			"niceName": _("Shows an overview of all documented available profiles"),
			"advanced": True,
		}

	def enable(self):
		if len(set(self._mm.mods(type="profilesHelp"))) == 0: # pragma: no cover
