...
from pyage.core.statistics import   NotificationStatistics
...
aggregated_agents = lambda: float_emas_initializer(40, energy=100, size=100, lowerbound=-10, upperbound=10)
