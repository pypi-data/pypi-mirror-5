...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Release.comment_text'
        db.alter_column(u'pypi_release', 'comment_text', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'Release.comment_text'
        db.alter_column(u'pypi_release', 'comment_text', self.gf('django.db.models.fields.CharField')(max_length=100))
