...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Release.packagetype'
        db.alter_column(u'pypi_release', 'packagetype', self.gf('django.db.models.fields.CharField')(max_length=13))

    def backwards(self, orm):

        # Changing field 'Release.packagetype'
        db.alter_column(u'pypi_release', 'packagetype', self.gf('django.db.models.fields.CharField')(max_length=9))
