...
#templates = []
#for root, dirnames, filenames in os.walk("src/admin_timeline/templates/admin_timeline"):
#    templates.extend(glob.glob(root + "/*.*"))

#static_files = []
#for root, dirnames, filenames in os.walk("src/admin_timeline/static"):
#    static_files.extend(glob.glob(root + "/*.*"))
