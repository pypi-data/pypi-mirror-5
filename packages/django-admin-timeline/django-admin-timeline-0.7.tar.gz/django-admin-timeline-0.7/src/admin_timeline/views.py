...
from admin_timeline.settings import NUMBER_OF_ENTRIES_PER_PAGE, SINGLE_LOG_ENTRY_DATE_FORMAT, ENABLE_USER_FILTER
from admin_timeline.settings import LOG_ENTRIES_DAY_HEADINGS_DATE_FORMAT, ENABLE_CONTENT_TYPE_FILTER
