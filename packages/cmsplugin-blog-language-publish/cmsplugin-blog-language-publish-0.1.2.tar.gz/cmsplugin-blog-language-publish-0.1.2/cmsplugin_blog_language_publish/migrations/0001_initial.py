...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('cmsplugin_blog_language_publish_entrylanguagepublish', (
            ...
            ('entry_title', self.gf('django.db.models.fields.related.OneToOneField')(related_name='is_published', unique=True, to=orm['cmsplugin_blog.EntryTitle'])),
    ...
    models = {
        ...
        'cmsplugin_blog_language_publish.entrylanguagepublish': {
            'Meta': {'object_name': 'EntryLanguagePublish'},
            'entry_title': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'is_published'", 'unique': 'True', 'to': "orm['cmsplugin_blog.EntryTitle']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_published': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
