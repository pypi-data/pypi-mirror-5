...
diags_dict['[OI] 5579/6302'] = ('O1', 'L(5579)/L(6300)', 'RMS([E(6300), E(5579)])')
diags_dict['[OI] 5579/6300'] = ('O1', 'L(5579)/L(6300)', 'RMS([E(6300), E(5579)])')
diags_dict['[OI] 5579/6300+'] = ('O1', 'L(5579)/(L(6300)+L(6364))', 'RMS([E(6300)*L(6300)/(L(6300)+L(6364)), E(6364)*L(6364)/(L(6300)+L(6364)), E(5579)])')
...
#                    self.addDiag(label, diag_tuple, atom, subrange)
    ...
    def getCrossTemDen(self, diag_tem, diag_den, value_tem=None, value_den=None, obs=None, i_obs=None,
        ...
        - i_obs      indice of the observations to be used from obs. 
