...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MultimediaFile.miniature'
        db.add_column('chimere_multimediafile', 'miniature', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MultimediaFile.miniature'
        db.delete_column('chimere_multimediafile', 'miniature')
