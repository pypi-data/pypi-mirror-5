...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PictureFile.thumbnailfile'
        db.add_column('chimere_picturefile', 'thumbnailfile',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PictureFile.thumbnailfile_height'
        db.add_column('chimere_picturefile', 'thumbnailfile_height',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PictureFile.thumbnailfile_width'
        db.add_column('chimere_picturefile', 'thumbnailfile_width',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'PictureFile.thumbnailfile'
        db.delete_column('chimere_picturefile', 'thumbnailfile')

        # Deleting field 'PictureFile.thumbnailfile_height'
        db.delete_column('chimere_picturefile', 'thumbnailfile_height')

        # Deleting field 'PictureFile.thumbnailfile_width'
        db.delete_column('chimere_picturefile', 'thumbnailfile_width')
