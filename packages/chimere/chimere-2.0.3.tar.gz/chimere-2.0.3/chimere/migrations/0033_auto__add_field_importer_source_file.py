...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Importer.source_file'
        db.add_column('chimere_importer', 'source_file',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Importer.source_file'
        db.delete_column('chimere_importer', 'source_file')
