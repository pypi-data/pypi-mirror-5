...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MultimediaFile.marker'
        db.add_column('chimere_multimediafile', 'marker', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='multimedia_files2', null=True, to=orm['chimere.Marker']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'PictureFile.marker'
        db.delete_column('chimere_picturefile', 'marker_id')

        # Deleting field 'MultimediaFile.marker'
        db.delete_column('chimere_multimediafile', 'marker_id')

        # Deleting field 'Area.default'
        db.delete_column('chimere_area', 'default')

        # Adding field 'Marker.available_date'
        db.add_column('chimere_marker', 'available_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)
    ...
    models = {
        ...
        'chimere.marker': {
            ...
            'multimedia_files': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'marker2'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['chimere.MultimediaFile']"}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '150'}),
            'pictures': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'marker2'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['chimere.PictureFile']"}),
        ...
        'chimere.multimediafile': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'marker': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'multimedia_files2'", 'null': 'True', 'to': "orm['chimere.Marker']"}),
        ...
        'chimere.picturefile': {
            ...
            'height': ('django.db.models.fields.IntegerField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'marker': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'pictures2'", 'null': 'True', 'to': "orm['chimere.Marker']"}),
            'miniature': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '150'}),
            'order': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
