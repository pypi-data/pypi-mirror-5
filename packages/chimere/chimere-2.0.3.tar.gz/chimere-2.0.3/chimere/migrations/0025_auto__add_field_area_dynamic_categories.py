...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Area.dynamic_categories'
        db.add_column('chimere_area', 'dynamic_categories',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Area.dynamic_categories'
        db.delete_column('chimere_area', 'dynamic_categories')
