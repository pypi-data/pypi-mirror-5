...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Area.welcome_message'
        db.add_column('chimere_area', 'welcome_message', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Changing field 'Layer.layer_code'
        db.alter_column('chimere_layer', 'layer_code', self.gf('django.db.models.fields.CharField')(max_length=300))

        # Deleting field 'Area.welcome_message'
        db.delete_column('chimere_area', 'welcome_message')
    ...
    models = {
        ...
        'chimere.subcategory': {
            ...
            'areas': ('chimere.widgets.SelectMultipleField', [], {'symmetrical': 'False', 'related_name': "'subcategories'", 'blank': 'True', 'to': "orm['chimere.Area']"}),
            'available': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
