...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Area.restrict_to_extent'
        db.add_column('chimere_area', 'restrict_to_extent', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Area.restrict_to_extent'
        db.delete_column('chimere_area', 'restrict_to_extent')
