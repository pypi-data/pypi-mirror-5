...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('chimere_importer', (
            ...
            ('source_url', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
        ...
        # Adding field 'Route.import_key'
        db.add_column('chimere_route', 'import_key', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'Marker.import_key'
        db.add_column('chimere_marker', 'import_key', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Route.import_key'
        db.delete_column('chimere_route', 'import_key')

        # Deleting field 'Marker.import_key'
        db.delete_column('chimere_marker', 'import_key')
