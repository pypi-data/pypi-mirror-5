...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Area.external_css'
        db.add_column('chimere_area', 'external_css', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Area.external_css'
        db.delete_column('chimere_area', 'external_css')
