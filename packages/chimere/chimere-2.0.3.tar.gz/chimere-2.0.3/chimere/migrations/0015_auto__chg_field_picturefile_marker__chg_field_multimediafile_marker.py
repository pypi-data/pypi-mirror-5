...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('chimere_picturefile', 'marker_id', self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['chimere.Marker']))

        # Changing field 'MultimediaFile.marker'
        db.alter_column('chimere_multimediafile', 'marker_id', self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['chimere.Marker']))
    ...
    def backwards(self, orm):
        ...
        db.create_table('chimere_marker_pictures', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('marker', models.ForeignKey(orm['chimere.marker'], null=False)),
            ('picturefile', models.ForeignKey(orm['chimere.picturefile'], null=False))
        ))
        db.create_unique('chimere_marker_pictures', ['marker_id', 'picturefile_id'])
