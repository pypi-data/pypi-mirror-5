...
(function() {
  ...
  mainApp.controller('ConsoleCtlr', [
    '$scope', '$location', '$route', '$q', '$templateCache', 'Configuration', 'AppData', 'AppPref', 'Item', 'Itemizer', 'Minioner', 'Resulter', 'Jobber', 'Runner', 'Wheeler', 'Commander', 'Pagerage', 'SaltApiSrvc', 'SaltApiEvtSrvc', 'SessionStore', function($scope, $location, $route, $q, $templateCache, Configuration, AppData, AppPref, Item, Itemizer, Minioner, Resulter, Jobber, Runner, Wheeler, Commander, Pagerage, SaltApiSrvc, SaltApiEvtSrvc, SessionStore) {
