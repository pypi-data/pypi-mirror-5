...
from coopr.pyomo.base.intrinsic_functions import \
...
class Expression_EvaluateNumericConstant(unittest.TestCase):
    ...
    def value_test(self, exp, val, expectExpression=None):
        ...
        self.assertEqual(isinstance(exp,_ExpressionBase), expectExpression)
    ...
    def relation_test(self, exp, val, expectConstExpression=None):
        ...
        self.assertTrue(isinstance(exp, _ExpressionBase))
...
class Expression_EvaluateVarData(Expression_EvaluateNumericConstant):
    ...
    def create(self,val,domain):
        tmp=coopr.pyomo.base.var._VarData(None, domain)
        tmp.value=val
        return tmp
...
class PrettyPrinter_oldStyle(pyutilib.th.TestCase):
    _save = None
...
class PrettyPrinter_newStyle(pyutilib.th.TestCase):
    _save = None
...
class CloneIfNeeded(pyutilib.th.TestCase):
    ...
    def test_intrinsic_UNREFERENCED_EXPR_COUNT(self):
        try:
            ...
            TrapRefCount.inst.saved_fcn = coopr.pyomo.base.intrinsic_functions._generate_intrinsic_function_expression__clone_if_needed
            coopr.pyomo.base.intrinsic_functions._generate_intrinsic_function_expression__clone_if_needed= TrapRefCount_fcn
            ...
            coopr.pyomo.base.intrinsic_functions._generate_intrinsic_function_expression__clone_if_needed = TrapRefCount.inst.saved_fcn
            TrapRefCount.inst = None
