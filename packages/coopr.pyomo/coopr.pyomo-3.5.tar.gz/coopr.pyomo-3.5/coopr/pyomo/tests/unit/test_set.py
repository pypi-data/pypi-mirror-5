...
class SimpleSetA(PyomoModel):
    ...
    def test_iterator(self):
        ...
        for val in self.instance.A:
            self.tmp.add(val)
        self.assertFalse( self.tmp != self.instance.A.data(), "Set values found by the iterator appear to be different from the underlying set")
    ...
    def test_and(self):
        ...
        self.instance.tmp = self.instance.A & self.instance.tmpset3
        self.instance.tmp.construct()
        #print self.instance.tmp.data()
        #print self.instance.setintersection.data()
...
class RealSetTests(SimpleSetA):
    ...
    def test_first(self):
        """Check that we can get the 'first' value in the set"""
        self.assertRaises(TypeError,self.instance.A.first)
...
class SetArgs1(PyomoModel):
    ...
    def test_initialize4(self):
        ...
        self.assertEqual(self.instance.B[0].data(),set([0,1]))
        self.assertEqual(self.instance.B[2].data(),set([2,3]))
    ...
    def test_initialize6(self):
        ...
        self.assertEqual(self.instance.B[0,True].data(),set([0,1]))
        self.assertEqual(self.instance.B[2,True].data(),set([2,3]))
    ...
    def test_initialize7(self):
        ...
        self.assertEqual(self.instance.B[0,1,0,True].data(),set([0,1]))
        self.assertEqual(self.instance.B[2,3,4,True].data(),set([2,3]))
...
class SetArgs2(PyomoModel):
    ...
    def test_other4(self):
        ...
        self.model.B = Set(self.model.Z, rule=tmp_init, within=Integers)
        try:
            self.instance = self.model.create()
        except ValueError:
            pass
...
class SetErrors(PyomoModel):
    ...
    def test_membership(self):
        ...
        self.assertEqual( True in Integers, False)
        self.assertEqual( False in Integers, False)
        ...
        self.assertEqual( True in Reals, False)
        self.assertEqual( False in Reals, False)
    ...
    def test_verify(self):
        ...
        try:
            ...
            pass
        self.assertEqual(b._verify(4,False),False)
        #
        c=Set()
        try:
            c._verify( (1,2) )
            ...
            pass
        self.assertEqual(c._verify( (1,2),False),False)
        #
        c=Set(dimen=2)
        try:
            c._verify( (1,2,3) )
            ...
            pass
        self.assertEqual(c._verify( (1,2,3),False),False)
