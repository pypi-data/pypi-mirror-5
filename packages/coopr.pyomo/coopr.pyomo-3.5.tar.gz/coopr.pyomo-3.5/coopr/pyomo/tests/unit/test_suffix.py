...
class TestSuffixMethods(unittest.TestCase):
    ...
    def test_setValue_getValue_Var(self):
        ...
        self.assertEqual(model.junk.getValue(model.X[1]), 2.0)
        ...
        self.assertEqual(model.junk.getValue(model.X), None)
        self.assertEqual(model.junk.getValue(model.X[1]), 2.0)
        self.assertEqual(model.junk.getValue(model.X[2]), 3.0)
        self.assertEqual(model.junk.getValue(model.x), 3.0)
    ...
    def test_setValue_getValue_Constraint(self):
        ...
        self.assertEqual(model.junk.getValue(model.C[1]), 2.0)
        ...
        self.assertEqual(model.junk.getValue(model.C), None)
        self.assertEqual(model.junk.getValue(model.C[1]), 2.0)
        self.assertEqual(model.junk.getValue(model.C[2]), 3.0)
        self.assertEqual(model.junk.getValue(model.c), 3.0)
    ...
    def test_setValue_getValue_Objective(self):
        ...
        self.assertEqual(model.junk.getValue(model.OBJ[1]), 2.0)
        ...
        self.assertEqual(model.junk.getValue(model.OBJ), None)
        self.assertEqual(model.junk.getValue(model.OBJ[1]), 2.0)
        self.assertEqual(model.junk.getValue(model.OBJ[2]), 3.0)
        self.assertEqual(model.junk.getValue(model.obj), 3.0)

    # test setValue and getValue
    # and if mutable Param arrays are correctly expanded
    def Xtest_setValue_getValue_mutableParam(self):
        model = ConcreteModel()
        model.junk = Suffix()
        model.x = Var()
        model.X = Var([1,2,3])
        ...
        self.assertEqual(model.junk.getValue(model.P), None)
        self.assertEqual(model.junk.getValue(model.P[1]), 2.0)
        ...
        self.assertEqual(model.junk.getValue(model.P), None)
        self.assertEqual(model.junk.getValue(model.P[1]), 2.0)
        self.assertEqual(model.junk.getValue(model.P[2]), 3.0)
        self.assertEqual(model.junk.getValue(model.p), 3.0)

    # test setValue and getValue
    # and if immutable Param arrays are correctly expanded
    def Xtest_setValue_getValue_immutableParam(self):
        model = ConcreteModel()
        model.junk = Suffix()
        model.x = Var()
        model.X = Var([1,2,3])
    ...
    def Xtest_setValue_getValue_Set(self):
        ...
        self.assertEqual(model.junk.getValue(model.S), None)
        self.assertEqual(model.junk.getValue(model.S[1]), 2.0)
        ...
        self.assertEqual(model.junk.getValue(model.S), None)
        self.assertEqual(model.junk.getValue(model.S[1]), 2.0)
        self.assertEqual(model.junk.getValue(model.S[2]), 3.0)
        self.assertEqual(model.junk.getValue(model.s), 3.0)
    ...
    def test_setValue_getValue_Block(self):
        ...
        self.assertEqual(model.junk.getValue(model.B[1]), 2.0)
        ...
        self.assertEqual(model.junk.getValue(model.B), None)
        self.assertEqual(model.junk.getValue(model.B[1]), 2.0)
        self.assertEqual(model.junk.getValue(model.B[2]), 3.0)
        self.assertEqual(model.junk.getValue(model.b), 3.0)
    ...
    def test_clearValue(self):
        ...
        self.assertTrue(model.junk.getValue(model.y) == None)
        self.assertTrue(model.junk.getValue(model.y[1]) == -2.0)
        self.assertEqual(model.junk.getValue(model.y[2]), 1.0)
        self.assertEqual(model.junk.getValue(model.z), None)
        self.assertEqual(model.junk.getValue(model.z[2]), 2.0)
        ...
        self.assertTrue(model.junk.getValue(model.y) is None)
        self.assertTrue(model.junk.getValue(model.y[1]) is None)
        self.assertEqual(model.junk.getValue(model.y[2]), None)
        self.assertEqual(model.junk.getValue(model.z), None)
        self.assertEqual(model.junk.getValue(model.z[2]), 2.0)
        self.assertEqual(model.junk.getValue(model.z[1]), None)
