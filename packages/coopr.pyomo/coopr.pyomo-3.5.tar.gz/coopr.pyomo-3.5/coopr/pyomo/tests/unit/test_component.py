...
class TestComponentUID(unittest.TestCase):
    ...
    def test_genFromComponent_simple(self):
        ...
        self.assertEquals(cuid._cids, (('a',tuple(),''),))
    ...
    def test_printers_1(self):
        ...
        s = 'b[1,2].c.a[3]'
        r = 'b:#1,$2.c.a:#3'
        self.assertEquals(repr(cuid), r)
        self.assertEquals(str(cuid), s)
    ...
    def test_list_components_dne_1(self):
        ...
        self.assertEquals(sorted(cList), sorted(ref))
    ...
    def test_list_components_singleton(self):
        cuid = ComponentUID('b:1,2.c.a:3')
