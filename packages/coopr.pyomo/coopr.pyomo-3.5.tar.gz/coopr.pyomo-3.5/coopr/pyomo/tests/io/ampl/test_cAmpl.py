...
class CAmplBasicTest(unittest.TestCase):
    ...
    def testVar(self):
        ...
        self.assertIsInstance(var_ar, coopr.pyomo.io.ampl.ampl_representation)
    ...
    def testSumExpression(self):
        ...
        self.assertIsInstance(exp_ar, coopr.pyomo.io.ampl.ampl_representation)
    ...
    def testFixedValue(self):
        ...
        self.assertIsInstance(val_ar, coopr.pyomo.io.ampl.ampl_representation)
