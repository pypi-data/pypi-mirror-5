...
from coopr.pyomo.base.var import _VarElement, Var, _VarData
...
from coopr.pyomo.transform.util import partial
from coopr.pyomo.transform.isomorphic_transformation import IsomorphicTransformation
from coopr.pyomo.transform.util import collectAbstractComponents

__all__ = ["NonNegativeTransformation"]
...
class NonNegativeTransformation(IsomorphicTransformation,
    ...
    alias("nonnegative_transform")

    def __init__(self, **kwds):
        kwds["name"] = kwds.pop("name", "nonnegative_transform")
    ...
    def _walk_expr(expr, varMap):
        ...
        # Attempt to replace a singleton variable
