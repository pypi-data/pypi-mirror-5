...
from coopr.pyomo.transform.standard_form import StandardForm
from coopr.pyomo.transform.util import partial, process_canonical_repn

__all__ = ["DualTransformation"]
...
class DualTransformation(IsomorphicTransformation):
    ...
    alias("DualTransformation", "Returns the LP dual of a model.")

    def __init__(self, **kwds):
        kwds['name'] = "dual_transformation"
