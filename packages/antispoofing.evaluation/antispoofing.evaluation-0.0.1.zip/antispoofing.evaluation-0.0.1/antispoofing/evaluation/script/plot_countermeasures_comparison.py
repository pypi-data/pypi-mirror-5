...
def main():
  ...
  if args.demandedplot == 1:
    ...
    for antispoofingalg in ('LBP', 'LBP-TOP-1', 'MOTION', 'ALL'):
      ...
      ax1 = mpl.subplot(111)
      base_dev_cm_file = os.path.join(args.basedir_fvas, args.fusionalg, args.faceverifalg, antispoofingalg, 'licit/scores-dev')
      over_dev_cm_file = os.path.join(args.basedir_fvas, args.fusionalg, args.faceverifalg, antispoofingalg, 'spoof/scores-dev')
      base_test_cm_file = os.path.join(args.basedir_fvas, args.fusionalg, args.faceverifalg, antispoofingalg, 'licit/scores-eval')
      over_test_cm_file = os.path.join(args.basedir_fvas, args.fusionalg, args.faceverifalg, antispoofingalg, 'spoof/scores-eval')
