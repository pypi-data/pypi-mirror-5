...
from nose_extra_tools import assert_equal, assert_is, assert_in, assert_not_in, issues_warnings #@UnresolvedImport
from simple_plugins import AttrDict, PluginMount, CoercionError, PerformanceWarning
...
class TestPluginMount(object):
    ...
    def test_plugin_unregistration(self):
        cls = self.actual_http_response_class
        assert_in(cls, self.HttpResponse.plugins.classes)
        
        cls._unregister_plugin()
        assert_not_in(cls, self.HttpResponse.plugins.classes)
