...
from qmpy.db.custom import NumpyArrayField
...
class DOS(models.Model):
    ...
    Database attributes:
        efermi      : fermi energy (float)
        band_gap    : band gap (float)
        vbm         : valence band minimum (float)
        cbm         : conduction band minimum (float)
        file        : DOSCAR file location (string)
    ...
    data = NumpyArrayField(blank=True, null=True)
    ...
    def save(self, *args, **kwargs):
        super(DOS, self).save(*args, **kwargs)
