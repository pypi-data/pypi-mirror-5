...
import time
import re
from bishop.mako.pygen import PythonPrinter
from bishop.mako import util, ast, parsetree, filters, exceptions
...
class _GenerateRenderMethod(object):
    ...
    def write_toplevel(self):
        ...
        self.printer.writeline("from bishop.mako import runtime, filters, cache")
