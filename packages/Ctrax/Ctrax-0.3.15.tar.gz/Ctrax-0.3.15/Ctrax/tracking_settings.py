...
class TrackingSettings:
    ...
    def InitControlHandles(self):
        ...
        self.checkbox_enforce_minmax_shape = self.control( 'checkbox_enforce_minmax_shape' )
...
##            self.info_text = wx.TextCtrl(self.toolbar, -1, 'Observation Info', size=(300,20),style=wx.TE_READONLY|wx.TE_CENTRE)
    ...
    def InitializeValues(self):
        ...
        self.checkbox_enforce_minmax_shape.SetValue( params.params.enforce_minmax_shape )
    ...
    def BindCallbacks(self):
        ...
        self.frame.Bind( wx.EVT_CHECKBOX, self.OnEnforceCheckbox, self.checkbox_enforce_minmax_shape )
    ...
    def OnEnforceCheckbox( self, evt ):
        params.params.enforce_minmax_shape = self.checkbox_enforce_minmax_shape.GetValue()
