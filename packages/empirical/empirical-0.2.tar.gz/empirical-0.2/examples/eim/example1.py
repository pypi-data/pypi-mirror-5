...
if __name__ == "__main__":
    ...
    params = np.linspace(1, 25, 100).reshape((100, 1))
    ...
    for m in m_eim:
        ...
        mesh_linear = Mesh2D(-1, 1, 1, 25, N=75, M=m, qtype_x='lgl', qtype_y='linear')
        mesh_cc = Mesh2D(-1, 1, 1, 25, N=75, M=m, qtype_x='lgl', qtype_y='cc')
    ...
    plt.figure("Example 1 L2 norms", figsize=(8, 6))
    ...
    plt.savefig("example1_l2_norms.png", dpi=120, pad_inches=0)
    ...
    plt.savefig("example1_basis_functions.png", dpi=120, pad_inches=0)
    ...
    plt.subplot(132)
    plt.plot(points, f(points, 12))
    plt.subplot(133)
    plt.plot(points, f(points, 25))
    plt.savefig("example1_test_function.png", dpi=120, pad_inches=0)
