...
def rangeCaseSelector(range,inst="999"):
	...
	if re.match(r'(%s) (%s) (%s) (%s) (%s)\s*$'%(number_expr,word_expr,number_expr,word_expr,number_expr),range):	#	(+/-)a or (+/-)b to c
		match = re.match(r'(%s) (%s) (%s) (%s) (%s)'%(number_expr,word_expr,number_expr,word_expr,number_expr),range)
		...
		if re.match(r'(%s) (%s) (%s) *(\(M.*) *(\n) *(%s) (%s) (%s)'%(number_expr,word_expr,number_expr,number_expr,word_expr,number_expr),range):				
			...
			result = (5,match)
		elif re.match(r'(%s) (%s) (%s)\s+ (%s) (%s) (%s)\s*$'%(number_expr,word_expr,number_expr,number_expr,word_expr,number_expr),range):
			match = re.match(r'(%s) (%s) (%s)\s+ (%s) (%s) (%s)\s*$'%(number_expr,word_expr,number_expr,number_expr,word_expr,number_expr),range)
