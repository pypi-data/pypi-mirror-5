...
function insertTable() {
    console.log('zopyx.authoring custom table pluging');
	var formObj = document.forms[0];
	var inst = tinyMCEPopup.editor, dom = inst.dom;
	var cols = 2, rows = 2, border = 0, cellpadding = -1, cellspacing = -1, align, width, height, className, caption, frame, rules, overlay;
	var html = '', capEl, elm;
	...
	overlay = formObj.elements['overlay'].checked;
    ...
    if (overlay) 
        className = className + ' display-overlay';
...
function init() {
	...
	if (elm && action != "insert") {
        ...
        overlay = className.indexOf('display-overlay') != -1 ? '1' : '';
        className = className.replace(/display-overlay/g, '');
        ...
        formObj.overlay.checked = overlay;
