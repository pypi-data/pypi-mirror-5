...
APP_INSTALLER = r"""SetOutPath '$INSTDIR\${MUI_PRODUCT}\bin\Python%(PY_VERSION)s\'
    ...
    CreateShortCut '$DESKTOP\${MUI_PRODUCT}.lnk' '"$INSTDIR\${MUI_PRODUCT}\bin\Python%(PY_VERSION)s\pythonw.exe"' '"$INSTDIR\${MUI_PRODUCT}\main.py"' '$INSTDIR\${MUI_PRODUCT}\resources\img\icon.ico'
    """
