...
project = u'Reproducible research example'
import time
...
man_pages = [
    ('index', 'xbob.paper.jmlr2013', u'Bob Reproducible Research article example', [u'Idiap Research Institute'], 1)
]
