...
"""
Script to generate the installer for coopr.dae.
"""
...
setup(name='coopr.dae',
      version='1.1',
      maintainer='John Siirola',
      maintainer_email='jdsiiro@sandia.gov',
      url = 'https://software.sandia.gov/svn/public/coopr/coopr.dae',
      license = 'BSD',
      platforms = ["any"],
      description = 'Differential-Algebraic Equation (DAE) extensions to the Pyomo environment',
