...
class Differential(SingletonBlock):
    """
    ...
    def __init__(self, *args, **kwd):
        ...
        SingletonBlock.__init__(self,**kwd)
    ...
    def construct(self, data=None):
        ...
        if self._dv.dim()==1: 
            ...
            self.add_component('_lhs_var',Var(*self._dv._index_set,bounds=bds,initialize=init))
