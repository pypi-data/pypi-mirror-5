...
class Cookie(object):
    ...
    '/cgi-bin'
    >>> print str(c)
    session_id=abc123;Domain=.example.org;Path=/cgi-bin;Version=1
    """
    attributes = [
        ("Comment", "comment"),
        ("Domain", "domain"),
...
def expire_cookie(cookie_or_name, *args, **kwargs):
    ...
    Synopsis::
        ...
        ...     print view(c.request).get_header('Set-Cookie')
        ...
        X=;Expires=Tue, 01 Jan 1980 00:00:00 -0000;Max-Age=0;Path=/;Version=1
    """
