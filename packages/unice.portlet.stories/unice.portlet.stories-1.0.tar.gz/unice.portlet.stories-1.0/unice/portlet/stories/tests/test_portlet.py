...
from unice.portlet.stories import storiesportlet

from unice.portlet.stories.tests.base import TestCase
...
class TestPortlet(TestCase):
    ...
    def test_portlet_type_registered(self):
        portlet = getUtility(
            IPortletType,
            name='unice.portlet.stories.StoriesPortlet')
        self.assertEquals(portlet.addview,
                          'unice.portlet.stories.StoriesPortlet')

    def test_interfaces(self):
        # TODO: Pass any keyword arguments to the Assignment constructor
        portlet = storiesportlet.Assignment()
    ...
    def test_invoke_edit_view(self):
        ...
        mapping['foo'] = storiesportlet.Assignment()
        editview = getMultiAdapter((mapping['foo'], request), name='edit')
        self.failUnless(isinstance(editview, storiesportlet.EditForm))
    ...
    def test_obtain_renderer(self):
        ...
        # TODO: Pass any keyword arguments to the Assignment constructor
        assignment = storiesportlet.Assignment()

        renderer = getMultiAdapter(
            (context, request, view, manager, assignment), IPortletRenderer)
        self.failUnless(isinstance(renderer, storiesportlet.Renderer))
...
class TestRenderer(TestCase):
    ...
    def afterSetUp(self):
        ...
        self.stories_tmpl = """<p><a href="%s">Home</a></p>"""
        
        # make a document with some realistic stories
        ...
        self.portal['quick-links'].setText(
            self.stories_tmpl % self.portal.portal_url())
    ...
    def renderer(self, context=None, request=None, view=None, manager=None,
        ...
        assignment = assignment or storiesportlet.Assignment()
    ...
    def test_render_body(self):
        r = self.renderer(
            context=self.portal,
            assignment=storiesportlet.Assignment(
                stories=self.item_url_path[len(self.portal_url_path):],
                item_display=[u'body'],
            )
        )
        ...
        r.update()
        output = r.render()
        self.failUnless(self.stories_tmpl % self.portal.portal_url() in output)
    ...
    def test_i18n_render_body(self):
        ...
        ql_german.setText(self.stories_tmpl % self.portal.portal_url() + "DE")
        ...
        r.update()
        output = r.render()
        self.failUnless(self.stories_tmpl % self.portal.portal_url() + "DE" \
            in output)
