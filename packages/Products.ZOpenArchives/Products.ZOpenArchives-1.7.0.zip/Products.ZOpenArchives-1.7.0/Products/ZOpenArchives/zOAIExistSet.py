...
class zOAIExistSet(App.Management.Navigation, SimpleItem, Implicit):
    ...
    def __init__(self,
        ...
        self.setDateTemplate = DATE_TEMPLATE_DEFAULT
    ...
    def initialize(self):
        ...
        if not getattr(self, 'setDateTemplate', False):
            setattr(self, 'setDateTemplate', DATE_TEMPLATE_DEFAULT)
    ...
    def get_setDateTemplate(self):
        """
        """
        return getattr(self, 'setDateTemplate', DATE_TEMPLATE_DEFAULT)
    ...
    def manage_OAIExistSetUpdate(self,
        ...
        self.setDateTemplate = setDateTemplate
