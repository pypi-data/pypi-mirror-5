...
##        zOAIExistRepository.inheritedAttribute("manage_beforeDelete")(self, item, container)
    ...
    def get_GetRecord(self, args={}):
        ...
        if args.has_key('identifier') and args.has_key('metadataPrefix'):
            ...
            my_function = gr_function % {
                ...
                'oai_ns': oai_ns,
                'md_ns': md_ns,
                'dateTemplate': oai_set.get_setDateTemplate() % {
                    'formatDateTime': self.getDatetimeFormatFunctionname(),
    ...
    def get_ListRecords(self, args={}):
        ...
        date_template_string = oai_set.get_setDateTemplate()
        date_template_vars = {
            'formatDateTime': self.getDatetimeFormatFunctionname(),
            'dateGranularity': self.getDateGranularityTemplate(),
            }
        date_template = date_template_string % date_template_vars
