...
class ThreadSlot:
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, ThreadSlot, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, ThreadSlot, name)
    __repr__ = _swig_repr
    def __init__(self): 
        this = _CharniakParser.new_ThreadSlot()
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = _CharniakParser.delete_ThreadSlot
    __del__ = lambda self : None;
    def acquire(self): return _CharniakParser.ThreadSlot_acquire(self)
    def recycle(self): return _CharniakParser.ThreadSlot_recycle(self)
    def acquiredThreadSlot(self): return _CharniakParser.ThreadSlot_acquiredThreadSlot(self)
ThreadSlot_swigregister = _CharniakParser.ThreadSlot_swigregister
ThreadSlot_swigregister(ThreadSlot)
