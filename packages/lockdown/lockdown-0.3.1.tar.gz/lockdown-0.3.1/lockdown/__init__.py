...
class Lockdown(object):
    ...
    def _lockdown_gen_hmac(self, ctext):
        ''' Generate an HMAC from cipher text '''
    ...
    def _lockdown_encrypt_file(self, input_path):
        ...
        self.___cipher = None
        hmac = self._lockdown_gen_hmac(ctext)
    ...
    def _lockdown_decrypt_file(self, input_path):
        ...
        check_hmac = HMAC.new(self.___keys['HMAC'])
        check_hmac.update(ctext)
        if check_hmac.digest() != hmac:
