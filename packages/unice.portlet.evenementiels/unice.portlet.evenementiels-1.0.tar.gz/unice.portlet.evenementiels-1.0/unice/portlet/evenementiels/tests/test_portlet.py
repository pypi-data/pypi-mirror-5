...
from unice.portlet.evenementiels import evenementielsportlet

from unice.portlet.evenementiels.tests.base import TestCase
...
class TestPortlet(TestCase):
    ...
    def test_portlet_type_registered(self):
        portlet = getUtility(
            IPortletType,
            name='unice.portlet.evenementiels.EvenementielsPortlet')
        self.assertEquals(portlet.addview,
                          'unice.portlet.evenementiels.EvenementielsPortlet')

    def test_interfaces(self):
        # TODO: Pass any keyword arguments to the Assignment constructor
        portlet = evenementielsportlet.Assignment()
    ...
    def test_invoke_add_view(self):
        ...
        self.failUnless(isinstance(mapping.values()[0],
                                   evenementielsportlet.Assignment))
    ...
    def test_invoke_edit_view(self):
        ...
        mapping['foo'] = evenementielsportlet.Assignment()
        editview = getMultiAdapter((mapping['foo'], request), name='edit')
        self.failUnless(isinstance(editview, evenementielsportlet.EditForm))
    ...
    def test_obtain_renderer(self):
        ...
        # TODO: Pass any keyword arguments to the Assignment constructor
        assignment = evenementielsportlet.Assignment()

        renderer = getMultiAdapter(
            (context, request, view, manager, assignment), IPortletRenderer)
        self.failUnless(isinstance(renderer, evenementielsportlet.Renderer))
...
class TestRenderer(TestCase):
    ...
    def afterSetUp(self):
        ...
        self.evenementiels_tmpl = """<p><a href="%s">Home</a></p>"""
        
        # make a document with some realistic evenementiels
        ...
        self.portal['quick-links'].setText(
            self.evenementiels_tmpl % self.portal.portal_url())
    ...
    def renderer(self, context=None, request=None, view=None, manager=None,
        ...
        assignment = assignment or evenementielsportlet.Assignment()
    ...
    def test_render_body(self):
        r = self.renderer(
            context=self.portal,
            assignment=evenementielsportlet.Assignment(
                evenementiels=self.item_url_path[len(self.portal_url_path):],
                item_display=[u'body'],
            )
        )
        ...
        r.update()
        output = r.render()
        self.failUnless(self.evenementiels_tmpl % self.portal.portal_url() in output)
    ...
    def test_i18n_render_body(self):
        ...
        ql_german.setText(self.evenementiels_tmpl % self.portal.portal_url() + "DE")
        ...
        r.update()
        output = r.render()
        self.failUnless(self.evenementiels_tmpl % self.portal.portal_url() + "DE" \
            in output)
