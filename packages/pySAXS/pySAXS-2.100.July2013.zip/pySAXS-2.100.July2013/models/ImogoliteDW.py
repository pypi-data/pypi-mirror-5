...
#par[0]=8e-5*0.5
     ...
     IntensityFunc=ImogoliteDWFunction
     q=Qlogspace(0.005,1.0,500)    #q range(x scale)
     Arg=[.042,22,0.0,6.0,11,0.0,6.0,200.0,0.334,0.334]         #list of defaults parameters
     Format=["%1.3e","%1.3e","%1.3e","%1.3e","%1.3e","%1.3e","%1.3e","%1.3e","%1.3e","%1.3e"]      #list of c format
     istofit=[True,True,False,False,True,False,False,True,False,False]    #list of boolean for fitting
     name="Specific: Imogolite Double Wall Si/Ge"          #name of the model
     Author="Antoine Thill"
     Description = "Imodolite double wall variable thickness Si/Ge"
     Doc=["Ge concentration (mol/l)",\
