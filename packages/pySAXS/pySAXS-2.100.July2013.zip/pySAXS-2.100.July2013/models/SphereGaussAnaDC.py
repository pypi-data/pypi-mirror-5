...
class SphereGaussAnaDC(Model):
    ...
    '''
    IntensityFunc=SphereGauss_ana_DC #function
    N=0
    ...
    name="Spheres polydisperses: Semi-Gaussian distribution"          #name of the model
    Doc=["Mean radius(A)",\
    ...
    Description="Spheres : Semi-Gaussian distribution, analytical"  # description of model
