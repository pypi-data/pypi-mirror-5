...
# adaptation for pySAXS by Olivier Tache - 2013
...
class MainWindow(QMainWindow):
    def __init__(self,parentwindow=None):
        QMainWindow.__init__(self,parentwindow)
        #QtGui.QWidget.__init__(self, parentwindow)
    ...
    def about(self):
        QMessageBox.about( self, _("About ")+APP_NAME,
              ...
              <br>adaptation for pySAXS by Olivier Tache - 2013
    ...
    def open_image(self,filename=None):
        ...
        if filename is None:
            ...
            sys.stdout = None
            filename, _filter = getopenfilename(self, _("Open"), "",)#io.iohandler.load_filters)
...
if __name__ == '__main__':
    ...
    window = MainWindow()
    '''
    name='OT-2012-10-09-tetradecanol-3600s.TIFF'
    rep='f:\\test\\'
    fullname=rep+name
    window.open_image(fullname)
    '''
    window.show()
    app.exec_()
