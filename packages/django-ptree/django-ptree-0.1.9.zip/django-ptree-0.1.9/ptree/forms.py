...
class FormMixin(object):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields[ptree.views.abstract.SessionKeys.current_view_index] = forms.CharField(widget=forms.HiddenInput(), max_length=200)
        self.fields[ptree.views.abstract.SessionKeys.current_view_index].initial = self.request.session[ptree.views.abstract.SessionKeys.current_view_index]
...
class BlankModelForm(FormMixin, forms.ModelForm):
    ...
    def clean(self):
        ...
        self.request.session[ptree.views.abstract.SessionKeys.participant_resubmitted_last_form] = participant_resubmitted_this_form
        return cleaned_data
