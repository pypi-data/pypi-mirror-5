...
setup(
    name='django-ptree',
    version='0.1.27',
    packages=['ptree', 'ptree.models', 'ptree.management', 'ptree.stuff', 'ptree.templatetags', 'ptree.views', 'ptree.questionnaires', 'ptree.questionnaires.life_orientation_test'],
