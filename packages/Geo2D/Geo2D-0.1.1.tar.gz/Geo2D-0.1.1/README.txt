...
is compatible with `Python`_ >= 2.7, everything else is the same. Also
regenerated the HTML docs in a more user friendly way.**
...
And so on. More details about the technical stuff is in the docs.
