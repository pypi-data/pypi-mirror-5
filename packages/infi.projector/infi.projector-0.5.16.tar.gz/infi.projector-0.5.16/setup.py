...
SETUP_INFO = dict(
    ...
    install_requires = ['infi.execute', 'smmap', 'infi.traceback', 'distribute', 'infi.exceptools', 'gitflow', 'zc.buildout', 'gitdb', 'infi.recipe.template.version', 'infi.pysync', 'infi.pyutils', 'async', 'git-py', 'docopt'],
