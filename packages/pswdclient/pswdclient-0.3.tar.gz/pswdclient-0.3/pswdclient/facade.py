...
from pswdclient.pswdless import SendLoginEmail, LogUserIn, LogUserOut, FetchUserDetail
...
def log_user_in(app_id, token, ticket, url_detail='https://pswdless.appspot.com/rest/detail'):
    '''
    Fetch the user deatil from Passwordless
    '''
    return FetchUserDetail(app_id, token, ticket, url_detail)
