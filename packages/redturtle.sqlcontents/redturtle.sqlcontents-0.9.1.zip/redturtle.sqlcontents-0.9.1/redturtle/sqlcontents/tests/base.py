...
def setup_product():
    ...
    import redturtle.sqlcontents
    zcml.load_config('configure.zcml', redturtle.sqlcontents)
    ...
    ztc.installPackage('redturtle.sqlcontents')
...
setup_product()
ptc.setupPloneSite(products=['redturtle.sqlcontents'])
