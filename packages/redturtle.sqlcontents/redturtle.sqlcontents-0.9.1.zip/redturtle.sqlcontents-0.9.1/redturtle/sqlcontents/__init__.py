...
from redturtle.sqlcontents import config
...
sqlcontentsMessageFactory = MessageFactory('redturtle.sqlcontents')
sqlcontentsLogger = getLogger('redturtle.sqlcontents')
