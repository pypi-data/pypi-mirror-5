...
from encoder import SWUJSONEncode
...
class api:
    ...
    JSON_ENCODE_DEFAULT = None 
    JSON_ENCODE_CLS = SWUJSONEncode
    ...
    def __init__(self, api_key=None, **kwargs):
        ...
        if 'JSON_ENCODE_CLS' in kwargs:
            self.JSON_ENCODE_CLS = kwargs['JSON_ENCODE_CLS ']
    ...
    def _api_request(self, endpoint, http_method, *args, **kwargs):
        ...
        if 'payload' in kwargs:
            if self.JSON_ENCODE_DEFAULT:
                data = json.dumps(kwargs['payload'], default=self.JSON_ENCODE_DEFAULT)
            else:
                data = json.dumps(kwargs['payload'], cls=self.JSON_ENCODE_CLS)
