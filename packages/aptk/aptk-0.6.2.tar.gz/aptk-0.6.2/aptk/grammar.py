...
class Grammar(BaseGrammar):
    ...
    def BRANCH(P, args, s=None, start=None, end=None):
    ...
    def ERROR(P, args, s=None, start=None, end=None):
        ...
        raise SyntaxError("Error at line %s, pos %s: %s" % (line_no, pos, ' '.join(args)))
