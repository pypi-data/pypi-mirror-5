...
def _cache_key(func, self):
    ...
    return (cache_time_key, func.__name__, username, searchterms, userdisplay, searchdisplay,
            filtertext, languages, userpictures, includerts, consumer_secret,
...
class IFourdigitsPortletTwitter(IPortletDataProvider):
    ...
    name = schema.TextLine(
        ...
        description=_("twitterportlet_title_help", default=u"The title of the portlet."))

    username = schema.TextLine(
        title=_("twitterportlet_username", default=u"Username"),
        description=_("twitterportlet_username_help", default=u"The tweets of this user will be shown."),
        required=False,)

    userinfo = schema.Bool(
        title=_("twitterportlet_userinfo", default=u"Show user info?"),
        description=_("twitterportlet_userinfo_help", default=u"Show info of the Twitter user? (username is mandatory)."),
        required=False,)

    includerts = schema.Bool(
        title=_("twitterportlet_includerts", default=u"Include retweets"),
        description=_("twitterportlet_includerts_help", default=u"Include retweets of the user's account?"),
        required=False,
        default=True,)
    ...
    use_client_side = schema.Bool(
        title=_("twitterportlet_use_client_side",
                default=u"Use client side rendering"),
        description=_("twitterportlet_use_client_side_help",
                      default=u"Use a modified version of Tweet! to display a twitterfeed on your website."),
        default=False,
    )

    clientside_display = schema.Int(
        title=_("twitterportlet_clientside_display",
                default=u'Combined number of items to display for username and search.'),
        description=_("twitterportlet_clientside_display_help",
                      default=u'How many items to list when client side \
    ...
    def gettweets(self):
        ...
        if searchterms:
            ...
            query_dict = {'term': searchterms,
                          'count': searchlimit,
                          'lang': ""}
            if self.data.mergeuserandsearch:
                query_dict['from_user'] = self.data.username
            if languages:
