...
struct log_lookup {
    ...
    static const int D_LOGADD = 30; // y/x < 1e-D discard
    static const int G_LOGADD = 100; // step function look-up every 1/G
    static const int D_LOGSUB = 17; // above 16.25.. the func is zero
    static const int G_LOGSUB = 200;
    static const double SUB_INTERP_THRESHOLD = .02; // too steep to interpolate on
