...
typedef tuple< iterator_t, iterator_t > segment_t;
...
BOOST_AUTO_TEST_CASE( segmentize_1 )
{
	...
	BOOST_CHECK( true_segments[0] == make_tuple( seq.begin() + 1, seq.begin() + 3 ) );
	BOOST_CHECK_EQUAL( int( false_segments.size() ), 2 );
	BOOST_CHECK( false_segments[0] == make_tuple( seq.begin() + 0, seq.begin() + 1 ) );
	BOOST_CHECK( false_segments[1] == make_tuple( seq.begin() + 3, seq.begin() + 4 ) );
}
...
BOOST_AUTO_TEST_CASE( segmentize_2 )
{
	...
	BOOST_CHECK_EQUAL( int( true_segments.size() ), 1 );
	BOOST_CHECK( true_segments[0] == make_tuple( seq.begin() + 0, seq.begin() + 4 ) );
...
BOOST_AUTO_TEST_CASE( segmentize_3 )
{
	...
	BOOST_CHECK( false_segments[0] == make_tuple( seq.begin() + 0, seq.begin() + 4 ) );
...
BOOST_AUTO_TEST_CASE( known_segments_1 )
{
	...
	BOOST_CHECK( unknown_segments[0] == make_tuple( seqan::begin( seq ), seqan::end( seq ) ) );
...
BOOST_AUTO_TEST_CASE( known_segments_2 )
{
	...
	BOOST_CHECK( known_segments[0] == make_tuple( seqan::begin( seq ), seqan::end( seq ) ) );
...
BOOST_AUTO_TEST_CASE( known_segments_4 )
{
	...
	BOOST_CHECK( known_segments[0] == make_tuple( seqan::begin( seq ) + 1, seqan::begin( seq ) + 2 ) );
	BOOST_CHECK( known_segments[1] == make_tuple( seqan::begin( seq ) + 3, seqan::begin( seq ) + 4 ) );
	BOOST_CHECK( known_segments[2] == make_tuple( seqan::begin( seq ) + 5, seqan::begin( seq ) + 6 ) );
	BOOST_CHECK( known_segments[3] == make_tuple( seqan::begin( seq ) + 7, seqan::begin( seq ) + 8 ) );
	BOOST_CHECK_EQUAL( int( unknown_segments.size() ), 5 );
	BOOST_CHECK( unknown_segments[0] == make_tuple( seqan::begin( seq ) + 0, seqan::begin( seq ) + 1 ) );
	BOOST_CHECK( unknown_segments[1] == make_tuple( seqan::begin( seq ) + 2, seqan::begin( seq ) + 3 ) );
	BOOST_CHECK( unknown_segments[2] == make_tuple( seqan::begin( seq ) + 4, seqan::begin( seq ) + 5 ) );
	BOOST_CHECK( unknown_segments[3] == make_tuple( seqan::begin( seq ) + 6, seqan::begin( seq ) + 7 ) );
	BOOST_CHECK( unknown_segments[4] == make_tuple( seqan::begin( seq ) + 8, seqan::begin( seq ) + 9 ) );
}
