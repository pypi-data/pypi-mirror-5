...
#         self._execution_log('\nStarting DB migration on database "%s@%s:%s"...' % (self.config.get('database_user'), self.config.get('database_host'), self.config.get('database_name')), "PINK", log_level_limit=1)
