...
"""
import datetime
from relshell.error import RecordTypeError, UnsupportedTypeError
...
class Record(object):
    ...
    def __init__(self, record_def, *columns, **kwargs):
        ...
        :param timestamp=: instance of `Timestamp <#relshell.timestamp.Timestamp>`_
        :raises:           `RecordTypeError <#relshell.error.RecordTypeError>`_
        """
