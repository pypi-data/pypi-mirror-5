...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OrganizationPersonRole'
        db.create_table(u'multilingual_orgs_organizationpersonrole', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('organization', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['multilingual_orgs.Organization'])),
        ...
        db.send_create_signal(u'multilingual_orgs', ['OrganizationPersonRole'])


    def backwards(self, orm):
        # Deleting model 'OrganizationPersonRole'
        db.delete_table(u'multilingual_orgs_organizationpersonrole')
    ...
    models = {
        ...
        u'multilingual_orgs.organizationpersonrole': {
            'Meta': {'object_name': 'OrganizationPersonRole'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'organization': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['multilingual_orgs.Organization']"}),
        ...
        u'multilingual_orgs.organizationpluginmodel': {
            'Meta': {'object_name': 'OrganizationPluginModel', 'db_table': "u'cmsplugin_organizationpluginmodel'", '_ormbases': ['cms.CMSPlugin']},
            u'cmsplugin_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.CMSPlugin']", 'unique': 'True', 'primary_key': 'True'}),
            'display_type': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'organization': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['multilingual_orgs.Organization']"})
        },
        u'multilingual_orgs.organizationtranslation': {
            'Meta': {'object_name': 'OrganizationTranslation'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
    ...
    complete_apps = ['multilingual_orgs']