...
class Ui_LoginWidget(object):
    def setupUi(self, LoginWidget):
        ...
        self.gridLayout_5.setContentsMargins(-1, -1, -1, 24)
        ...
        self.lblLoginStatus = QtGui.QLabel(self.logged_widget)
        self.lblLoginStatus.setStyleSheet("color: rgb(132, 132, 132);\n"
"font: 75 12pt \"Lucida Grande\";")
        self.lblLoginStatus.setText("")
        self.lblLoginStatus.setObjectName("lblLoginStatus")
        self.gridLayout_5.addWidget(self.lblLoginStatus, 2, 0, 1, 2)
        self.gridLayout.addWidget(self.logged_widget, 2, 2, 1, 2)
        ...
        self.gridLayout.addWidget(self.login_widget, 1, 2, 1, 2)
        spacerItem1 = QtGui.QSpacerItem(12, 0, QtGui.QSizePolicy.Maximum, QtGui.QSizePolicy.Minimum)
