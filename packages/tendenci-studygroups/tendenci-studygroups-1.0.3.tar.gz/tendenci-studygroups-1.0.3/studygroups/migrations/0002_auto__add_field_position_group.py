...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('studygroups_position', 'group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['user_groups.Group'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Position.group'
        db.delete_column('studygroups_position', 'group_id')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 17, 15, 23, 10, 507187)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 17, 15, 23, 10, 507090)'}),
