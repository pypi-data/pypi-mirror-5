...
xml_data = """
<accounting-document type="downpayment"
                     format-version="PBD-1.0"
                     xmlns="http://www.logilab.org/2010/PyBillDocument">

  <downpayment-percent>1.7</downpayment-percent>
...
class AccDocFormat10ReaderDownpaymentTest(TestCase, FormatReaderGenericTest):
    def setUp(self):
        """
    ...
    def test_load_data(self):
        """
        Tests the Format_1_0_Reader reads correctly an XML downpayment document.
        """
