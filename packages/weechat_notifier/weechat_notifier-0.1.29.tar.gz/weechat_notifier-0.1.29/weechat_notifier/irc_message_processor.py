...
def generate_actions_from_irc_message(args,printer):
    ...
    if debug:
        printer("to_me: " + to_me + ", from_me: " + from_me + ", monitoring_channel: " + monitoring_channel,"")
    ...
    if not to_me and not from_me and monitoring_channel:
        ...
        actions_todo.append({u"action": display_alert,
                             u"arguments": {u"alert_title": alert_title, 
                                           ...
                                           u"urgency": u"low"}} )
        if debug:
            printer("Monitoring Channel Msg" + channel, str(monitored_channels))
...
def construct_alert(frm, channel, msg, elapsed=None):
    ...
    return trim_leading_dashes(alert_title), trim_leading_dashes(message)
