...
def is_message_for_me(highlight):
    if highlight == "1":
        display_alert("message IS for me")
        return True
    else:
        display_alert("message is NOT for me")
        return False
