...
old-style class in the Python 2.7 source of markupbase.py, which seems to
cause sporadic unit-test failures on travis-ci.org with test_htmlparser.py.
The test failures like like this:
