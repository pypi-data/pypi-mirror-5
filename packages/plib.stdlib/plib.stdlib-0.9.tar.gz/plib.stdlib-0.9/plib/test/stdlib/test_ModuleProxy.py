...
class ModuleProxyTest(unittest.TestCase):
    ...
    def test_proxy(self):
        ...
        self.assert_('test_var_static' not in set(ModuleProxy_testmod.__dict__.iterkeys()))
        self.assert_('test_var_static' not in testnames)
        self.assert_('test_var_static' in dir(testmod))
        ...
        self.assert_('test_var_dynamic' in set(ModuleProxy_testmod.__dict__.iterkeys()))
        ...
        self.assert_('test_fn' in set(ModuleProxy_testmod.__dict__.iterkeys()))
