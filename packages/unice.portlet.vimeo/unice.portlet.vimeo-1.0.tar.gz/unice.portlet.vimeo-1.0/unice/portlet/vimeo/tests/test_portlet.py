...
from unice.portlet.vimeo import vimeoportlet

from unice.portlet.vimeo.tests.base import TestCase
...
class TestPortlet(TestCase):
    ...
    def test_portlet_type_registered(self):
        portlet = getUtility(
            IPortletType,
            name='unice.portlet.vimeo.VimeoPortlet')
        self.assertEquals(portlet.addview,
                          'unice.portlet.vimeo.VimeoPortlet')

    def test_interfaces(self):
        # TODO: Pass any keyword arguments to the Assignment constructor
        portlet = vimeoportlet.Assignment()
    ...
    def test_invoke_edit_view(self):
        ...
        mapping['foo'] = vimeoportlet.Assignment()
        editview = getMultiAdapter((mapping['foo'], request), name='edit')
        self.failUnless(isinstance(editview, vimeoportlet.EditForm))
    ...
    def test_obtain_renderer(self):
        ...
        # TODO: Pass any keyword arguments to the Assignment constructor
        assignment = vimeoportlet.Assignment()

        renderer = getMultiAdapter(
            (context, request, view, manager, assignment), IPortletRenderer)
        self.failUnless(isinstance(renderer, vimeoportlet.Renderer))
...
class TestRenderer(TestCase):
    ...
    def afterSetUp(self):
        ...
        self.vimeo_tmpl = """<p><a href="%s">Home</a></p>"""
        
        # make a document with some realistic vimeo
        ...
        self.portal['quick-links'].setText(
            self.vimeo_tmpl % self.portal.portal_url())
    ...
    def renderer(self, context=None, request=None, view=None, manager=None,
        ...
        assignment = assignment or vimeoportlet.Assignment()
    ...
    def test_render_body(self):
        r = self.renderer(
            context=self.portal,
            assignment=vimeoportlet.Assignment(
                vimeo=self.item_url_path[len(self.portal_url_path):],
                item_display=[u'body'],
            )
        )
        ...
        r.update()
        output = r.render()
        self.failUnless(self.vimeo_tmpl % self.portal.portal_url() in output)
    ...
    def test_i18n_render_body(self):
        ...
        ql_german.setText(self.vimeo_tmpl % self.portal.portal_url() + "DE")
        ...
        r.update()
        output = r.render()
        self.failUnless(self.vimeo_tmpl % self.portal.portal_url() + "DE" \
            in output)
