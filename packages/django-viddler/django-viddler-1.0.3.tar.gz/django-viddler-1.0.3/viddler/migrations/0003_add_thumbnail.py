...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ViddlerVideo.embed_url'
        db.delete_column('viddler_viddlervideo', 'embed_url')
    ...
    def backwards(self, orm):
        # Adding field 'ViddlerVideo.embed_url'
        db.add_column('viddler_viddlervideo', 'embed_url',
