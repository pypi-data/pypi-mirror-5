...
setup(
    ...
    packages=['etmQt',],
    scripts=['etm_qt'],
    install_requires=["python-dateutil>=1.5", "PyYaml>=3.10", "icalendar>=3.5" ],
    package_data={'etmQt': ['icons/*', '*.html', 'version.txt', 'CHANGES', 'applications/etm_qt.desktop', 'etm_qt.1.gz', 'etm_qt.1', 'etm_qt.xpm'],
    ...
    data_files=[
        ('share/doc/etm_qt', ['etmQt/version.txt', 'etmQt/CHANGES', 'etmQt/INSTALL.html']),
        ('share/man/man1', ['etmQt/etm_qt.1', 'etmQt/etm_qt.1.gz']),
        ...
        ('share/doc/etm_qt/language/images', glob.glob('etmQt/language/images/*.png'))
        ]
)
