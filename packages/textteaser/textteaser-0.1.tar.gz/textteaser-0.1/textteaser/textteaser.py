...
class TextTeaser(object):
    ...
    def _post(self, url, data):
        ...
        return requests.post(
            urls.SUMMARIZE, data, headers=self.headers)
    ...
    def summarize(self, text, title, kwargs=None):
        ...
        Args:
            ...
            kwargs: A dictionary with the following possible strings:
                id: A string containing a unique identifier for the
                    summary. Caches the request for faster retrieval in
                    the future.
        ...
        resp = requests.post(urls.SUMMARIZE, data, headers=self._headers())
