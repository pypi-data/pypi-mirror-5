...
class WET(DstTzInfo):
    ...
    _utc_transition_times = [
        ...
        datetime(1977,  4,  3,  1,  0,  0), #   3600  3600 WEST
        datetime(1977,  9, 25,  1,  0,  0), #      0     0 WET
        datetime(1978,  4,  2,  1,  0,  0), #   3600  3600 WEST
        datetime(1978, 10,  1,  1,  0,  0), #      0     0 WET
        datetime(1979,  4,  1,  1,  0,  0), #   3600  3600 WEST
        datetime(1979,  9, 30,  1,  0,  0), #      0     0 WET
        datetime(1980,  4,  6,  1,  0,  0), #   3600  3600 WEST
