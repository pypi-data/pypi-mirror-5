...
class Hobart(DstTzInfo):
    ...
    _zone = 'Australia/Hobart'

    _utc_transition_times = [
        datetime(   1,  1,  1,  0,  0,  0), #  36000     0 EST
        datetime(1916,  9, 30, 16,  0,  0), #  39600  3600 EST
        ...
        datetime(1967,  9, 30, 16,  0,  0), #  39600  3600 EST
        datetime(1968,  3, 30, 16,  0,  0), #  36000     0 EST
        datetime(1968, 10, 26, 16,  0,  0), #  39600  3600 EST
        datetime(1969,  3,  8, 16,  0,  0), #  36000     0 EST
        datetime(1969, 10, 25, 16,  0,  0), #  39600  3600 EST
        datetime(1970,  3,  7, 16,  0,  0), #  36000     0 EST
        datetime(1970, 10, 24, 16,  0,  0), #  39600  3600 EST
        datetime(1971,  3, 13, 16,  0,  0), #  36000     0 EST
        ...
        datetime(1982,  3, 27, 16,  0,  0), #  36000     0 EST
        datetime(1982, 10, 30, 16,  0,  0), #  39600  3600 EST
        datetime(1983,  3, 26, 16,  0,  0), #  36000     0 EST
        ...
        datetime(1986,  3,  1, 16,  0,  0), #  36000     0 EST
        ...
        datetime(1990,  3, 17, 16,  0,  0), #  36000     0 EST
        datetime(1990, 10, 27, 16,  0,  0), #  39600  3600 EST
        datetime(1991,  3, 30, 16,  0,  0), #  36000     0 EST
        datetime(1991, 10,  5, 16,  0,  0), #  39600  3600 EST
        datetime(1992,  3, 28, 16,  0,  0), #  36000     0 EST
        datetime(1992, 10,  3, 16,  0,  0), #  39600  3600 EST
        datetime(1993,  3, 27, 16,  0,  0), #  36000     0 EST
        datetime(1993, 10,  2, 16,  0,  0), #  39600  3600 EST
        datetime(1994,  3, 26, 16,  0,  0), #  36000     0 EST
        datetime(1994, 10,  1, 16,  0,  0), #  39600  3600 EST
        datetime(1995,  3, 25, 16,  0,  0), #  36000     0 EST
        datetime(1995,  9, 30, 16,  0,  0), #  39600  3600 EST
        datetime(1996,  3, 30, 16,  0,  0), #  36000     0 EST
        datetime(1996, 10,  5, 16,  0,  0), #  39600  3600 EST
        datetime(1997,  3, 29, 16,  0,  0), #  36000     0 EST
        datetime(1997, 10,  4, 16,  0,  0), #  39600  3600 EST
        datetime(1998,  3, 28, 16,  0,  0), #  36000     0 EST
        datetime(1998, 10,  3, 16,  0,  0), #  39600  3600 EST
        datetime(1999,  3, 27, 16,  0,  0), #  36000     0 EST
        datetime(1999, 10,  2, 16,  0,  0), #  39600  3600 EST
        datetime(2000,  3, 25, 16,  0,  0), #  36000     0 EST
        datetime(2000,  8, 26, 16,  0,  0), #  39600  3600 EST
        datetime(2001,  3, 24, 16,  0,  0), #  36000     0 EST
        datetime(2001, 10,  6, 16,  0,  0), #  39600  3600 EST
        datetime(2002,  3, 30, 16,  0,  0), #  36000     0 EST
        datetime(2002, 10,  5, 16,  0,  0), #  39600  3600 EST
        datetime(2003,  3, 29, 16,  0,  0), #  36000     0 EST
        datetime(2003, 10,  4, 16,  0,  0), #  39600  3600 EST
        datetime(2004,  3, 27, 16,  0,  0), #  36000     0 EST
        datetime(2004, 10,  2, 16,  0,  0), #  39600  3600 EST
        datetime(2005,  3, 26, 16,  0,  0), #  36000     0 EST
        datetime(2005, 10,  1, 16,  0,  0), #  39600  3600 EST
        datetime(2006,  3, 25, 16,  0,  0), #  36000     0 EST
        datetime(2006,  9, 30, 16,  0,  0), #  39600  3600 EST
        datetime(2007,  3, 24, 16,  0,  0), #  36000     0 EST
        datetime(2007, 10,  6, 16,  0,  0), #  39600  3600 EST
        datetime(2008,  3, 29, 16,  0,  0), #  36000     0 EST
        datetime(2008, 10,  4, 16,  0,  0), #  39600  3600 EST
        datetime(2009,  3, 28, 16,  0,  0), #  36000     0 EST
        datetime(2009, 10,  3, 16,  0,  0), #  39600  3600 EST
        datetime(2010,  3, 27, 16,  0,  0), #  36000     0 EST
        datetime(2010, 10,  2, 16,  0,  0), #  39600  3600 EST
        datetime(2011,  3, 26, 16,  0,  0), #  36000     0 EST
        datetime(2011, 10,  1, 16,  0,  0), #  39600  3600 EST
        datetime(2012,  3, 24, 16,  0,  0), #  36000     0 EST
        datetime(2012, 10,  6, 16,  0,  0), #  39600  3600 EST
        datetime(2013,  3, 30, 16,  0,  0), #  36000     0 EST
        datetime(2013, 10,  5, 16,  0,  0), #  39600  3600 EST
        datetime(2014,  3, 29, 16,  0,  0), #  36000     0 EST
        datetime(2014, 10,  4, 16,  0,  0), #  39600  3600 EST
        datetime(2015,  3, 28, 16,  0,  0), #  36000     0 EST
        datetime(2015, 10,  3, 16,  0,  0), #  39600  3600 EST
        datetime(2016,  3, 26, 16,  0,  0), #  36000     0 EST
        datetime(2016, 10,  1, 16,  0,  0), #  39600  3600 EST
        datetime(2017,  3, 25, 16,  0,  0), #  36000     0 EST
        datetime(2017,  9, 30, 16,  0,  0), #  39600  3600 EST
        datetime(2018,  3, 24, 16,  0,  0), #  36000     0 EST
        datetime(2018, 10,  6, 16,  0,  0), #  39600  3600 EST
        datetime(2019,  3, 30, 16,  0,  0), #  36000     0 EST
        datetime(2019, 10,  5, 16,  0,  0), #  39600  3600 EST
        datetime(2020,  3, 28, 16,  0,  0), #  36000     0 EST
        datetime(2020, 10,  3, 16,  0,  0), #  39600  3600 EST
        datetime(2021,  3, 27, 16,  0,  0), #  36000     0 EST
        datetime(2021, 10,  2, 16,  0,  0), #  39600  3600 EST
        datetime(2022,  3, 26, 16,  0,  0), #  36000     0 EST
        datetime(2022, 10,  1, 16,  0,  0), #  39600  3600 EST
        datetime(2023,  3, 25, 16,  0,  0), #  36000     0 EST
        datetime(2023,  9, 30, 16,  0,  0), #  39600  3600 EST
        datetime(2024,  3, 30, 16,  0,  0), #  36000     0 EST
        datetime(2024, 10,  5, 16,  0,  0), #  39600  3600 EST
        datetime(2025,  3, 29, 16,  0,  0), #  36000     0 EST
        datetime(2025, 10,  4, 16,  0,  0), #  39600  3600 EST
        datetime(2026,  3, 28, 16,  0,  0), #  36000     0 EST
        datetime(2026, 10,  3, 16,  0,  0), #  39600  3600 EST
        datetime(2027,  3, 27, 16,  0,  0), #  36000     0 EST
        datetime(2027, 10,  2, 16,  0,  0), #  39600  3600 EST
        datetime(2028,  3, 25, 16,  0,  0), #  36000     0 EST
        datetime(2028,  9, 30, 16,  0,  0), #  39600  3600 EST
        datetime(2029,  3, 24, 16,  0,  0), #  36000     0 EST
        datetime(2029, 10,  6, 16,  0,  0), #  39600  3600 EST
        datetime(2030,  3, 30, 16,  0,  0), #  36000     0 EST
        datetime(2030, 10,  5, 16,  0,  0), #  39600  3600 EST
        datetime(2031,  3, 29, 16,  0,  0), #  36000     0 EST
        datetime(2031, 10,  4, 16,  0,  0), #  39600  3600 EST
        datetime(2032,  3, 27, 16,  0,  0), #  36000     0 EST
        datetime(2032, 10,  2, 16,  0,  0), #  39600  3600 EST
        datetime(2033,  3, 26, 16,  0,  0), #  36000     0 EST
        datetime(2033, 10,  1, 16,  0,  0), #  39600  3600 EST
        datetime(2034,  3, 25, 16,  0,  0), #  36000     0 EST
        datetime(2034,  9, 30, 16,  0,  0), #  39600  3600 EST
        datetime(2035,  3, 24, 16,  0,  0), #  36000     0 EST
        datetime(2035, 10,  6, 16,  0,  0), #  39600  3600 EST
        datetime(2036,  3, 29, 16,  0,  0), #  36000     0 EST
        datetime(2036, 10,  4, 16,  0,  0), #  39600  3600 EST
        datetime(2037,  3, 28, 16,  0,  0), #  36000     0 EST
        datetime(2037, 10,  3, 16,  0,  0), #  39600  3600 EST
        ]
