...
class Louisville(DstTzInfo):
    ...
    _zone = 'America/Kentucky/Louisville'
    ...
    _utc_transition_times = [
        ...
        datetime(1921,  5,  1,  8,  0,  0), # -18000  3600 CDT
        datetime(1921,  9,  1,  7,  0,  0), # -21600     0 CST
        ...
        datetime(1946,  1,  1,  6,  0,  0), # -18000  3600 CDT
        datetime(1946,  6,  2,  7,  0,  0), # -21600     0 CST
        ...
        datetime(1961,  7, 23,  7,  0,  0), # -18000     0 EST
...
Louisville = Louisville() # Singleton
