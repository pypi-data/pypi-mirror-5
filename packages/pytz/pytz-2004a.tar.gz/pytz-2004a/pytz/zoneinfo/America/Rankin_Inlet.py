...
class Rankin_Inlet(DstTzInfo):
    ...
    _utc_transition_times = [
        ...
        datetime(2001,  4,  1,  8,  0,  0), # -18000     0 CDT
...
Rankin_Inlet = Rankin_Inlet() # Singleton
