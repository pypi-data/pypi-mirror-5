...
class Yakutat(DstTzInfo):
    ...
    _utc_transition_times = [
        ...
        datetime(1969,  4, 27, 11,  0,  0), # -28800  3600 YDT
        datetime(1969, 10, 26, 10,  0,  0), # -32400     0 YST
        datetime(1970,  4, 26, 11,  0,  0), # -28800  3600 YDT
        datetime(1970, 10, 25, 10,  0,  0), # -32400     0 YST
        datetime(1971,  4, 25, 11,  0,  0), # -28800  3600 YDT
        datetime(1971, 10, 31, 10,  0,  0), # -32400     0 YST
        datetime(1972,  4, 30, 11,  0,  0), # -28800  3600 YDT
        datetime(1972, 10, 29, 10,  0,  0), # -32400     0 YST
        datetime(1973,  4, 29, 11,  0,  0), # -28800  3600 YDT
        datetime(1973, 10, 28, 10,  0,  0), # -32400     0 YST
        datetime(1974,  1,  6, 11,  0,  0), # -28800  3600 YDT
        datetime(1974, 10, 27, 10,  0,  0), # -32400     0 YST
        datetime(1975,  2, 23, 11,  0,  0), # -28800  3600 YDT
        datetime(1975, 10, 26, 10,  0,  0), # -32400     0 YST
        datetime(1976,  4, 25, 11,  0,  0), # -28800  3600 YDT
        datetime(1976, 10, 31, 10,  0,  0), # -32400     0 YST
        datetime(1977,  4, 24, 11,  0,  0), # -28800  3600 YDT
        datetime(1977, 10, 30, 10,  0,  0), # -32400     0 YST
        datetime(1978,  4, 30, 11,  0,  0), # -28800  3600 YDT
        datetime(1978, 10, 29, 10,  0,  0), # -32400     0 YST
        datetime(1979,  4, 29, 11,  0,  0), # -28800  3600 YDT
        datetime(1979, 10, 28, 10,  0,  0), # -32400     0 YST
        datetime(1980,  4, 27, 11,  0,  0), # -28800  3600 YDT
        datetime(1980, 10, 26, 10,  0,  0), # -32400     0 YST
        datetime(1981,  4, 26, 11,  0,  0), # -28800  3600 YDT
        datetime(1981, 10, 25, 10,  0,  0), # -32400     0 YST
        datetime(1982,  4, 25, 11,  0,  0), # -28800  3600 YDT
        datetime(1982, 10, 31, 10,  0,  0), # -32400     0 YST
        datetime(1983,  4, 24, 11,  0,  0), # -28800  3600 YDT
        datetime(1983, 10, 30, 10,  0,  0), # -32400     0 YST
