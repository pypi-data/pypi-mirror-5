...
class Vancouver(DstTzInfo):
    ...
    _utc_transition_times = [
        ...
        datetime(1946,  4, 28, 10,  0,  0), # -25200  3600 PDT
        datetime(1946, 10, 13,  9,  0,  0), # -28800     0 PST
        ...
        datetime(1974,  4, 28, 10,  0,  0), # -25200  3600 PDT
        datetime(1974, 10, 27,  9,  0,  0), # -28800     0 PST
        datetime(1975,  4, 27, 10,  0,  0), # -25200  3600 PDT
