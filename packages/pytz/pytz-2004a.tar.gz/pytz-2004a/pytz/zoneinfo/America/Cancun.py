...
class Cancun(DstTzInfo):
    ...
    _zone = 'America/Cancun'

    _utc_transition_times = [
        datetime(   1,  1,  1,  0,  0,  0), # -20824     0 LMT
        datetime(1922,  1,  1,  6,  0,  0), # -21600     0 CST
        datetime(1981, 12, 23,  6,  0,  0), # -18000     0 EST
        ...
        datetime(1998,  8,  2,  6,  0,  0), # -18000 -3600 CDT
