...
class Montreal(DstTzInfo):
    ...
    _utc_transition_times = [
        ...
        datetime(1917,  3, 25,  7,  0,  0), # -14400  3600 EDT
        datetime(1917,  4, 24,  4,  0,  0), # -18000     0 EST
        datetime(1918,  4, 14,  7,  0,  0), # -14400  3600 EDT
        datetime(1918, 10, 31,  6,  0,  0), # -18000     0 EST
        datetime(1919,  3, 31,  7, 30,  0), # -14400  3600 EDT
        datetime(1919, 10, 25,  6, 30,  0), # -18000     0 EST
        datetime(1920,  5,  2,  7, 30,  0), # -14400  3600 EDT
        datetime(1920, 10,  3,  6, 30,  0), # -18000     0 EST
        datetime(1921,  5,  1,  7,  0,  0), # -14400  3600 EDT
        datetime(1921, 10,  2,  6, 30,  0), # -18000     0 EST
        datetime(1922,  4, 30,  7,  0,  0), # -14400  3600 EDT
        datetime(1922, 10,  1,  6, 30,  0), # -18000     0 EST
        datetime(1924,  5, 17,  7,  0,  0), # -14400  3600 EDT
        datetime(1924,  9, 28,  6, 30,  0), # -18000     0 EST
        datetime(1925,  5,  3,  7,  0,  0), # -14400  3600 EDT
        datetime(1925,  9, 27,  6, 30,  0), # -18000     0 EST
        datetime(1926,  5,  2,  7,  0,  0), # -14400  3600 EDT
        datetime(1926,  9, 26,  6, 30,  0), # -18000     0 EST
        datetime(1927,  5,  1,  5,  0,  0), # -14400  3600 EDT
        datetime(1927,  9, 25,  4,  0,  0), # -18000     0 EST
        datetime(1928,  4, 29,  5,  0,  0), # -14400  3600 EDT
        datetime(1928,  9, 30,  4,  0,  0), # -18000     0 EST
        datetime(1929,  4, 28,  5,  0,  0), # -14400  3600 EDT
        datetime(1929,  9, 29,  4,  0,  0), # -18000     0 EST
        datetime(1930,  4, 27,  5,  0,  0), # -14400  3600 EDT
        datetime(1930,  9, 28,  4,  0,  0), # -18000     0 EST
        datetime(1931,  4, 26,  5,  0,  0), # -14400  3600 EDT
        datetime(1931,  9, 27,  4,  0,  0), # -18000     0 EST
        datetime(1932,  5,  1,  5,  0,  0), # -14400  3600 EDT
        datetime(1932,  9, 25,  4,  0,  0), # -18000     0 EST
        datetime(1933,  4, 30,  5,  0,  0), # -14400  3600 EDT
        datetime(1933, 10,  1,  4,  0,  0), # -18000     0 EST
        datetime(1934,  4, 29,  5,  0,  0), # -14400  3600 EDT
        datetime(1934,  9, 30,  4,  0,  0), # -18000     0 EST
        datetime(1935,  4, 28,  5,  0,  0), # -14400  3600 EDT
        datetime(1935,  9, 29,  4,  0,  0), # -18000     0 EST
        datetime(1936,  4, 26,  5,  0,  0), # -14400  3600 EDT
        datetime(1936,  9, 27,  4,  0,  0), # -18000     0 EST
        datetime(1937,  4, 25,  5,  0,  0), # -14400  3600 EDT
        datetime(1937,  9, 26,  4,  0,  0), # -18000     0 EST
        datetime(1938,  4, 24,  5,  0,  0), # -14400  3600 EDT
        datetime(1938,  9, 25,  4,  0,  0), # -18000     0 EST
        datetime(1939,  4, 30,  5,  0,  0), # -14400  3600 EDT
        datetime(1939,  9, 24,  4,  0,  0), # -18000     0 EST
        datetime(1940,  4, 28,  5,  0,  0), # -14400  3600 EDT
        ...
        datetime(1949, 10, 30,  6,  0,  0), # -18000     0 EST
        datetime(1950,  4, 30,  7,  0,  0), # -14400  3600 EDT
        datetime(1950, 10, 29,  6,  0,  0), # -18000     0 EST
        ...
        datetime(1955,  9, 25,  6,  0,  0), # -18000     0 EST
        datetime(1956,  4, 29,  7,  0,  0), # -14400  3600 EDT
        datetime(1956,  9, 30,  6,  0,  0), # -18000     0 EST
