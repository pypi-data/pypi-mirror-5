...
class Pangnirtung(DstTzInfo):
    ...
    _zone = 'America/Pangnirtung'

    _utc_transition_times = [
        datetime(   1,  1,  1,  0,  0,  0), # -14400     0 AST
        datetime(1918,  4, 14,  6,  0,  0), # -10800  3600 ADT
        datetime(1918, 10, 27,  5,  0,  0), # -14400     0 AST
        datetime(1919,  5, 25,  6,  0,  0), # -10800  3600 ADT
        datetime(1919, 11,  1,  3,  0,  0), # -14400     0 AST
        datetime(1942,  2,  9,  6,  0,  0), # -10800  3600 AWT
        datetime(1945,  8, 14, 23,  0,  0), # -10800     0 APT
        datetime(1945,  9, 30,  5,  0,  0), # -14400     0 AST
        datetime(1965,  4, 25,  4,  0,  0), #  -7200  7200 ADDT
        datetime(1965, 10, 31,  4,  0,  0), # -14400     0 AST
        ...
        datetime(1995,  4,  2,  6,  0,  0), # -14400     0 EDT
        ...
        datetime(1999, 10, 31,  6,  0,  0), # -21600     0 CST
...
Pangnirtung = Pangnirtung() # Singleton
