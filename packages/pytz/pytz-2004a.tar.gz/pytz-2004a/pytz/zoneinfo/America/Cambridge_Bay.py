...
class Cambridge_Bay(DstTzInfo):
    ...
    _utc_transition_times = [
        ...
        datetime(2000, 11,  5,  5,  0,  0), # -21600     0 CST
        datetime(2001,  4,  1,  9,  0,  0), # -21600     0 MDT
...
Cambridge_Bay = Cambridge_Bay() # Singleton
