...
class Buenos_Aires(DstTzInfo):
    ...
    _utc_transition_times = [
        ...
        datetime(1990,  3,  4,  2,  0,  0), # -10800     0 ART
        datetime(1990, 10, 21,  3,  0,  0), #  -7200  3600 ARST
        datetime(1991,  3,  3,  2,  0,  0), # -10800     0 ART
        datetime(1991, 10, 20,  3,  0,  0), #  -7200  3600 ARST
        datetime(1992,  3,  1,  2,  0,  0), # -10800     0 ART
        datetime(1992, 10, 18,  3,  0,  0), #  -7200  3600 ARST
...
Buenos_Aires = Buenos_Aires() # Singleton
