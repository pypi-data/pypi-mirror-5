...
class Thule(DstTzInfo):
    ...
    _utc_transition_times = [
        datetime(   1,  1,  1,  0,  0,  0), # -16508     0 LMT
        datetime(1916,  7, 28,  4, 35,  8), # -14400     0 AST
        datetime(1991,  3, 31,  6,  0,  0), # -10800  3600 ADT
        datetime(1991,  9, 29,  5,  0,  0), # -14400     0 AST
        datetime(1992,  3, 29,  6,  0,  0), # -10800  3600 ADT
        datetime(1992,  9, 27,  5,  0,  0), # -14400     0 AST
