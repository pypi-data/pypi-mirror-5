...
class Longyearbyen(DstTzInfo):
    ...
    _zone = 'Arctic/Longyearbyen'

    _utc_transition_times = [
        datetime(   1,  1,  1,  0,  0,  0), #   3600     0 CET
        datetime(1916,  5, 22,  0,  0,  0), #   7200  3600 CEST
        datetime(1916,  9, 29, 22,  0,  0), #   3600     0 CET
        datetime(1940,  8, 10, 22,  0,  0), #   7200  3600 CEST
        ...
        datetime(1945, 10,  1,  1,  0,  0), #   3600     0 CET
        datetime(1959,  3, 15,  1,  0,  0), #   7200  3600 CEST
        datetime(1959,  9, 20,  1,  0,  0), #   3600     0 CET
        datetime(1960,  3, 20,  1,  0,  0), #   7200  3600 CEST
        datetime(1960,  9, 18,  1,  0,  0), #   3600     0 CET
        datetime(1961,  3, 19,  1,  0,  0), #   7200  3600 CEST
        datetime(1961,  9, 17,  1,  0,  0), #   3600     0 CET
        datetime(1962,  3, 18,  1,  0,  0), #   7200  3600 CEST
        datetime(1962,  9, 16,  1,  0,  0), #   3600     0 CET
        datetime(1963,  3, 17,  1,  0,  0), #   7200  3600 CEST
        datetime(1963,  9, 15,  1,  0,  0), #   3600     0 CET
        datetime(1964,  3, 15,  1,  0,  0), #   7200  3600 CEST
        datetime(1964,  9, 20,  1,  0,  0), #   3600     0 CET
        datetime(1965,  4, 25,  1,  0,  0), #   7200  3600 CEST
        datetime(1965,  9, 19,  1,  0,  0), #   3600     0 CET
        datetime(1979, 12, 31, 23,  0,  0), #   3600     0 CET
...
Longyearbyen = Longyearbyen() # Singleton
