...
class Central(DstTzInfo):
    ...
    _zone = 'Canada/Central'

    _utc_transition_times = [
        datetime(   1,  1,  1,  0,  0,  0), # -21600     0 CST
        datetime(1916,  4, 23,  6,  0,  0), # -18000  3600 CDT
        datetime(1916,  9, 17,  5,  0,  0), # -21600     0 CST
        datetime(1918,  4, 14,  8,  0,  0), # -18000  3600 CDT
        datetime(1918, 10, 31,  7,  0,  0), # -21600     0 CST
        datetime(1937,  5, 16,  8,  0,  0), # -18000  3600 CDT
        datetime(1937,  9, 26,  7,  0,  0), # -21600     0 CST
        datetime(1942,  2,  9,  8,  0,  0), # -18000  3600 CWT
        datetime(1945,  8, 14, 23,  0,  0), # -18000     0 CPT
        datetime(1945,  9, 30,  7,  0,  0), # -21600     0 CST
        datetime(1946,  5, 12,  8,  0,  0), # -18000  3600 CDT
        datetime(1946, 10, 13,  7,  0,  0), # -21600     0 CST
        ...
        datetime(1950,  5,  1,  8,  0,  0), # -18000  3600 CDT
        datetime(1950,  9, 30,  7,  0,  0), # -21600     0 CST
        ...
        datetime(1963,  4, 28,  8,  0,  0), # -18000  3600 CDT
        datetime(1963,  9, 22,  7,  0,  0), # -21600     0 CST
        datetime(1966,  4, 24,  8,  0,  0), # -18000  3600 CDT
        datetime(1966, 10, 30,  7,  0,  0), # -21600     0 CST
