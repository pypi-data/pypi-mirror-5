...
class Eastern(DstTzInfo):
    ...
    _zone = 'Canada/Eastern'

    _utc_transition_times = [
        datetime(   1,  1,  1,  0,  0,  0), # -18000     0 EST
        datetime(1918,  4, 14,  7,  0,  0), # -14400  3600 EDT
        datetime(1918, 10, 31,  6,  0,  0), # -18000     0 EST
        datetime(1919,  3, 31,  4, 30,  0), # -14400  3600 EDT
        datetime(1919, 10, 26,  4,  0,  0), # -18000     0 EST
        datetime(1920,  5,  2,  7,  0,  0), # -14400  3600 EDT
        datetime(1920,  9, 26,  4,  0,  0), # -18000     0 EST
        datetime(1921,  5, 15,  7,  0,  0), # -14400  3600 EDT
        datetime(1921,  9, 15,  6,  0,  0), # -18000     0 EST
        datetime(1922,  5, 14,  7,  0,  0), # -14400  3600 EDT
        datetime(1922,  9, 17,  6,  0,  0), # -18000     0 EST
        datetime(1923,  5, 13,  7,  0,  0), # -14400  3600 EDT
        datetime(1923,  9, 16,  6,  0,  0), # -18000     0 EST
        datetime(1924,  5,  4,  7,  0,  0), # -14400  3600 EDT
        datetime(1924,  9, 21,  6,  0,  0), # -18000     0 EST
        datetime(1925,  5,  3,  7,  0,  0), # -14400  3600 EDT
        datetime(1925,  9, 20,  6,  0,  0), # -18000     0 EST
        datetime(1926,  5,  2,  7,  0,  0), # -14400  3600 EDT
        datetime(1926,  9, 19,  6,  0,  0), # -18000     0 EST
        datetime(1927,  5,  1,  7,  0,  0), # -14400  3600 EDT
        ...
        datetime(1947,  4, 27,  5,  0,  0), # -14400  3600 EDT
        datetime(1947,  9, 28,  4,  0,  0), # -18000     0 EST
        datetime(1948,  4, 25,  5,  0,  0), # -14400  3600 EDT
        datetime(1948,  9, 26,  4,  0,  0), # -18000     0 EST
        datetime(1949,  4, 24,  5,  0,  0), # -14400  3600 EDT
        datetime(1949, 11, 27,  4,  0,  0), # -18000     0 EST
        datetime(1950,  4, 30,  7,  0,  0), # -14400  3600 EDT
        datetime(1950, 11, 26,  6,  0,  0), # -18000     0 EST
