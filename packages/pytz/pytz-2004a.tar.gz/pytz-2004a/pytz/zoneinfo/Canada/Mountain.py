...
class Mountain(DstTzInfo):
    ...
    _zone = 'Canada/Mountain'

    _utc_transition_times = [
        datetime(   1,  1,  1,  0,  0,  0), # -27232     0 LMT
        datetime(1906,  9,  1,  7, 33, 52), # -25200     0 MST
        datetime(1918,  4, 14,  9,  0,  0), # -21600  3600 MDT
        datetime(1918, 10, 31,  8,  0,  0), # -25200     0 MST
        datetime(1919,  4, 13,  9,  0,  0), # -21600  3600 MDT
        datetime(1919,  5, 27,  8,  0,  0), # -25200     0 MST
        datetime(1920,  4, 25,  9,  0,  0), # -21600  3600 MDT
        datetime(1920, 10, 31,  8,  0,  0), # -25200     0 MST
        datetime(1921,  4, 24,  9,  0,  0), # -21600  3600 MDT
        datetime(1921,  9, 25,  8,  0,  0), # -25200     0 MST
        datetime(1922,  4, 30,  9,  0,  0), # -21600  3600 MDT
        datetime(1922,  9, 24,  8,  0,  0), # -25200     0 MST
        datetime(1923,  4, 29,  9,  0,  0), # -21600  3600 MDT
        datetime(1923,  9, 30,  8,  0,  0), # -25200     0 MST
        ...
        datetime(1974,  4, 28,  9,  0,  0), # -21600  3600 MDT
        datetime(1974, 10, 27,  8,  0,  0), # -25200     0 MST
        datetime(1975,  4, 27,  9,  0,  0), # -21600  3600 MDT
