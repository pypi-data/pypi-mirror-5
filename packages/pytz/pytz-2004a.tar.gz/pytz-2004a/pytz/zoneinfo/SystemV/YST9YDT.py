...
class YST9YDT(DstTzInfo):
    ...
    _zone = 'SystemV/YST9YDT'

    _utc_transition_times = [
        datetime(   1,  1,  1,  0,  0,  0), # -36000     0 CAT
        datetime(1942,  2,  9, 12,  0,  0), # -32400  3600 CAWT
        datetime(1945,  8, 14, 23,  0,  0), # -32400     0 CAWT
        datetime(1945,  9, 30, 11,  0,  0), # -36000     0 CAT
        datetime(1967,  4,  1, 10,  0,  0), # -36000     0 AHST
        datetime(1969,  4, 27, 12,  0,  0), # -32400  3600 AHDT
        datetime(1969, 10, 26, 11,  0,  0), # -36000     0 AHST
        datetime(1970,  4, 26, 12,  0,  0), # -32400  3600 AHDT
        datetime(1970, 10, 25, 11,  0,  0), # -36000     0 AHST
        datetime(1971,  4, 25, 12,  0,  0), # -32400  3600 AHDT
        datetime(1971, 10, 31, 11,  0,  0), # -36000     0 AHST
        datetime(1972,  4, 30, 12,  0,  0), # -32400  3600 AHDT
        datetime(1972, 10, 29, 11,  0,  0), # -36000     0 AHST
        datetime(1973,  4, 29, 12,  0,  0), # -32400  3600 AHDT
        datetime(1973, 10, 28, 11,  0,  0), # -36000     0 AHST
        datetime(1974,  1,  6, 12,  0,  0), # -32400  3600 AHDT
        datetime(1974, 10, 27, 11,  0,  0), # -36000     0 AHST
        datetime(1975,  2, 23, 12,  0,  0), # -32400  3600 AHDT
        datetime(1975, 10, 26, 11,  0,  0), # -36000     0 AHST
        datetime(1976,  4, 25, 12,  0,  0), # -32400  3600 AHDT
        datetime(1976, 10, 31, 11,  0,  0), # -36000     0 AHST
        datetime(1977,  4, 24, 12,  0,  0), # -32400  3600 AHDT
        datetime(1977, 10, 30, 11,  0,  0), # -36000     0 AHST
        datetime(1978,  4, 30, 12,  0,  0), # -32400  3600 AHDT
        datetime(1978, 10, 29, 11,  0,  0), # -36000     0 AHST
        datetime(1979,  4, 29, 12,  0,  0), # -32400  3600 AHDT
        datetime(1979, 10, 28, 11,  0,  0), # -36000     0 AHST
        datetime(1980,  4, 27, 12,  0,  0), # -32400  3600 AHDT
        datetime(1980, 10, 26, 11,  0,  0), # -36000     0 AHST
        datetime(1981,  4, 26, 12,  0,  0), # -32400  3600 AHDT
        datetime(1981, 10, 25, 11,  0,  0), # -36000     0 AHST
        datetime(1982,  4, 25, 12,  0,  0), # -32400  3600 AHDT
        datetime(1982, 10, 31, 11,  0,  0), # -36000     0 AHST
        datetime(1983,  4, 24, 12,  0,  0), # -32400  3600 AHDT
        datetime(1983, 10, 30, 11,  0,  0), # -32400     0 YST
    ...
    _transition_info = [
        ttinfo(-36000,      0,  'CAT'),
        ttinfo(-32400,   3600, 'CAWT'),
        ttinfo(-32400,      0, 'CAWT'),
        ttinfo(-36000,      0,  'CAT'),
        ttinfo(-36000,      0, 'AHST'),
        ttinfo(-32400,   3600, 'AHDT'),
        ttinfo(-36000,      0, 'AHST'),
        ttinfo(-32400,   3600, 'AHDT'),
        ttinfo(-36000,      0, 'AHST'),
        ttinfo(-32400,   3600, 'AHDT'),
