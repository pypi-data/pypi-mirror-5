...
class Michigan(DstTzInfo):
    ...
    _utc_transition_times = [
        datetime(   1,  1,  1,  0,  0,  0), # -19931     0 LMT
        datetime(1905,  1,  1,  5, 32, 11), # -21600     0 CST
        datetime(1915,  5, 15,  8,  0,  0), # -18000     0 EST
        ...
        datetime(1967,  6, 14,  7,  0,  0), # -14400  3600 EDT
