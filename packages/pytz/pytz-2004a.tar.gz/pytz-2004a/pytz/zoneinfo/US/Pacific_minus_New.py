...
class Pacific_minus_New(DstTzInfo):
    ...
    _zone = 'US/Pacific_minus_New'

    _utc_transition_times = [
        datetime(   1,  1,  1,  0,  0,  0), # -28800     0 PST
        datetime(1918,  3, 31, 10,  0,  0), # -25200  3600 PDT
        datetime(1918, 10, 27,  9,  0,  0), # -28800     0 PST
        datetime(1919,  3, 30, 10,  0,  0), # -25200  3600 PDT
        datetime(1919, 10, 26,  9,  0,  0), # -28800     0 PST
        datetime(1942,  2,  9, 10,  0,  0), # -25200  3600 PWT
        datetime(1945,  8, 14, 23,  0,  0), # -25200     0 PPT
        datetime(1945,  9, 30,  9,  0,  0), # -28800     0 PST
        datetime(1948,  3, 14, 10,  0,  0), # -25200  3600 PDT
        datetime(1949,  1,  1,  9,  0,  0), # -28800     0 PST
...
Pacific_minus_New = Pacific_minus_New() # Singleton
