...
class Copenhagen(DstTzInfo):
    ...
    _zone = 'Europe/Copenhagen'

    _utc_transition_times = [
        datetime(   1,  1,  1,  0,  0,  0), #   3600     0 CET
        datetime(1916,  5, 14, 22,  0,  0), #   7200  3600 CEST
        datetime(1916,  9, 30, 21,  0,  0), #   3600     0 CET
        datetime(1940,  5, 14, 23,  0,  0), #   7200  3600 CEST
        ...
        datetime(1945,  8, 15,  1,  0,  0), #   3600     0 CET
        datetime(1946,  5,  1,  1,  0,  0), #   7200  3600 CEST
        datetime(1946,  9,  1,  1,  0,  0), #   3600     0 CET
        datetime(1947,  5,  4,  1,  0,  0), #   7200  3600 CEST
        datetime(1947,  8, 10,  1,  0,  0), #   3600     0 CET
        datetime(1948,  5,  9,  1,  0,  0), #   7200  3600 CEST
        datetime(1948,  8,  8,  1,  0,  0), #   3600     0 CET
...
Copenhagen = Copenhagen() # Singleton
