...
class Budapest(DstTzInfo):
    ...
    _utc_transition_times = [
        ...
        datetime(1917, 12, 31, 23,  0,  0), #   3600     0 CET
        datetime(1918,  4,  1,  2,  0,  0), #   7200  3600 CEST
        datetime(1918,  9, 29,  1,  0,  0), #   3600     0 CET
        datetime(1919,  4, 15,  2,  0,  0), #   7200  3600 CEST
        datetime(1919,  9, 15,  1,  0,  0), #   3600     0 CET
        datetime(1920,  4,  5,  2,  0,  0), #   7200  3600 CEST
        datetime(1920,  9, 30,  1,  0,  0), #   3600     0 CET
        datetime(1941,  4,  6,  1,  0,  0), #   7200  3600 CEST
        ...
        datetime(1945,  5,  1, 22,  0,  0), #   7200  3600 CEST
        datetime(1945, 11,  2, 22,  0,  0), #   3600     0 CET
        datetime(1946,  3, 31,  1,  0,  0), #   7200  3600 CEST
        datetime(1946, 10,  6,  1,  0,  0), #   3600     0 CET
        datetime(1947,  4,  6,  1,  0,  0), #   7200  3600 CEST
        datetime(1947, 10,  5,  1,  0,  0), #   3600     0 CET
        datetime(1948,  4,  4,  1,  0,  0), #   7200  3600 CEST
        datetime(1948, 10,  3,  1,  0,  0), #   3600     0 CET
        datetime(1949,  4, 10,  1,  0,  0), #   7200  3600 CEST
        datetime(1949, 10,  2,  1,  0,  0), #   3600     0 CET
        datetime(1950,  4, 17,  1,  0,  0), #   7200  3600 CEST
        datetime(1950, 10, 23,  1,  0,  0), #   3600     0 CET
        datetime(1954,  5, 22, 23,  0,  0), #   7200  3600 CEST
        datetime(1954, 10,  2, 22,  0,  0), #   3600     0 CET
        datetime(1955,  5, 22, 23,  0,  0), #   7200  3600 CEST
        datetime(1955, 10,  2, 22,  0,  0), #   3600     0 CET
        datetime(1956,  6,  2, 23,  0,  0), #   7200  3600 CEST
        datetime(1956,  9, 29, 22,  0,  0), #   3600     0 CET
        datetime(1957,  6,  2,  0,  0,  0), #   7200  3600 CEST
        datetime(1957,  9, 29,  1,  0,  0), #   3600     0 CET
