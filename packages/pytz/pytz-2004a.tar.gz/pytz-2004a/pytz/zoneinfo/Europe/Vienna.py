...
class Vienna(DstTzInfo):
    ...
    _utc_transition_times = [
        ...
        datetime(1919, 12, 31, 23,  0,  0), #   3600     0 CET
        datetime(1920,  4,  5,  1,  0,  0), #   7200  3600 CEST
        datetime(1920,  9, 13,  1,  0,  0), #   3600     0 CET
        ...
        datetime(1945,  4, 12,  1,  0,  0), #   3600     0 CET
        datetime(1945, 12, 31, 23,  0,  0), #   3600     0 CET
        ...
        datetime(1980,  4,  5, 23,  0,  0), #   7200  3600 CEST
        datetime(1980,  9, 27, 22,  0,  0), #   3600     0 CET
