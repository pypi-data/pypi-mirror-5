...
class Brussels(DstTzInfo):
    ...
    _utc_transition_times = [
        ...
        datetime(1914, 11,  8,  0,  0,  0), #   3600     0 CET
        datetime(1916,  4, 30, 23,  0,  0), #   7200  3600 CEST
        ...
        datetime(1918, 11, 11, 11,  0,  0), #      0     0 WET
        datetime(1919,  3,  1, 23,  0,  0), #   3600  3600 WEST
        datetime(1919, 10,  4, 23,  0,  0), #      0     0 WET
        ...
        datetime(1928, 10,  7,  2,  0,  0), #      0     0 WET
        datetime(1929,  4, 21,  2,  0,  0), #   3600  3600 WEST
        ...
        datetime(1940,  5, 20,  2,  0,  0), #   7200  3600 CEST
        ...
        datetime(1944,  9,  2, 22,  0,  0), #   7200     0 CEST
        datetime(1944,  9, 17,  1,  0,  0), #   3600     0 CET
