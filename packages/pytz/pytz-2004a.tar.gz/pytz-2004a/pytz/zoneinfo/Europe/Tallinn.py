...
class Tallinn(DstTzInfo):
    ...
    _zone = 'Europe/Tallinn'

    _utc_transition_times = [
        datetime(   1,  1,  1,  0,  0,  0), #   5940     0 TMT
        datetime(1918,  1, 31, 22, 21,  0), #   3600     0 CET
        datetime(1918,  4, 15,  1,  0,  0), #   7200  3600 CEST
        datetime(1918,  9, 16,  1,  0,  0), #   3600     0 CET
        datetime(1919,  6, 30, 23,  0,  0), #   5940     0 TMT
        datetime(1921,  4, 30, 22, 21,  0), #   7200     0 EET
        datetime(1940,  8,  5, 22,  0,  0), #  10800     0 MSK
        datetime(1941,  9, 14, 21,  0,  0), #   7200 -3600 CEST
        ...
        datetime(1944,  9, 21, 22,  0,  0), #  10800     0 MSK
