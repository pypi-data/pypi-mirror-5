...
class Belgrade(DstTzInfo):
    ...
    _zone = 'Europe/Belgrade'

    _utc_transition_times = [
        datetime(   1,  1,  1,  0,  0,  0), #   3600     0 CET
        datetime(1941,  4, 18, 22,  0,  0), #   7200  3600 CEST
        ...
        datetime(1945,  5,  8,  1,  0,  0), #   7200  3600 CEST
        datetime(1945,  9, 16,  1,  0,  0), #   3600     0 CET
        datetime(1982, 11, 26, 23,  0,  0), #   3600     0 CET
