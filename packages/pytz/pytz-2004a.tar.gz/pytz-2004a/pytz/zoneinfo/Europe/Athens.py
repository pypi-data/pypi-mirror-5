...
class Athens(DstTzInfo):
    ...
    _utc_transition_times = [
        datetime(   1,  1,  1,  0,  0,  0), #   5692     0 AMT
        datetime(1916,  7, 27, 22, 26,  8), #   7200     0 EET
        datetime(1932,  7,  6, 22,  0,  0), #  10800  3600 EEST
        datetime(1932,  8, 31, 21,  0,  0), #   7200     0 EET
        datetime(1941,  4,  6, 22,  0,  0), #  10800  3600 EEST
        datetime(1941,  4, 29, 21,  0,  0), #   7200 -3600 CEST
        datetime(1942, 11,  2,  1,  0,  0), #   3600     0 CET
        datetime(1943,  3, 29, 23,  0,  0), #   7200  3600 CEST
        datetime(1943, 10,  3, 22,  0,  0), #   3600     0 CET
        datetime(1944,  4,  3, 23,  0,  0), #   7200     0 EET
        datetime(1952,  6, 30, 22,  0,  0), #  10800  3600 EEST
        datetime(1952, 11,  1, 21,  0,  0), #   7200     0 EET
        datetime(1975,  4, 11, 22,  0,  0), #  10800  3600 EEST
        datetime(1975, 11, 25, 22,  0,  0), #   7200     0 EET
        datetime(1976,  4, 11,  0,  0,  0), #  10800  3600 EEST
        datetime(1976, 10, 10,  0,  0,  0), #   7200     0 EET
        datetime(1977,  4,  3,  0,  0,  0), #  10800  3600 EEST
        datetime(1977,  9, 26,  0,  0,  0), #   7200     0 EET
        datetime(1978,  4,  2,  0,  0,  0), #  10800  3600 EEST
        datetime(1978,  9, 24,  1,  0,  0), #   7200     0 EET
        datetime(1979,  4,  1,  7,  0,  0), #  10800  3600 EEST
        datetime(1979,  9, 28, 23,  0,  0), #   7200     0 EET
        datetime(1980,  3, 31, 22,  0,  0), #  10800  3600 EEST
