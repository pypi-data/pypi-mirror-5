...
class Zurich(DstTzInfo):
    ...
    _utc_transition_times = [
        ...
        datetime(1940, 11,  1, 23,  0,  0), #   7200  3600 CEST
        datetime(1940, 12, 30, 22,  0,  0), #   3600     0 CET
        datetime(1941,  5,  4,  1,  0,  0), #   7200  3600 CEST
        datetime(1941, 10,  4, 22,  0,  0), #   3600     0 CET
        datetime(1942,  5,  3,  1,  0,  0), #   7200  3600 CEST
        datetime(1942, 10,  3, 22,  0,  0), #   3600     0 CET
