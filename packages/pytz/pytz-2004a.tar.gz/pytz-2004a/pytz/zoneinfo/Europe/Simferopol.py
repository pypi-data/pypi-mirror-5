...
class Simferopol(DstTzInfo):
    ...
    _zone = 'Europe/Simferopol'

    _utc_transition_times = [
        datetime(   1,  1,  1,  0,  0,  0), #   8160     0 SMT
        datetime(1924,  5,  1, 21, 44,  0), #   7200     0 EET
        datetime(1930,  6, 20, 22,  0,  0), #  10800     0 MSK
        datetime(1941, 10, 31, 21,  0,  0), #   7200 -3600 CEST
        ...
        datetime(1944,  4, 12, 22,  0,  0), #  10800     0 MSK
        ...
        datetime(1990,  6, 30, 23,  0,  0), #   7200     0 EET
        ...
        datetime(1994,  4, 30, 21,  0,  0), #  14400  3600 MSD
        datetime(1994,  9, 24, 20,  0,  0), #  10800     0 MSK
        datetime(1995,  3, 25, 21,  0,  0), #  14400  3600 MSD
        datetime(1995,  9, 23, 20,  0,  0), #  10800     0 MSK
        datetime(1996,  3, 30, 21,  0,  0), #  14400  3600 MSD
        datetime(1996,  3, 31,  0,  0,  0), #  14400     0 MSD
        datetime(1996, 10, 27,  0,  0,  0), #  10800     0 MSK
        datetime(1996, 12, 31, 21,  0,  0), #  10800     0 MSK
        datetime(1997,  3, 30,  1,  0,  0), #  10800     0 EEST
...
Simferopol = Simferopol() # Singleton
