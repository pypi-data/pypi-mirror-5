...
class Berlin(DstTzInfo):
    ...
    _utc_transition_times = [
        ...
        datetime(1945,  5, 24,  0,  0,  0), #  10800  3600 CEMT
        datetime(1945,  9, 24,  0,  0,  0), #   7200 -3600 CEST
        datetime(1945, 11, 18,  1,  0,  0), #   3600     0 CET
        datetime(1946,  4, 14,  1,  0,  0), #   7200  3600 CEST
        datetime(1946, 10,  7,  1,  0,  0), #   3600     0 CET
        datetime(1947,  4,  6,  1,  0,  0), #   7200  3600 CEST
        datetime(1947,  5, 11,  1,  0,  0), #  10800  3600 CEMT
        datetime(1947,  6, 29,  0,  0,  0), #   7200 -3600 CEST
        datetime(1947, 10,  5,  1,  0,  0), #   3600     0 CET
        datetime(1948,  4, 18,  1,  0,  0), #   7200  3600 CEST
