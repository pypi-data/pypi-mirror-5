...
class Minsk(DstTzInfo):
    ...
    _utc_transition_times = [
        datetime(   1,  1,  1,  0,  0,  0), #   6600     0 MMT
        datetime(1924,  5,  1, 22, 10,  0), #   7200     0 EET
        datetime(1930,  6, 20, 22,  0,  0), #  10800     0 MSK
        datetime(1941,  6, 27, 21,  0,  0), #   7200 -3600 CEST
        ...
        datetime(1944,  7,  2, 22,  0,  0), #  10800     0 MSK
