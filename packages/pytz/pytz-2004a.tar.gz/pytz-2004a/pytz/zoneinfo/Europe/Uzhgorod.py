...
class Uzhgorod(DstTzInfo):
    ...
    _utc_transition_times = [
        ...
        datetime(1944,  9, 30, 22,  0,  0), #   7200     0 CEST
        datetime(1944, 10, 25, 22,  0,  0), #   3600     0 CET
        datetime(1945,  6, 28, 23,  0,  0), #  10800     0 MSK
        ...
        datetime(1990,  6, 30, 23,  0,  0), #   3600     0 CET
        datetime(1991,  3, 31,  2,  0,  0), #   7200     0 EET
