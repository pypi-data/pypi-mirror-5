...
class Madrid(DstTzInfo):
    ...
    _utc_transition_times = [
        ...
        datetime(1917,  5,  5, 23,  0,  0), #   3600  3600 WEST
        datetime(1917, 10,  6, 23,  0,  0), #      0     0 WET
        datetime(1918,  4, 15, 23,  0,  0), #   3600  3600 WEST
        datetime(1918, 10,  6, 23,  0,  0), #      0     0 WET
        datetime(1919,  4,  5, 23,  0,  0), #   3600  3600 WEST
        datetime(1919, 10,  6, 23,  0,  0), #      0     0 WET
        ...
        datetime(1937,  5, 22, 23,  0,  0), #   3600  3600 WEST
        datetime(1937, 10,  2, 23,  0,  0), #      0     0 WET
        datetime(1938,  3, 22, 23,  0,  0), #   3600  3600 WEST
        datetime(1938, 10,  1, 23,  0,  0), #      0     0 WET
        datetime(1939,  4, 15, 23,  0,  0), #   3600  3600 WEST
        datetime(1939, 10,  7, 23,  0,  0), #      0     0 WET
        datetime(1940,  3, 16, 23,  0,  0), #   3600  3600 WEST
        datetime(1942,  5,  2, 22,  0,  0), #   7200  3600 WEMT
        datetime(1942,  9,  1, 22,  0,  0), #   3600 -3600 WEST
        datetime(1943,  4, 17, 22,  0,  0), #   7200  3600 WEMT
        datetime(1943, 10,  3, 22,  0,  0), #   3600 -3600 WEST
        datetime(1944,  4, 15, 22,  0,  0), #   7200  3600 WEMT
        datetime(1944, 10, 10, 22,  0,  0), #   3600 -3600 WEST
        datetime(1945,  4, 14, 22,  0,  0), #   7200  3600 WEMT
        datetime(1945,  9, 29, 23,  0,  0), #   3600 -3600 WEST
        datetime(1946,  4, 13, 22,  0,  0), #   7200  3600 WEMT
        datetime(1946,  9, 29, 22,  0,  0), #   3600     0 CET
        datetime(1949,  4, 30, 22,  0,  0), #   7200  3600 CEST
        datetime(1949,  9, 29, 23,  0,  0), #   3600     0 CET
        datetime(1974,  4, 13, 22,  0,  0), #   7200  3600 CEST
        datetime(1974, 10,  5, 23,  0,  0), #   3600     0 CET
        datetime(1975,  4, 19, 22,  0,  0), #   7200  3600 CEST
        datetime(1975, 10,  4, 23,  0,  0), #   3600     0 CET
        datetime(1976,  3, 27, 22,  0,  0), #   7200  3600 CEST
        datetime(1976,  9, 25, 23,  0,  0), #   3600     0 CET
        datetime(1977,  4,  2, 22,  0,  0), #   7200  3600 CEST
        datetime(1977,  9, 24, 23,  0,  0), #   3600     0 CET
        datetime(1978,  4,  2, 22,  0,  0), #   7200  3600 CEST
