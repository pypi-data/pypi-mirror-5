...
class Sofia(DstTzInfo):
    ...
    _utc_transition_times = [
        ...
        datetime(1945,  4,  2,  2,  0,  0), #   7200     0 EET
        datetime(1979,  3, 31, 21,  0,  0), #  10800  3600 EEST
        datetime(1979,  9, 30, 22,  0,  0), #   7200     0 EET
        datetime(1980,  4,  5, 21,  0,  0), #  10800  3600 EEST
        datetime(1980,  9, 28, 22,  0,  0), #   7200     0 EET
        datetime(1981,  4,  4, 21,  0,  0), #  10800  3600 EEST
        datetime(1981,  9, 26, 23,  0,  0), #   7200     0 EET
        datetime(1982,  4,  3, 21,  0,  0), #  10800  3600 EEST
