...
class San_Marino(DstTzInfo):
    ...
    _utc_transition_times = [
        ...
        datetime(1944,  6, 30, 22,  0,  0), #   7200     0 CEST
        datetime(1944,  9, 16, 23,  0,  0), #   3600     0 CET
        ...
        datetime(1973,  6,  2, 23,  0,  0), #   7200  3600 CEST
        datetime(1973,  9, 29, 22,  0,  0), #   3600     0 CET
        datetime(1974,  5, 25, 23,  0,  0), #   7200  3600 CEST
        datetime(1974,  9, 28, 22,  0,  0), #   3600     0 CET
        datetime(1975,  5, 31, 23,  0,  0), #   7200  3600 CEST
        datetime(1975,  9, 27, 23,  0,  0), #   3600     0 CET
        datetime(1976,  5, 29, 23,  0,  0), #   7200  3600 CEST
        datetime(1976,  9, 25, 23,  0,  0), #   3600     0 CET
        datetime(1977,  5, 21, 23,  0,  0), #   7200  3600 CEST
        datetime(1977,  9, 24, 23,  0,  0), #   3600     0 CET
        datetime(1978,  5, 27, 23,  0,  0), #   7200  3600 CEST
        datetime(1978,  9, 30, 23,  0,  0), #   3600     0 CET
        datetime(1979,  5, 26, 23,  0,  0), #   7200  3600 CEST
        datetime(1979,  9, 29, 23,  0,  0), #   3600     0 CET
...
San_Marino = San_Marino() # Singleton
