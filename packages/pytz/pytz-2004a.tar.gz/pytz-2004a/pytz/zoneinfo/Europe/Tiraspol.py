...
class Tiraspol(DstTzInfo):
    ...
    _zone = 'Europe/Tiraspol'

    _utc_transition_times = [
        datetime(   1,  1,  1,  0,  0,  0), #   6900     0 CMT
        datetime(1918,  2, 14, 22,  5,  0), #   6264     0 BMT
        ...
        datetime(1940,  8, 14, 22,  0,  0), #  10800  3600 EEST
        datetime(1941,  7, 16, 21,  0,  0), #   7200 -3600 CEST
        ...
        datetime(1944,  8, 23, 22,  0,  0), #  10800     0 MSK
        ...
        datetime(1989, 12, 31, 21,  0,  0), #  10800     0 MSK
        datetime(1990,  5,  5, 21,  0,  0), #   7200     0 EET
        datetime(1991,  3, 31,  0,  0,  0), #  10800  3600 EEST
        datetime(1991,  9, 29,  0,  0,  0), #   7200     0 EET
        datetime(1991, 12, 31, 22,  0,  0), #   7200     0 EET
