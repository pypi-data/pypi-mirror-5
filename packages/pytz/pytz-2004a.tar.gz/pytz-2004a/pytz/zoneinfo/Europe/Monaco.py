...
class Monaco(DstTzInfo):
    ...
    _utc_transition_times = [
        ...
        datetime(1911,  3, 10, 23, 50, 39), #      0     0 WET
        datetime(1916,  6, 14, 23,  0,  0), #   3600  3600 WEST
        datetime(1916, 10,  1, 23,  0,  0), #      0     0 WET
        datetime(1917,  3, 24, 23,  0,  0), #   3600  3600 WEST
        datetime(1917, 10,  7, 23,  0,  0), #      0     0 WET
        datetime(1918,  3,  9, 23,  0,  0), #   3600  3600 WEST
        datetime(1918, 10,  6, 23,  0,  0), #      0     0 WET
        datetime(1919,  3,  1, 23,  0,  0), #   3600  3600 WEST
        datetime(1919, 10,  5, 23,  0,  0), #      0     0 WET
        datetime(1920,  2, 14, 23,  0,  0), #   3600  3600 WEST
        datetime(1920, 10, 23, 23,  0,  0), #      0     0 WET
        datetime(1921,  3, 14, 23,  0,  0), #   3600  3600 WEST
        datetime(1921, 10, 25, 23,  0,  0), #      0     0 WET
        datetime(1922,  3, 25, 23,  0,  0), #   3600  3600 WEST
        datetime(1922, 10,  7, 23,  0,  0), #      0     0 WET
        datetime(1923,  5, 26, 23,  0,  0), #   3600  3600 WEST
        datetime(1923, 10,  6, 23,  0,  0), #      0     0 WET
        datetime(1924,  3, 29, 23,  0,  0), #   3600  3600 WEST
        datetime(1924, 10,  4, 23,  0,  0), #      0     0 WET
        datetime(1925,  4,  4, 23,  0,  0), #   3600  3600 WEST
        datetime(1925, 10,  3, 23,  0,  0), #      0     0 WET
        ...
        datetime(1930,  4, 12, 23,  0,  0), #   3600  3600 WEST
        datetime(1930, 10,  4, 23,  0,  0), #      0     0 WET
        ...
        datetime(1933,  3, 25, 23,  0,  0), #   3600  3600 WEST
        datetime(1933, 10,  7, 23,  0,  0), #      0     0 WET
        ...
        datetime(1941,  5,  4, 23,  0,  0), #   7200  3600 WEMT
        datetime(1941, 10,  5, 22,  0,  0), #   3600 -3600 WEST
        datetime(1942,  3,  8, 23,  0,  0), #   7200  3600 WEMT
        datetime(1942, 11,  2,  1,  0,  0), #   3600 -3600 WEST
        datetime(1943,  3, 29,  1,  0,  0), #   7200  3600 WEMT
        datetime(1943, 10,  4,  1,  0,  0), #   3600 -3600 WEST
        datetime(1944,  4,  3,  1,  0,  0), #   7200  3600 WEMT
        datetime(1944, 10,  7, 23,  0,  0), #   3600 -3600 WEST
        datetime(1945,  4,  2,  1,  0,  0), #   7200  3600 WEMT
        datetime(1945,  9, 16,  1,  0,  0), #   3600     0 CET
        datetime(1976,  3, 28,  0,  0,  0), #   7200  3600 CEST
