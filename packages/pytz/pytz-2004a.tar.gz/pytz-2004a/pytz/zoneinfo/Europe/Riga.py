...
class Riga(DstTzInfo):
    ...
    _utc_transition_times = [
        datetime(   1,  1,  1,  0,  0,  0), #   5784     0 RMT
        datetime(1918,  4, 15,  0, 23, 36), #   9384  3600 LST
        datetime(1918,  9, 16,  0, 23, 36), #   5784     0 RMT
        datetime(1919,  4,  1,  0, 23, 36), #   9384  3600 LST
        datetime(1919,  5, 22,  0, 23, 36), #   5784     0 RMT
        datetime(1926,  5, 10, 22, 23, 36), #   7200     0 EET
        datetime(1940,  8,  4, 22,  0,  0), #  10800     0 MSK
        datetime(1941,  6, 30, 21,  0,  0), #   7200 -3600 CEST
        ...
        datetime(1944, 10, 12, 23,  0,  0), #  10800     0 MSK
        ...
        datetime(1989,  3, 25, 23,  0,  0), #  10800     0 EEST
        ...
        datetime(1992,  3, 29,  0,  0,  0), #  10800  3600 EEST
        datetime(1992,  9, 27,  0,  0,  0), #   7200     0 EET
        ...
        datetime(1996,  9, 29,  0,  0,  0), #   7200     0 EET
        datetime(1997,  1, 20, 22,  0,  0), #   7200     0 EET
        ...
        datetime(2000,  2, 28, 22,  0,  0), #   7200     0 EET
