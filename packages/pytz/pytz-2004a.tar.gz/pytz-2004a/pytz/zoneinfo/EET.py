...
class EET(DstTzInfo):
    ...
    _utc_transition_times = [
        ...
        datetime(1977,  4,  3,  1,  0,  0), #  10800  3600 EEST
        datetime(1977,  9, 25,  1,  0,  0), #   7200     0 EET
        datetime(1978,  4,  2,  1,  0,  0), #  10800  3600 EEST
        datetime(1978, 10,  1,  1,  0,  0), #   7200     0 EET
        datetime(1979,  4,  1,  1,  0,  0), #  10800  3600 EEST
        datetime(1979,  9, 30,  1,  0,  0), #   7200     0 EET
        datetime(1980,  4,  6,  1,  0,  0), #  10800  3600 EEST
        datetime(1980,  9, 28,  1,  0,  0), #   7200     0 EET
