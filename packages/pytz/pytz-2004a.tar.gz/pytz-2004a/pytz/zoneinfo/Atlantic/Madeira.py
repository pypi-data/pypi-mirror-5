...
class Madeira(DstTzInfo):
    ...
    _utc_transition_times = [
        datetime(   1,  1,  1,  0,  0,  0), #  -4056     0 FMT
        datetime(1911,  5, 24,  1,  7, 36), #  -3600     0 MADT
        datetime(1916,  6, 18,  0,  0,  0), #      0  3600 MADST
        datetime(1916, 11,  1,  1,  0,  0), #  -3600     0 MADT
        datetime(1917,  3,  1,  0,  0,  0), #      0  3600 MADST
        datetime(1917, 10, 15,  0,  0,  0), #  -3600     0 MADT
        datetime(1918,  3,  2,  0,  0,  0), #      0  3600 MADST
        datetime(1918, 10, 15,  0,  0,  0), #  -3600     0 MADT
        datetime(1919,  3,  1,  0,  0,  0), #      0  3600 MADST
        datetime(1919, 10, 15,  0,  0,  0), #  -3600     0 MADT
        datetime(1920,  3,  1,  0,  0,  0), #      0  3600 MADST
        datetime(1920, 10, 15,  0,  0,  0), #  -3600     0 MADT
        datetime(1921,  3,  1,  0,  0,  0), #      0  3600 MADST
        datetime(1921, 10, 15,  0,  0,  0), #  -3600     0 MADT
        datetime(1924,  4, 17,  0,  0,  0), #      0  3600 MADST
        datetime(1924, 10, 15,  0,  0,  0), #  -3600     0 MADT
        datetime(1926,  4, 18,  0,  0,  0), #      0  3600 MADST
        datetime(1926, 10,  3,  0,  0,  0), #  -3600     0 MADT
        datetime(1927,  4, 10,  0,  0,  0), #      0  3600 MADST
        datetime(1927, 10,  2,  0,  0,  0), #  -3600     0 MADT
        datetime(1928,  4, 15,  0,  0,  0), #      0  3600 MADST
        datetime(1928, 10,  7,  0,  0,  0), #  -3600     0 MADT
        datetime(1929,  4, 21,  0,  0,  0), #      0  3600 MADST
        datetime(1929, 10,  6,  0,  0,  0), #  -3600     0 MADT
        datetime(1931,  4, 19,  0,  0,  0), #      0  3600 MADST
        datetime(1931, 10,  4,  0,  0,  0), #  -3600     0 MADT
        datetime(1932,  4,  3,  0,  0,  0), #      0  3600 MADST
        datetime(1932, 10,  2,  0,  0,  0), #  -3600     0 MADT
        datetime(1934,  4,  8,  0,  0,  0), #      0  3600 MADST
        datetime(1934, 10,  7,  0,  0,  0), #  -3600     0 MADT
        datetime(1935,  3, 31,  0,  0,  0), #      0  3600 MADST
        datetime(1935, 10,  6,  0,  0,  0), #  -3600     0 MADT
        datetime(1936,  4, 19,  0,  0,  0), #      0  3600 MADST
        datetime(1936, 10,  4,  0,  0,  0), #  -3600     0 MADT
        datetime(1937,  4,  4,  0,  0,  0), #      0  3600 MADST
        datetime(1937, 10,  3,  0,  0,  0), #  -3600     0 MADT
        datetime(1938,  3, 27,  0,  0,  0), #      0  3600 MADST
        datetime(1938, 10,  2,  0,  0,  0), #  -3600     0 MADT
        datetime(1939,  4, 16,  0,  0,  0), #      0  3600 MADST
        datetime(1939, 11, 19,  0,  0,  0), #  -3600     0 MADT
        datetime(1940,  2, 25,  0,  0,  0), #      0  3600 MADST
        datetime(1940, 10,  6,  0,  0,  0), #  -3600     0 MADT
        datetime(1941,  4,  6,  0,  0,  0), #      0  3600 MADST
        datetime(1941, 10,  6,  0,  0,  0), #  -3600     0 MADT
        datetime(1942,  3, 15,  0,  0,  0), #      0  3600 MADST
        datetime(1942,  4, 25, 23,  0,  0), #   3600  3600 MADMT
        datetime(1942,  8, 15, 23,  0,  0), #      0 -3600 MADST
        datetime(1942, 10, 25,  0,  0,  0), #  -3600     0 MADT
        datetime(1943,  3, 14,  0,  0,  0), #      0  3600 MADST
        datetime(1943,  4, 17, 23,  0,  0), #   3600  3600 MADMT
        datetime(1943,  8, 28, 23,  0,  0), #      0 -3600 MADST
        datetime(1943, 10, 31,  0,  0,  0), #  -3600     0 MADT
        datetime(1944,  3, 12,  0,  0,  0), #      0  3600 MADST
        datetime(1944,  4, 22, 23,  0,  0), #   3600  3600 MADMT
        datetime(1944,  8, 26, 23,  0,  0), #      0 -3600 MADST
        datetime(1944, 10, 29,  0,  0,  0), #  -3600     0 MADT
        datetime(1945,  3, 11,  0,  0,  0), #      0  3600 MADST
        datetime(1945,  4, 21, 23,  0,  0), #   3600  3600 MADMT
        datetime(1945,  8, 25, 23,  0,  0), #      0 -3600 MADST
        datetime(1945, 10, 28,  0,  0,  0), #  -3600     0 MADT
        datetime(1946,  4,  7,  0,  0,  0), #      0  3600 MADST
        datetime(1946, 10,  6,  0,  0,  0), #  -3600     0 MADT
        datetime(1947,  4,  6,  3,  0,  0), #      0  3600 MADST
        datetime(1947, 10,  5,  3,  0,  0), #  -3600     0 MADT
        datetime(1948,  4,  4,  3,  0,  0), #      0  3600 MADST
        datetime(1948, 10,  3,  3,  0,  0), #  -3600     0 MADT
        datetime(1949,  4,  3,  3,  0,  0), #      0  3600 MADST
        datetime(1949, 10,  2,  3,  0,  0), #  -3600     0 MADT
        datetime(1951,  4,  1,  3,  0,  0), #      0  3600 MADST
        datetime(1951, 10,  7,  3,  0,  0), #  -3600     0 MADT
        datetime(1952,  4,  6,  3,  0,  0), #      0  3600 MADST
        datetime(1952, 10,  5,  3,  0,  0), #  -3600     0 MADT
        datetime(1953,  4,  5,  3,  0,  0), #      0  3600 MADST
        datetime(1953, 10,  4,  3,  0,  0), #  -3600     0 MADT
        datetime(1954,  4,  4,  3,  0,  0), #      0  3600 MADST
        datetime(1954, 10,  3,  3,  0,  0), #  -3600     0 MADT
        datetime(1955,  4,  3,  3,  0,  0), #      0  3600 MADST
        datetime(1955, 10,  2,  3,  0,  0), #  -3600     0 MADT
        datetime(1956,  4,  1,  3,  0,  0), #      0  3600 MADST
        datetime(1956, 10,  7,  3,  0,  0), #  -3600     0 MADT
        datetime(1957,  4,  7,  3,  0,  0), #      0  3600 MADST
        datetime(1957, 10,  6,  3,  0,  0), #  -3600     0 MADT
        datetime(1958,  4,  6,  3,  0,  0), #      0  3600 MADST
        datetime(1958, 10,  5,  3,  0,  0), #  -3600     0 MADT
        datetime(1959,  4,  5,  3,  0,  0), #      0  3600 MADST
        datetime(1959, 10,  4,  3,  0,  0), #  -3600     0 MADT
        datetime(1960,  4,  3,  3,  0,  0), #      0  3600 MADST
        datetime(1960, 10,  2,  3,  0,  0), #  -3600     0 MADT
        datetime(1961,  4,  2,  3,  0,  0), #      0  3600 MADST
        datetime(1961, 10,  1,  3,  0,  0), #  -3600     0 MADT
        datetime(1962,  4,  1,  3,  0,  0), #      0  3600 MADST
        datetime(1962, 10,  7,  3,  0,  0), #  -3600     0 MADT
        datetime(1963,  4,  7,  3,  0,  0), #      0  3600 MADST
        datetime(1963, 10,  6,  3,  0,  0), #  -3600     0 MADT
        datetime(1964,  4,  5,  3,  0,  0), #      0  3600 MADST
        datetime(1964, 10,  4,  3,  0,  0), #  -3600     0 MADT
        datetime(1965,  4,  4,  3,  0,  0), #      0  3600 MADST
        datetime(1965, 10,  3,  3,  0,  0), #  -3600     0 MADT
        datetime(1966,  4,  3,  3,  0,  0), #      0     0 WET
