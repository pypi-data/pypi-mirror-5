...
class Canary(DstTzInfo):
    ...
    _utc_transition_times = [
        datetime(   1,  1,  1,  0,  0,  0), #  -3696     0 LMT
        datetime(1922,  3,  1,  1,  1, 36), #  -3600     0 CANT
        datetime(1946,  9, 30,  2,  0,  0), #      0     0 WET
        datetime(1980,  4,  6,  0,  0,  0), #   3600  3600 WEST
