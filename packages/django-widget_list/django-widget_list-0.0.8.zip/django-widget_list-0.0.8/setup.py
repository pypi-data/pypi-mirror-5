...
setup(
    ...
    license = "BSD",
    keywords = "pagination",
    url = "https://github.com/davidrenne/widget_list",
    packages=['widget_list'],
    package_data={
        'widget_list': [
            'static_widget_list/assets/stylesheets/*.css',
            'static_widget_list/assets/images/*',
            'static_widget_list/assets/images/buttons/regular/green/*',
            'static_widget_list/assets/images/buttons/small/green/*',
            'static_widget_list/assets/images/gobblecons/dark-gray/*', 
            'static_widget_list/assets/images/gobblecons/light-gray/*', 
            'static_widget_list/assets/images/gobblecons/mid-gray/*', 
            'static_widget_list/assets/images/gobblecons/lime/*', 
            'static_widget_list/assets/images/gobblecons/teal/*', 
            'static_widget_list/assets/javascripts/*.js',
        ],
    },
