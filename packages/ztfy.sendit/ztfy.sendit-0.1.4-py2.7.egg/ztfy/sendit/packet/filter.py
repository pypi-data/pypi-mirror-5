    ...
    def filterElement(self, config, filename, data):
        ...
        if extensions:
            ...
            if '.' + ext in extensions:
                raise FilteredPacketException, \
                      translate(_("A document containing invalid data (%s) has been uploaded. Your packet has been rejected."), context=queryRequest()) % filename
        # check MIME types
