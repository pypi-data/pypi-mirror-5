...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LineItem.started'
        db.add_column('spreedly_lineitem', 'started',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'LineItem.reference'
        db.add_column('spreedly_lineitem', 'reference',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True),
                      keep_default=False)

        # Adding field 'LineItem.error_code'
        db.add_column('spreedly_lineitem', 'error_code',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LineItem.started'
        db.delete_column('spreedly_lineitem', 'started')

        # Deleting field 'LineItem.reference'
        db.delete_column('spreedly_lineitem', 'reference')

        # Deleting field 'LineItem.error_code'
        db.delete_column('spreedly_lineitem', 'error_code')
