...
::
    ...
    <link rel="stylesheet" href="/static/djfrontend_static/css/h5bp/4.2.0/h5bp.css">
...
::
    ...
    <link rel="stylesheet" href="/static/djfrontend_static/css/normalize/1.1.1/normalize.css">
...
::
    ...
    <script src="/static/djfrontend_static/js/modernizr/2.6.2/modernizr.js"></script>

Or

::

    <script src="/static/djfrontend_static/js/modernizr/2.6.2/modernizr.min.js"></script>
...
::
    ...
    <script src="/static/djfrontend_static/js/jquery/1.10.1/jquery.js"></script>
...
::
    ...
    <script>window.jQuery || document.write('<script src="/static/djfrontend_static/js/jquery/1.10.1/jquery.min.js"><\/script>')</script>
...
::
    ...
    <script src="/static/djfrontend_static/js/jquery/jqueryui/1.10.3/jquery-ui.js"></script>
...
::
    ...
    <script>window.jQueryUI || document.write(\'<script src="/static/djfrontend_static/js/jquery/jqueryui/1.10.3/jquery-ui.min.js"><\/script>\')</script>
...
::
    ...
    <script src="/static/djfrontend_static/js/jquery/jquery.dataTables/1.9.4/jquery.dataTables.js"></script>

Or

::

    <script src="/static/djfrontend_static/js/jquery/jquery.dataTables/1.9.4/jquery.dataTables.min.js"></script>
...
::
    ...
    <link rel="stylesheet" href="/static/djfrontend_static/css/jquery/jquery.dataTables/1.9.4/jquery.dataTables.css">
...
::
    ...
    <script src="/static/djfrontend_static/js/jquery/jquery.formset/1.2/jquery.formset.js"></script>

Or

::

    <script src="/static/djfrontend_static/js/jquery/jquery.formset/1.2/jquery.formset.min.js"></script>
...
::
    ...
    <script src="/static/djfrontend_static/js/jquery/jquery.smooth-scroll/1.4.10/jquery.smooth-scroll.js"></script>

Or

::

    <script src="/static/djfrontend_static/js/jquery/jquery.smooth-scroll/1.4.10/jquery.smooth-scroll.min.js"></script>
...
::
    ...
    <link rel="stylesheet" href="/static/djfrontend_static/css/twbs/2.3.2/bootstrap.css">

Or

::

    <link rel="stylesheet" href="/static/djfrontend_static/css/twbs/2.3.2/bootstrap.min.css">
...
::
    ...
    <link rel="stylesheet" href="/static/djfrontend_static/css/twbs/2.3.2/bootstrap-responsive.css">

Or

::

    <link rel="stylesheet" href="/static/djfrontend_static/css/twbs/2.3.2/bootstrap-responsive.min.css">
...
::
    ...
    <script src="/static/djfrontend_static/js/twbs/2.3.2/bootstrap.js"></script>

Or

::

    <script src="/static/djfrontend_static/js/twbs/2.3.2/bootstrap.min.js"></script>

{% bootstrap_js alert affix %} would render
::

    <script src="/static/djfrontend_static/js/twbs/2.3.2/bootstrap-affix.js"></script>
    <script src="/static/djfrontend_static/js/twbs/2.3.2/bootstrap-alert.js"></script>
