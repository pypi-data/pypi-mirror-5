...
scanner = re.Scanner([
    ...
    (r'(less that or equal|greater than or equal|not equal|greater than|' +
     r'equal|less than|not zero|zero|positive or zero|positive|' +
     r'negative or zero|negative|not overflow|overflow|never|always)',
     s_condition),
    ('[^ :0-9\n\t\v][^ :\n\t\v]*', s_label),
])
