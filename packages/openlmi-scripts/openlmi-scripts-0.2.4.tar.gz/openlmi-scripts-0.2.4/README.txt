...
[pythonhosted][] or build your own in ``doc/`` directory.
...
[git][]. It can be located anywhere on system.
...
openlmi-python-base package contained in [providers-git][] repository
the setup script is located at ``src/python/setup.py``. In future these
will be available from PyPi.
...
"openlmi-providers" [pythonhosted]:
http://pythonhosted.org/openlmi-scripts/index.html "python hosted"
