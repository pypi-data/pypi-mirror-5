...
class KeyBoard:
  def __init__(self,master):
    ...
    self.button9=tk.Button(frame1,text='\u09EF',width=2,bg='white',command=self.key_button9)
    ...
    self.button_14=tk.Button(frame1,text='Del',width=2,bg='white',command=self.key_button14)
...
#*****************************ROW-4**************************************#
    ...
    self.r3_button13=tk.Button(frame1,text='Del',anchor=tk.NE,width=2,bg='white')
