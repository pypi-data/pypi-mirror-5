...
from pyppi.views import IndexView, PackageDetail, PackageDetailSimple, PackageListSimple, PackageList, ReleaseDetail, ReleaseIndex, PackageUpdate, PackageManageVersions
