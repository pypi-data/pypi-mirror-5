...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AccessLogEntry.datetime'
        db.add_column('pyppi_accesslogentry', 'datetime',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AccessLogEntry.datetime'
        db.delete_column('pyppi_accesslogentry', 'datetime')
