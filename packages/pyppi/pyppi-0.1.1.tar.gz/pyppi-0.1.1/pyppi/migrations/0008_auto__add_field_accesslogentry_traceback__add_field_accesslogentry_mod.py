...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AccessLogEntry.traceback'
        db.add_column('pyppi_accesslogentry', 'traceback',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'AccessLogEntry.module'
        db.add_column('pyppi_accesslogentry', 'module',
                      self.gf('django.db.models.fields.CharField')(db_index=True, default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'AccessLogEntry.pathname'
        db.add_column('pyppi_accesslogentry', 'pathname',
                      self.gf('django.db.models.fields.CharField')(db_index=True, default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'AccessLogEntry.filename'
        db.add_column('pyppi_accesslogentry', 'filename',
                      self.gf('django.db.models.fields.CharField')(db_index=True, default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'AccessLogEntry.lineno'
        db.add_column('pyppi_accesslogentry', 'lineno',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'AccessLogEntry.func_name'
        db.add_column('pyppi_accesslogentry', 'func_name',
                      self.gf('django.db.models.fields.CharField')(db_index=True, default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'AccessLogEntry.thread_name'
        db.add_column('pyppi_accesslogentry', 'thread_name',
                      self.gf('django.db.models.fields.CharField')(db_index=True, default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'AccessLogEntry.process_name'
        db.add_column('pyppi_accesslogentry', 'process_name',
                      self.gf('django.db.models.fields.CharField')(db_index=True, default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'AccessLogEntry.process'
        db.add_column('pyppi_accesslogentry', 'process',
                      self.gf('django.db.models.fields.CharField')(db_index=True, default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'AccessLogEntry.thread'
        db.add_column('pyppi_accesslogentry', 'thread',
                      self.gf('django.db.models.fields.CharField')(db_index=True, default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AccessLogEntry.traceback'
        db.delete_column('pyppi_accesslogentry', 'traceback')

        # Deleting field 'AccessLogEntry.module'
        db.delete_column('pyppi_accesslogentry', 'module')

        # Deleting field 'AccessLogEntry.pathname'
        db.delete_column('pyppi_accesslogentry', 'pathname')

        # Deleting field 'AccessLogEntry.filename'
        db.delete_column('pyppi_accesslogentry', 'filename')

        # Deleting field 'AccessLogEntry.lineno'
        db.delete_column('pyppi_accesslogentry', 'lineno')

        # Deleting field 'AccessLogEntry.func_name'
        db.delete_column('pyppi_accesslogentry', 'func_name')

        # Deleting field 'AccessLogEntry.thread_name'
        db.delete_column('pyppi_accesslogentry', 'thread_name')

        # Deleting field 'AccessLogEntry.process_name'
        db.delete_column('pyppi_accesslogentry', 'process_name')

        # Deleting field 'AccessLogEntry.process'
        db.delete_column('pyppi_accesslogentry', 'process')

        # Deleting field 'AccessLogEntry.thread'
        db.delete_column('pyppi_accesslogentry', 'thread')
    ...
    models = {
        ...
        'pyppi.accesslogentry': {
            ...
            'func_name': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '255', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'level': ('django.db.models.fields.PositiveIntegerField', [], {'default': '40', 'db_index': 'True', 'blank': 'True'}),
            'lineno': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'logger': ('django.db.models.fields.CharField', [], {'default': "'root'", 'max_length': '64', 'db_index': 'True', 'blank': 'True'}),
            'message': ('django.db.models.fields.TextField', [], {}),
            'module': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '255', 'blank': 'True'}),
            'pathname': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '255', 'blank': 'True'}),
            'process': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '255', 'blank': 'True'}),
            'process_name': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '255', 'blank': 'True'}),
            'thread': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '255', 'blank': 'True'}),
            'thread_name': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '255', 'blank': 'True'}),
        ...
        'pyppi.mirrorlog': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'master': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'logs'", 'to': "orm['pyppi.MirrorSite']"}),
