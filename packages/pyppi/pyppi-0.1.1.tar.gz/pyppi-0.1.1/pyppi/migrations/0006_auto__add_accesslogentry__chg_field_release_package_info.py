...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('pyppi_accesslogentry', (
        ...
        db.send_create_signal('pyppi', ['AccessLogEntry'])


        # Changing field 'Release.package_info'
        db.alter_column('pyppi_release', 'package_info', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):
        # Deleting model 'AccessLogEntry'
        db.delete_table('pyppi_accesslogentry')


        # Changing field 'Release.package_info'
        db.alter_column('pyppi_release', 'package_info', self.gf('pyppi.fields.PackageInfoField')())
