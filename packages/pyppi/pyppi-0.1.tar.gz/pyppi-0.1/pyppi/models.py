...
from pyppi.fields import PackageInfoField, JSONDictField
...
class Package(models.Model):
    ...
    class Meta:
        ...
        permissions = (('register_package', 'Can register package'),
                       ...
                       ('access_package', 'Has access (read) package'))
...
class AccessLogEntry(models.Model):
    ...
    module = models.CharField(max_length=255, blank=True, db_index=True)
    pathname= models.CharField(max_length=255, blank=True, db_index=True)
    filename= models.CharField(max_length=255, blank=True, db_index=True)
    lineno = models.PositiveIntegerField(blank=True, null=True)
    func_name= models.CharField(max_length=255, blank=True, db_index=True)
    thread_name= models.CharField(max_length=255, blank=True, db_index=True)
    process_name= models.CharField(max_length=255, blank=True, db_index=True)
    process = models.CharField(max_length=255, blank=True, db_index=True)
    thread = models.CharField(max_length=255, blank=True, db_index=True)
