# -*- coding: utf-8 -*-
#
# Python Sikuli Cilent documentation build configuration file, created by
...
sys.path.insert(0, os.path.abspath('/Users/alistair.broomhead/github/SikuliServer/src'))
...
htmlhelp_basename = 'PythonSikuliCilentdoc'
...
latex_documents = [
  ('index', 'PythonSikuliCilent.tex', u'Python Sikuli Cilent Documentation',
   u'Alistair Broomhead', 'manual'),
]
