...
class Repository(Target):
  ...
  def __init__(self, name, url, push_db):
    """
    :param string name: an identifier for the repo
    :param string url: the url used to access the repo and retrieve artifacts or artifact metadata
    :param string push_db: the data file associated with this repo that records artifact push history
    """
