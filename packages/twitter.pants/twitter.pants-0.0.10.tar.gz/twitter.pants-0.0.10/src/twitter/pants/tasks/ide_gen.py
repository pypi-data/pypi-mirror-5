...
class Project(object):
  ...
  def configure_profiles(self, scala_compiler_profile):
    _, self.checkstyle_classpath = binary_util.profile_classpath('checkstyle')
    self.scala_compiler_classpath = []
    if self.has_scala:
      _, classpath = binary_util.profile_classpath(scala_compiler_profile)
      self.scala_compiler_classpath.extend(classpath)
