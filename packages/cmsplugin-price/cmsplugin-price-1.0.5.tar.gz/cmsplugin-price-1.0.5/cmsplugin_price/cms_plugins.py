...
from cmsplugin_price.utils import class_for_path
...
from admin import PriceAdminForm
...
class PricePlugin(CMSPluginBase):
    model = Price
    name = _("Price Form")
    render_template = "cmsplugin_price/contact.html"
    form = PriceAdminForm
    subject_template = "cmsplugin_price/subject.txt"
    email_template = "cmsplugin_price/email.txt"
    ...
    change_form_template = "cmsplugin_price/admin/plugin_change_form.html"
    ...
    def get_form(self, request, obj=None, **kwargs):
        ...
        return super(PricePlugin, self).get_form(request, obj, **kwargs)
    ...
    def create_form(self, instance, request):
        ...
        if instance.get_spam_protection_method_display() == 'Akismet':
            ...
            class PriceForm(ContactFormBase, AkismetContactForm):
                pass
            FormClass = PriceForm
            ...
            class PriceForm(ContactFormBase, RecaptchaContactForm):
            ...
            class PriceForm(ContactFormBase, HoneyPotContactForm):
                pass
            FormClass = PriceForm
    ...
    def render_change_form(self, request, context, add=False, change=False, form_url='', obj=None):
        ...
        return super(PricePlugin, self).render_change_form(request, context, add, change, form_url, obj)


plugin_pool.register_plugin(PricePlugin)
