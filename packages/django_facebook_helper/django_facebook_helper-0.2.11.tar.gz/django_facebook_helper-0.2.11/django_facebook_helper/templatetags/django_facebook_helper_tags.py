...
#      'redirect_uri' : redirect_uri,
      'display' : 'popup',
      'caption' : "qweqwe qweqwe qwe qwe qw eqw e",
      'description' : "qweqw eqwqwe qweqwe qwe qweqwe wqe ",
      'link' : 'http://apps.facebook.com/filmsobsession/movies/detail/a-20-millas-de-la-justicia-a-veinte-millas-de-la-justicia/'

    })
    
    
    return "https://www.facebook.com/dialog/feed?%s&redirect_uri=%s" % (params, redirect_uri, )
...
def facebook_request_app_install(context, redirect_uri):
    ...
    facebook_app_redirect = reverse('facebook-redirect')
    
    params = urllib.urlencode({
      'app_id': facebook_app_id, 
      'message': facebook_app_message, 
      'redirect_uri'  : facebook_app_redirect,
    })
