...
exec_shell_parser = picloud_subparsers.add_parser('exec-shell', description='Test your configuration by starting a defined by your environment, volumes, etc. and logging into it',
