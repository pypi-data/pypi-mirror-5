...
def local_tzname_all():
    return os.linesep.join([
        tzname_result(local_tzname(method), method)
...
if __name__ == '__main__':
    ...
    if opts.show_all:
        result = output = local_tzname_all()
    elif opts.method in local_tz_methods:
        result = output = local_tzname(opts.method)
    else:
        result, method = local_tzname(return_method=True)
