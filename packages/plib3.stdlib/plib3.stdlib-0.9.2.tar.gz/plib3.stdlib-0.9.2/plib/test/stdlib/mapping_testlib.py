...
class ImmutableMappingTest(unittest.TestCase):
    ...
    def test_read(self):
        ...
        def check_iter(it, ref):
            self.assert_(hasattr(it, '__next__'))
    ...
    def test_keys(self):
        ...
        d = self.type2test(self.reference)
        keys = list(d.keys())
        self.assert_(list(self.inmapping.keys())[0] in keys)
        self.assert_(list(self.other.keys())[0] not in keys)
    ...
    def test_values(self):
        ...
        self.assert_(list(self.inmapping.values())[0] in values)
        self.assert_(list(self.other.values())[0] not in values)
    ...
    def test_items(self):
        ...
        d = self.type2test(self.reference)
        items = list(d.items())
        self.assert_(list(self.inmapping.items())[0] in items)
        self.assert_(list(self.other.items())[0] not in items)
    ...
    def test_has_key(self):
        ...
        d = self.type2test(self.reference)
        self.assert_(list(self.inmapping.keys())[0] in d)
        self.assert_(list(self.other.keys())[0] not in d)
    ...
    def test_contains(self):
        ...
        d = self.type2test(self.reference)
        self.assert_(list(self.inmapping.keys())[0] in d)
        self.assert_(not (list(self.other.keys())[0] in d))
        self.assert_(list(self.other.keys())[0] not in d)
