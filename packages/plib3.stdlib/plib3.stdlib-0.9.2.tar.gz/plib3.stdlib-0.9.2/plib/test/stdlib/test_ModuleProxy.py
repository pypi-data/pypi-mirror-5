...
from . import ModuleProxy_testmod
...
class ModuleProxyTest(unittest.TestCase):
    ...
    def test_proxy(self):
        ...
        self.assert_('test_var_static' in testdir)
        self.assert_('test_var_dynamic' in testdir)
        self.assert_('test_fn' in testdir)
        
        # The proxy module dict only contains realized attributes
        self.assert_('test_var_static' not in testdict)
        self.assert_('test_var_dynamic' not in testdict)
        self.assert_('test_fn' not in testdict)
        ...
        self.assert_('test_var_static' in dir(ModuleProxy_testmod))
        self.assert_('test_var_static' not in set(ModuleProxy_testmod.__dict__.keys()))
        self.assert_('test_var_static' not in testnames)
        self.assert_('test_var_static' in dir(testmod))
        ...
        self.assert_('test_var_dynamic' in set(ModuleProxy_testmod.__dict__.keys()))
        ...
        self.assert_('test_fn' in set(ModuleProxy_testmod.__dict__.keys()))
