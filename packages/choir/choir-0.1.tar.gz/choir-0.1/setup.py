...
packages, package_data = findPackages("choir")
setup(
        name = "choir",
        version = choir.VERSION,
        description = "Python client for Choir.io",
        author = "Beachmonks",
        author_email = "info@beachmonks.com",
        url = "https://github.com/beachmonks",
        packages = packages,
