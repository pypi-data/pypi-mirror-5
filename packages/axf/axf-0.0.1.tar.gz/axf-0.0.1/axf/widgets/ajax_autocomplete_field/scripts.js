...
var AjaxAutocompleteField_init = function(field, placeholder, datasource, inverse_datasource) {
    ...
    var init_selection = function (element, callback) {
        jQuery.getJSON(inverse_datasource + '/' + element.val(), function(data) { callback(data) });
    }
