...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DataCollectorConfig.graph'
        db.add_column(u'acquisition_datacollectorconfig', 'graph',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'DataCollectorConfig.output'
        db.add_column(u'acquisition_datacollectorconfig', 'output',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'DataCollectorConfig.graph'
        db.delete_column(u'acquisition_datacollectorconfig', 'graph')

        # Deleting field 'DataCollectorConfig.output'
        db.delete_column(u'acquisition_datacollectorconfig', 'output')
