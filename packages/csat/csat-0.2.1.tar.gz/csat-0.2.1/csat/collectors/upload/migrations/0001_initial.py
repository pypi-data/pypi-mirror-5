...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UploadConfig'
        db.create_table(u'upload_uploadconfig', (
        ...
        db.send_create_signal(u'upload', ['UploadConfig'])


    def backwards(self, orm):
        # Deleting model 'UploadConfig'
        db.delete_table(u'upload_uploadconfig')
    ...
    models = {
        ...
        u'upload.uploadconfig': {
            'Meta': {'object_name': 'UploadConfig', '_ormbases': [u'acquisition.DataCollectorConfig']},
