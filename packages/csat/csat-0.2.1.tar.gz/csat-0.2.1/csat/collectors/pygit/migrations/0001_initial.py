...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Config'
        db.create_table(u'pygit_config', (
            ...
            ('revspec', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('package', self.gf('django.db.models.fields.CharField')(max_length=63)),
        ))
        db.send_create_signal(u'pygit', ['Config'])


    def backwards(self, orm):
        # Deleting model 'Config'
        db.delete_table(u'pygit_config')
