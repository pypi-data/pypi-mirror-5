...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Config.keep_history'
        db.add_column(u'pygit_config', 'keep_history',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Config.keep_history'
        db.delete_column(u'pygit_config', 'keep_history')
    ...
    models = {
        ...
        u'pygit.config': {
            ...
            'keep_history': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
