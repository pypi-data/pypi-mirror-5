...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AcquisitionSessionConfig.thumbnail'
        db.add_column(u'acquisition_acquisitionsessionconfig', 'thumbnail',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AcquisitionSessionConfig.thumbnail'
        db.delete_column(u'acquisition_acquisitionsessionconfig', 'thumbnail')
