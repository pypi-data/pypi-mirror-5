...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'examples_examplesconfig', (
            ...
            ('example', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'examples', ['ExamplesConfig'])


    def backwards(self, orm):
        # Deleting model 'ExamplesConfig'
        db.delete_table(u'examples_examplesconfig')
    ...
    models = {
        ...
        u'examples.examplesconfig': {
            'Meta': {'object_name': 'ExamplesConfig', '_ormbases': [u'acquisition.DataCollectorConfig']},
            ...
            'example': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        }
    }
