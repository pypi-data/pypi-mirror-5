...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AcquisitionSessionConfig.graph'
        db.add_column(u'acquisition_acquisitionsessionconfig', 'graph',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AcquisitionSessionConfig.graph'
        db.delete_column(u'acquisition_acquisitionsessionconfig', 'graph')
