...
# === django_pgmp.db.fields.mpq_test.models -------------------------------===
...
from django_pgmp.db.fields import MultiPrecisionFractionField

class MultiPrecisionFractionModel(models.Model):
    value = MultiPrecisionFractionField()
