# -*- coding: utf-8 -*-
"""
Created on Sun Jun 23 14:31:47 2013
...
Default_val_calculate= 'th1,th2,th3', '0.5*m*l**2*(vth1**2+vth2**2+vth3**2)', 'm*g*l*0.5*(th1**2+th2**2+th3**2)+0.5*k*l**2*((th2-th1)**2*s12**2+(th3-th1)**2*s13**2)' , '0,0,0','m,g,k,l,s12,s13','3,9.81,10e6,0.1,1,1','0.52,0,0,0,0,0','0,0,0'

field_labels_control1 = 'Initial Values (dof0,Pdof0,Fdof0,dof1,..)','Workpoint for linearization (dof0,Pdof0,dof1,Pdof1,...)'
field_labels_control2='Q-Martrix (e.g. [rxow0],[row1],[row3],..)','R-Matrix','Time Steps (T0,Tend,number of elements between T0 & Tend)','Reference Functions (REFdof0,REFdof1,etc..)'
