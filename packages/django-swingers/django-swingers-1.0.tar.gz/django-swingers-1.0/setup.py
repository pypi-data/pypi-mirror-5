...
install_requires = [
    'django{0}'.format(os.environ.get('DJANGO') and
                       '=={0}'.format(os.environ.get('DJANGO')) or '>=1.5'),
    'requests>=0.14.2',
    'south>=0.7.6',
...
setup(
    ...
    version=version,
    author='Adon Metcalfe, Ashley Felton, Nick Sandford',
    author_email=('adon.metcalfe@dpaw.wa.gov.au, ashley.felton@dpaw.wa.gov.au,'
                  ' nick.sandford@dpaw.wa.gov.au'),
