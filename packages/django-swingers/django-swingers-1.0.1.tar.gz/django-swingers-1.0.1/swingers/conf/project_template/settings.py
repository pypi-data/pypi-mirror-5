...
ADMINS = tuple(os.getenv('{{ project_name }}.ADMINS', []))
MANAGERS = ADMINS
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('{{ project_name }}.DATABASE_NAME'),
        'USER': os.getenv('{{ project_name }}.DATABASE_USER'),
        'PASSWORD': os.getenv('{{ project_name }}.DATABASE_PASSWORD'),
        'HOST': os.getenv('{{ project_name }}.DATABASE_HOST'),
        'PORT': os.getenv('{{ project_name }}.DATABASE_PORT'),
    }
}
...
STATIC_ROOT = os.getenv('{{ project_name }}.STATIC_ROOT')
STATIC_URL = '/static/'
...
HELP_URL = os.getenv('{{ project_name }}.HELP_URL')

SECRET_KEY = os.getenv('{{ project_name }}.SECRET_KEY')
...
# LDAP settings
AUTH_LDAP_SERVER_URI = os.getenv('{{ project_name }}.LDAP_SERVER_URI')
AUTH_LDAP_BIND_DN = os.getenv('{{ project_name }}.LDAP_BIND_DN')
AUTH_LDAP_BIND_PASSWORD = os.getenv('{{ project_name }}.LDAP_BIND_PASSWORD')
...
AUTH_LDAP_USER_SEARCH = LDAPSearch(
    os.getenv('{{ project_name }}.LDAP_BASE'),
...
AUTH_LDAP_USER_FLAGS_BY_GROUP = {
    "is_staff": os.getenv('{{ project_name }}.LDAP_STAFF_FLAG'),
    "is_superuser": os.getenv('{{ project_name }}.LDAP_SUPERUSER_FLAG')
}
...
EMAIL_HOST = os.getenv('{{ project_name }}.EMAIL_HOST')
EMAIL_PORT = os.getenv('{{ project_name }}.EMAIL_PORT')
