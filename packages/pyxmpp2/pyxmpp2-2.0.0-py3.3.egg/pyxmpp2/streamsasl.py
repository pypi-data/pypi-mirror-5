...
XMPPSettings.add_setting("insecure_auth", basic = True,
        type = bool,
        default = False,
        cmdline_help = "Enable insecure SASL mechanisms over unencrypted channels",
        doc = """Enable insecure SASL mechanisms over unencrypted channels"""
    )
XMPPSettings.add_setting("password_database",
        type = sasl.PasswordDatabase,
        factory = DefaultPasswordDatabase,
        default_d = "A `DefaultPasswordDatabase` instance",
        doc = """Object providing or checking user passwords on server."""
    )
