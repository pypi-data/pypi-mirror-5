    ...
    for obj in reversed(entries):
        ...
        if isinstance(focus, release):
            ...
            if line not in lines:
                ...
                lines['unreleased'] = []
                print "> After dump, lines: %r" % (lines,)
                print "> And releases: %r" % (releases,)
