...
def test_tiddler_collection(): # TODO: rename
    ...
    # check complex tags -- DEBUG'd
    #
    #_put_tiddler('Lorem Ipsum', 'alpha', ['foo', 'lorem ipsum', 'baz'], '...')
    #
    #response, content = http.request('http://example.org:8001/tags/foo',
    #        method='GET', headers={ 'Accept': 'text/html' })
    #import pdb; pdb.set_trace()
    #assert '<a href="/tags/foo,%22lorem%20ipsum%22">lorem ipsum</a>' in content
    #
    #response, content = http.request('http://example.org:8001/tags/%22lorem%20ipsum%22',
    #        method='GET', headers={ 'Accept': 'text/html' })
    #assert '<a href="/tags/foo,%22lorem%20ipsum%22">foo</a>' in content
