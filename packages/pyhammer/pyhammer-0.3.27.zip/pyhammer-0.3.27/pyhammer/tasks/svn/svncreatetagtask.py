...
class SvnCreateTagTask(TaskBase):
    ...
    def __init__(self, dirTrunk, dirTag, versionFile=None, includeRevision=False, encoding=None):
    ...
    def do(self):
        ...
        if self.__versionFile is not None:
            ...
            self.reporter.failure("Version file is None, please give a path to search version.")
            return False