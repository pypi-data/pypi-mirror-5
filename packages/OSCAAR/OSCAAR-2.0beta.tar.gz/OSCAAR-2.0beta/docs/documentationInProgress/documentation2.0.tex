...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%  Current documentation to do list:
%  - write up subsection on multiple regions files in the GUI section
%  - draw more "cheat sheet" tables of acceptable values
%  - write up subsection on registering with OSCAAR in the intro section
%  - neaten up the ephemeris cheat sheet table
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
