...
from unice.portlet.telechargement import telechargementportlet

from unice.portlet.telechargement.tests.base import TestCase
...
class TestPortlet(TestCase):
    ...
    def test_portlet_type_registered(self):
        portlet = getUtility(
            IPortletType,
            name='unice.portlet.telechargement.TelechargementPortlet')
        self.assertEquals(portlet.addview,
                          'unice.portlet.telechargement.TelechargementPortlet')

    def test_interfaces(self):
        # TODO: Pass any keyword arguments to the Assignment constructor
        portlet = telechargementportlet.Assignment()
    ...
    def test_invoke_add_view(self):
        ...
        self.failUnless(isinstance(mapping.values()[0],
                                   telechargementportlet.Assignment))
    ...
    def test_invoke_edit_view(self):
        ...
        mapping['foo'] = telechargementportlet.Assignment()
        editview = getMultiAdapter((mapping['foo'], request), name='edit')
        self.failUnless(isinstance(editview, telechargementportlet.EditForm))
    ...
    def test_obtain_renderer(self):
        ...
        # TODO: Pass any keyword arguments to the Assignment constructor
        assignment = telechargementportlet.Assignment()

        renderer = getMultiAdapter(
            (context, request, view, manager, assignment), IPortletRenderer)
        self.failUnless(isinstance(renderer, telechargementportlet.Renderer))
...
class TestRenderer(TestCase):
    ...
    def afterSetUp(self):
        ...
        self.telechargement_tmpl = """<p><a href="%s">Home</a></p>"""
        
        # make a document with some realistic telechargement
        ...
        self.portal['quick-links'].setText(
            self.telechargement_tmpl % self.portal.portal_url())
    ...
    def renderer(self, context=None, request=None, view=None, manager=None,
        ...
        assignment = assignment or telechargementportlet.Assignment()
    ...
    def test_render_body(self):
        r = self.renderer(
            context=self.portal,
            assignment=telechargementportlet.Assignment(
                telechargement=self.item_url_path[len(self.portal_url_path):],
                item_display=[u'body'],
            )
        )
        ...
        r.update()
        output = r.render()
        self.failUnless(self.telechargement_tmpl % self.portal.portal_url() in output)
    ...
    def test_i18n_render_body(self):
        ...
        ql_german.setText(self.telechargement_tmpl % self.portal.portal_url() + "DE")
        ...
        r.update()
        output = r.render()
        self.failUnless(self.telechargement_tmpl % self.portal.portal_url() + "DE" \
            in output)
