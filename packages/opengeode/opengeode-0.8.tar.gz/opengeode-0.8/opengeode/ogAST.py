...
class Floating_label(object):
    ''' AST Entry for a floating label '''
    def __init__(self):
        ''' Initialize the floatinglabel attributes '''
        self.inputString = 'Here'
        # optional hyperlink
        self.hyperlink = None
...
class TextArea(object):
    ...
    def __init__(self):
        ...
        # DCL variables in the text area {name: sort, ...}
        self.variables = {}
        self.line = None
        self.charPositionInLine = None
...
class Process(object):
    ...
    def __init__(self):
        ...
        # List of Floating_label
        self.floating_labels = []

        # list of operators (not supported) and procedures
        self.operators = {}
        # procedures: same form as outputlist: NOT ANYMORE
        #     {'procedureName': definition from iv.py, ...}
        # only supports procedures as sync RI specified in the
        # TASTE interface view
        # use operators or inner_procedures for other purposes
        #self.procedures = {}
        # list of class Procedure (external procedures)
        self.procedures = []
        # User-defined procedures: list of ogAST.Procedure
        self.inner_procedures = []
