...
Usage:  python setup_linux.py sdist   --> to create a tarball
        python setup_linux.py install --> to install in python directory
'''
...
setup(
        ...
        install_requires=['antlr_python_runtime', 'pygraphviz'],
