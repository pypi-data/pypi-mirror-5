...
def import_qpackage_src(relative_path, module_name):
    ...
    @param qpackage_name:      Name of the qpackage
    @type qpackage_name:       string
    @param relative path:      Relative path from <qpackage_name>/qpackage4/<platform> to the source file
...
class CloudApiSpec(object):
    ...
    def load(cls, spec, object_name):
        ...
        class_name = prefix.upper() + '_' + object_name if prefix else object_name
        ...
        spec_class = cls._load_spec_class(module_path, class_name)
    ...
    @classmethod
    def _load_spec_class(cls, module_path, class_name):
                # load the spec file
