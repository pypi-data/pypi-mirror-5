...
from unice.portlet.imagelegendee import imagelegendeeportlet

from unice.portlet.imagelegendee.tests.base import TestCase
...
class TestPortlet(TestCase):
    ...
    def test_portlet_type_registered(self):
        ...
        self.assertEquals(portlet.addview,
                          'unice.portlet.imagelegendee.ImageLegendeePortlet')

    def test_interfaces(self):
        # TODO: Pass any keyword arguments to the Assignment constructor
        portlet = imagelegendeeportlet.Assignment()
    ...
    def test_invoke_add_view(self):
        ...
        self.failUnless(isinstance(mapping.values()[0],
                                   imagelegendeeportlet.Assignment))
    ...
    def test_invoke_edit_view(self):
        ...
        mapping['foo'] = imagelegendeeportlet.Assignment()
        editview = getMultiAdapter((mapping['foo'], request), name='edit')
        self.failUnless(isinstance(editview, imagelegendeeportlet.EditForm))
    ...
    def test_obtain_renderer(self):
        ...
        self.failUnless(isinstance(renderer, imagelegendeeportlet.Renderer))
...
class TestRenderer(TestCase):
    ...
    def afterSetUp(self):
        ...
        self.imagelegendee_tmpl = """<p><a href="%s">Home</a></p>"""
        
        # make a document with some realistic imagelegendee
        ...
        self.portal['quick-links'].setText(
            self.imagelegendee_tmpl % self.portal.portal_url())
    ...
    def renderer(self, context=None, request=None, view=None, manager=None,
        ...
        assignment = assignment or imagelegendeeportlet.Assignment()
    ...
    def test_render_body(self):
        r = self.renderer(
            context=self.portal,
            assignment=imagelegendeeportlet.Assignment(
                imagelegendee=self.item_url_path[len(self.portal_url_path):],
                item_display=[u'body'],
            )
        )
        ...
        r.update()
        output = r.render()
        self.failUnless(self.imagelegendee_tmpl % self.portal.portal_url() in output)
    ...
    def test_i18n_render_body(self):
        ...
        ql_german.setText(self.imagelegendee_tmpl % self.portal.portal_url() + "DE")
        ...
        r.update()
        output = r.render()
        self.failUnless(self.imagelegendee_tmpl % self.portal.portal_url() + "DE" \
            in output)
