...
class XGanttWidgetItem(QTreeWidgetItem):
    """ 
    ...
    def __init__( self, ganttWidget ):
        ...
        self.setSizeHint(0, QSize(150, ganttWidget.cellHeight()))
    ...
    def setDateStart( self, date ):
        ...
        self._dateEnd   = date.addDays(duration - 1)
    ...
    def syncTree( self, recursive = False ):
        """
        ...
        if ( recursive ):
            for i in range(self.childCount()):
                self.child(i).syncTree(recursive = True)
