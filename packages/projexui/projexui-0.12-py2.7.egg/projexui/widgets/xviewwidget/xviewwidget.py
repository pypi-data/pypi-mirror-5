...
class XViewWidget(QScrollArea):
    ...
    def createMenu( self, parent ):
        ...
        act.setIcon(QIcon(projexui.resources.find('img/lock.png')))
        act.triggered.connect(self.toggleLocked)
        
        menu.addSeparator()
        act = menu.addAction('Export Layout as...')
        act.setIcon(QIcon(projexui.resources.find('img/export.png')))
        act.triggered.connect(self.exportProfile)
        
        act = menu.addAction('Import Layout from...')
        act.setIcon(QIcon(projexui.resources.find('img/import.png')))
