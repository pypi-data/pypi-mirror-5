...
class XOrbRecordWidget(QWidget):
    ...
    @classmethod
    def edit(cls, record, parent = None, autoCommit = True):
        """
        ...
        # create dialog
        dlg = QDialog(parent)
        dlg.setWindowTitle('Edit %s' % record.__class__.__name__)
    ...
    @classmethod
    def create(cls, model=None, parent=None, autoCommit=True, defaults=None):
        """
        ...
        # create dialog
        dlg = QDialog(parent)
        dlg.setWindowTitle('Create %s' % model.__name__)
        ...
        if widget.multipleCreateEnabled():
            btn = buttons.addButton('Save && Create Another', 
                                    buttons.ActionRole)
