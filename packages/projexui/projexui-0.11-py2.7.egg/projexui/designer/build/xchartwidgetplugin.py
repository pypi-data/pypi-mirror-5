...
from projexui.widgets.xchartwidget import XChartWidget as Base
setattr(Base, '__designer_mode__', True)

DEFAULT_XML = '''<ui language="c++" displayname="XChartWidget">
  <widget class="XChartWidget" name="XChartWidget"/>
  <customwidgets>
    <customwidget>
      <class>XChartWidget</class>
      <header>projexui.widgets.xchartwidget</header>
...
class XChartWidgetPlugin(QPyDesignerCustomWidgetPlugin):
    def __init__(self, parent=None):
        super(XChartWidgetPlugin, self).__init__(parent)
    ...
    def includeFile( self ):
        return 'projexui.widgets.xchartwidget'
