...
class XOrbRecordBox(XComboBox):
    ...
    def __init__( self, parent = None ):
        ...
        self._worker.loadedRecords.connect(self._addRecordsFromThread)
        
        self.currentIndexChanged.connect(self.emitCurrentRecordChanged)
    
    def _addRecordsFromThread(self, records):
        """
...
#            self._worker.cancel()
    ...
    def markLoadingFinished(self):
        ...
        # set the current record from cache
        if self._currentRecord:
            curr_record = self._currentRecord
