...
class XWizardPlugin(object):
    ...
    def iconFile( self ):
        ...
        if ( not os.path.isfile(self._iconFile) ):
            return projexui.resources.find('img/plugin_48.png')
    ...
    def groupIcon( cls, groupName, default = None ):
        ...
        return cls._groupIcons.get(str(groupName), default)
    ...
    def find( cls, name ):
        ...
        return cls._plugins.get(str(name))
    ...
    def setGroupIcon( cls, groupName, icon ):
        ...
        cls._groupIcons[str(groupName)] = icon
