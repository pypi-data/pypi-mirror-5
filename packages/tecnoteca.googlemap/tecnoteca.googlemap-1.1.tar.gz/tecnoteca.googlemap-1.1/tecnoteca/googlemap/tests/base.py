...
def setup_product():
    ...
    import tecnoteca.googlemap
    zcml.load_config('configure.zcml', tecnoteca.googlemap)
    ...
    ztc.installPackage('tecnoteca.googlemap')
...
setup_product()
ptc.setupPloneSite(products=['tecnoteca.googlemap'])
