...
project = u'Bob-based Video Data Acquisition Module'
import time
...
version = __import__('xbob.daq.version').daq.version.__version__
...
latex_documents = [
  ('index', 'xbob_daq_man.tex', u'Video Data Acquisition (xbob.daq)',
...
man_pages = [
    ('index', 'xbob.daq', u'Video Data Acquisition (xbob.daq)', [u'Idiap Research Institute'], 1)
]
