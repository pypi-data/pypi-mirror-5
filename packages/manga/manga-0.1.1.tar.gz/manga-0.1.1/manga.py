...
class ModelType(type):
    ...
    def __new__(cls, name, bases, dct):
        ...
        cls = super(ModelType, cls).__new__(cls, name, bases, dct)

        if db:
            db.add_son_manipulator(_ModelManipulator(cls))

        else:
            _manipulators.append(_ModelManipulator(cls))
