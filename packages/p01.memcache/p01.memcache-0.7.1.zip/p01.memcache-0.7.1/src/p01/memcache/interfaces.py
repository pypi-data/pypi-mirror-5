...
class IUltraMemcacheClient(IMemcacheClient):
    ...
    queuetime = zope.schema.Int(
        title=u'Lifetime in queue pool',
        description=u'Lifetime in queue pool',
        required=True,
        default=1,
        )
    ...
    maxPoolSize = zope.schema.Int(
        title=u'Max connection pool size',
        description=u'Max connection pool size',
        required=True,
        default=50,
        )
