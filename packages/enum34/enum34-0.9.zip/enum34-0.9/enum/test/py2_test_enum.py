...
class skip_if(object):
    ...
    def __call__(self, test):
        ...
        def skipped(self):
            pass
        skipped.__doc__ = '%s: skipping -- %s' % (test.__name__, self.reason)
        return skipped
...
class TestEnum(unittest.TestCase):
    ...
    @skip_if(pyver < 2.6, "cannot specify custom `dir` on this version")
    ...
    @skip_if(pyver < 3.0, "all objects are ordered in Python 2.x")
    ...
    def test_overwrite_enums(self):
        ...
        self.assertTrue(Why.question not in Why._member_names)
