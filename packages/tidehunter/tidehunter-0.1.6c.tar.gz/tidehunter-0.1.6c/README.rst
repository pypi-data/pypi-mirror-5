...
post <http://runzhou.li/blog/2013/07/02/tame-py-curl/>`_.
...
-  OAuth support based on python-oauth2 - see `this
   demo <https://github.com/amoa/tidehunter/blob/master/demo/five_tweets.py>`_
   in action.
...
See `demo <https://github.com/amoa/tidehunter/tree/master/demo>`_ for
more examples.
...
See the full
`LICENSE <https://github.com/amoa/tidehunter/blob/master/LICENSE>`_.
