...
"""
Script to generate the installer for coopr.gdp.
"""
...
setup(name='coopr.gdp',
      version='1.1.1',
      maintainer='John Siirola',
      maintainer_email='jdsiiro@sandia.gov',
      url = 'https://software.sandia.gov/svn/public/coopr/coopr.gdp',
      license = 'BSD',
      platforms = ["any"],
      description = 'Generalized Disjunctive Programming (GDP) extensions to the Pyomo environment',
