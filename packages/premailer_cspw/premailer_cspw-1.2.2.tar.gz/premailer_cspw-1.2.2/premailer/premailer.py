...
class Premailer(object):
    ...
    def __init__(self, html, base_url=None,
        ...
        self.trusted_pseudoclasses = trusted_pseudoclasses
    ...
    def _parse_style_rules(self, css_body, ruleset_index):
        ...
        for each in _regex.findall(css_body.strip()):
            ...
            for selector in (x.strip() for
                ...
                trusted_pseudo = (self.trusted_pseudoclasses and
                                  test_selector(selector))
                if (':' in selector and not trusted_pseudo and
    ...
    def transform(self, pretty_print=True, **kwargs):
        ...
        for __, selector, style in rules:
            ...
            if (self.trusted_pseudoclasses or
