...
function insertMail(mail){
    ...
    $("#inbox").prepend("<div class='"+css_class+"' id='"+div_id+"' data-mail-id='"+mail.id+"'><div><span class='subject'>#"+mail.id+" "+mail.subject+"</span><br><span class='date'>"+mail.sent_date+"</span></div></div>");
    total_inbox++;
    update_inbox_count();
}
