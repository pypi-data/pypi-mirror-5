...
if PATCH_AT:
    ...
    # the first place.
    # XXX we were previously deleting this method but due to some issues
    # with iterate on older versions of plone, we're just setting the roles
    UIDResolver.resolve_url__roles__ = ()
