...
class MarketSimulator():
    ...
    def applyTransforms(self, datafeed):
        ...
        for transform in self.registeredTransforms:
            ...
            # # Output of transformed Data can a list of numpy arrays.
            # if isinstance(transform["desiredname"], list) \
            #         and isinstance(transformedData, list) \
            #         and len(transformedData) == len(transform["desiredname"]):
            #     pass
            # elif :
            #     datafeed[transform["symbol"]][transform["desiredname"]] = pd.Series(
            #         transformedData,
