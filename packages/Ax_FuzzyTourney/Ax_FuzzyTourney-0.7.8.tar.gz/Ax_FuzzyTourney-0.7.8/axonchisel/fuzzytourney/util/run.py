...
This is a basic example of how to run a tournament defined in a JSON file.
...
class RunUtil(object):
    ...
    def _get_tournament_filename(self):
        if len(self._argv) < 2:
            self._print_error("No tournament JSON file specified")
    ...
    def _print_usage(self, f):
        ...
        print("", file=f)
        print("Run with tournament JSON filename", file=f)
