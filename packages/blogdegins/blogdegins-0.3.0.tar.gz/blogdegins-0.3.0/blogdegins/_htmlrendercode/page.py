...
my_package = __package__.rpartition('.')[0]
...
def get_page(here, output_path, debug):
    ...
    page = gaplic.create_gobj(
        None,
        Page,
        None,
        template='/%s/htmlrendercode/page.mako' % my_package,
    ...
    create_content(
        'content',
        page,
        gaplic_namespace=page.config.gaplic_namespace
    )
    return page
