...
@endpoint("http")
class UserHTTPEndpoint(HTTPEndpoint):
    method = "POST"

    def __init__(self, plugin, url):
        self.endpoint = "{scheme}://{url}".format(self.scheme, url)

    def setup(self, event):
        self.postdata = {
            "server":      plugin.parent.server_name,
...
@endpoint("https")
class UserHTTPSEndpoint(UserHTTPEndpoint):
    pass
