...
"""
try:
    from authkit.middleware.form import AuthFormHandler, parse_formvars
except ImportError:    
...
class FormAuthHandler(AuthKitAuthHandler, AuthFormHandler):
    ...
    def on_authorized(self, environ, start_response):
        if self.user_data is not None:
            ...
            environ['authkit.set_user'](userid=environ['REMOTE_USER'], user_data=self.user_data(state))
        else:
            environ['authkit.set_user'](userid=environ['REMOTE_USER'])
