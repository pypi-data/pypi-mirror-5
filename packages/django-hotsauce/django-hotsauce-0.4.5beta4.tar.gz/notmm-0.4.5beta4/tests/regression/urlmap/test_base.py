...
class RegexURLMapTestCase(unittest.TestCase):
    ...
    def test_add_routes(self):
        ...
        #    url(r'^$', 'handle500', name="index2") # XXX: Should we raise
                                                   ...
                                                   # unique routes.
        self.assertEqual(len(urlmap)==3, True, len(urlmap))
    
    def test_include(self):
        # default string based include
        urlmap = RegexURLMap()
        urlmap.include('sandbox.config.urls', prefix=r'^/sandbox')
    ...
    def test_autodiscover(self):
        ...
        self.assertEqual(urlmap.callback_prefix, '')
        #self.assertEqual(len(urlmap.routes), 11)
