# $Id: c18c8aa on Mon Jan 16 20:33:48 2012 +0000 by Benedict Verhegghe $
##
...
def HowManyColors():
    ...
    F = Formex('4:0123').scale([b,h,1]).replic2(B,H,b,h)
...
def AlignedLines():
    ...
    mask = Formex('4:0123').scale([1,20.*sin(a*pi/180.),1]).replic(11,2)
    mask.setProp(6)
