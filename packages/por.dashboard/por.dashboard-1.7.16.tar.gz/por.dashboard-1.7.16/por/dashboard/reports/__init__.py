...
from por.dashboard.reports.views import ReportContext; ReportContext
from por.dashboard.reports.queries import filter_users_with_timeentries, qry_active_projects
from por.models import DBSession, Project, SavedQuery, User
