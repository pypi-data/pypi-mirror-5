...
from por.dashboard import messages
from por.models.dashboard import User, PasswordResetToken
...
class TestSecurity(unittest2.TestCase):
    ...
    def test_password_reset_for_no_user(self):
        from por.dashboard.security.views import password_reset 
    ...
    def test_autoregister(self):
        from por.dashboard.security.views import autoregister
