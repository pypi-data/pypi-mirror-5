...
class Environment(object):
    ...
    def database( self, name = '' ):
        ...
        """
        if ( name ):
            return self._databases.get(str(name), Database.find(name))
        else:
    ...
    def toXml( self, xparent ):
        ...
        xenv.set('name',    str(self.name()))
        xenv.set('default', str(self.isDefault()))
    ...
    def find( name ):
        ...
        :return     <str>
        """
        return Environment._environments.get(str(name))