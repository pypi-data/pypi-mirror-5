...
class TableSchema(object):
    ...
    def database( self ):
        ...
        """
        return orb.Orb.instance().database(self.databaseName())
    ...
    def toXml(self, xparent):
        ...
        xschema.set('preloadCache', str(self.preloadCache()))
        xschema.set('useAdvanced', str(self.useAdvancedFormatting()))
