...
try:
    ...
    logger.debug('For Postgres backend, download the psycopg2 module')
    pg = None
...
PG_TYPE_MAP = {
    ...
    ColumnType.Datetime:                'TIMESTAMP WITHOUT TIMEZONE',
    ...
    ColumnType.DatetimeWithTimezone:    'TIMESTAMP WITHOUT TIMEZONE',
