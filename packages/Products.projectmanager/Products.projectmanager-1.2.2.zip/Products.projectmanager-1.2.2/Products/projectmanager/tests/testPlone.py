...
#
# Base TestCase for projectmanager
#
...
from Products.projectmanager.config import PRODUCT_DEPENDENCIES
...
PRODUCT_DEPENDENCIES.append('projectmanager')
...
ZopeTestCase.installProduct('projectmanager')

PRODUCTS = list()
PRODUCTS += DEPENDENCIES
PRODUCTS.append('projectmanager')
