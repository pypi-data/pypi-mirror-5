...
class TcpClientTool(Tool):
    ...
    __toolname__ = 'tcpclient CHANGE'
    __itemname__ = 'host CHANGE'
    __description__ = 'TcpClient base-class CHANGE'
    ...
    def __init__(self, options, outfile=sys.stdout, *args, **kw):
        super(TcpClientTool, self).__init__(options, *args, **kw)
...
def main():
    ...
    xnet.tools.run.run(TcpClientTool, tool_reads_stdin=True)
