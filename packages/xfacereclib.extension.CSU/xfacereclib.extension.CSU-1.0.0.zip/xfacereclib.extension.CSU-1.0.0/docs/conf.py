...
project = u'xfacereclib.CSU.PythonFaceEvaluation'
import time
...
#man_pages = [
#    ('index', 'xfacereclib.CSU.PythonFaceEvaluation', u'Documentation of the CSU PythonFaceEvaluation wrapper classes for the FaceRecLib', [u'Idiap Research Institute'], 1)
#]
