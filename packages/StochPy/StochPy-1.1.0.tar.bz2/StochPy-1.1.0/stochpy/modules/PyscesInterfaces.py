...
from stochpy.core2.PyscesCore2Interfaces import PscToCore, SbmlToCore, CoreToPsc, CoreToSBML
from stochpy.core2.PyscesCore2 import NewCore
...
class Core2interfaces(object):
    ...
    def convertSBML2PSC(self, sbmlfile, sbmldir=None, pscfile=None, pscdir=None, netStoich=True):
        """
