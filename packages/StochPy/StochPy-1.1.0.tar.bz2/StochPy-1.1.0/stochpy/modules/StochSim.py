...
import sys,copy,time,os,cPickle,subprocess,bisect,cStringIO
...
class SSA():
  ...
  def PlotWaitingtimes(self,rates2plot = True,linestyle = 'None',marker = 'o',colors = None,title = 'StochPy Event Waitingtimes Plot',xlabel='Interarrival time t',ylabel='Probability Mass'):
  ...
  def PlotDistributions(self,species2plot = True, linewidth=1,linestyle = 'dotted',colors=None,title = 'StochPy Species Probability Mass Function',bin_size=1,xlabel='Number of Molecules',ylabel='Probability Mass'):  
  ...
  def PlotSpeciesDistributions(self,species2plot = True, linestyle = 'dotted',linewidth = 1,colors=None,title = 'StochPy Species Probability Mass Function',xlabel='Number of Molecules',ylabel='Probability Mass',IsLegend=True,bin_size=1):  
      """
  ...
  def PlotPropensitiesDistributions(self,rates2plot = True, linestyle = 'dotted',linewidth = 1,colors=None,title = 'StochPy Propensities Probability Mass Function',xlabel='Propensity',ylabel='Probability Mass',IsLegend=True,bin_size=1):
      """
  ...
  def PlotWaitingtimesDistributions(self,rates2plot = True,linestyle = 'None',marker = 'o',colors = None,title = 'StochPy Event Waiting times Plot',xlabel=r'inter-event time $t$',ylabel='Probability Density',IsLegend=True):
      """
      PlotWaitingtimesDistributions(rates2plot = True,linestyle = 'None',marker = 'o',colors = None,title = 'StochPy Waiting times Plot',xlabel='inter-event time t',ylabel='Probability Density')
