...
"""
Script to generate the installer for coopr.openopt.
"""
...
setup(name='coopr.openopt',
      version='1.1.2',
      maintainer='William Hart',
      maintainer_email='wehart@sandia.gov',
      url = 'https://software.sandia.gov/svn/public/coopr/coopr.openopt',
      license = 'BSD',
      platforms = ["any"],
      ...
      entry_points = {
        'coopr.opt': [
            'solver.openopt = coopr.openopt.OPEN_OPT',
        ]
      }
      )
