...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Attachment.description'
        db.alter_column('ella_attachments_attachment', 'description', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Attachment.type'
        db.alter_column('ella_attachments_attachment', 'type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ella_attachments.Type'], null=True))
    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Attachment.description'
        raise RuntimeError("Cannot reverse this migration. 'Attachment.description' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Attachment.type'
        raise RuntimeError("Cannot reverse this migration. 'Attachment.type' and its values cannot be restored.")
    models = {
        'auth.group': {
        ...
        'ella_attachments.attachment': {
            ...
            'photo': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'photos'", 'null': 'True', 'to': "orm['photos.Photo']"}),
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '255'}),
            'type': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['ella_attachments.Type']", 'null': 'True', 'blank': 'True'})
        },
