...
static char __pyx_k_4[] = "/private/tmp/pyzmq/zmq/backend/cython/_version.pyx";
static char __pyx_k_5[] = "zmq.backend.cython._version";
...
static PyMethodDef __pyx_mdef_3zmq_7backend_6cython_8_version_1zmq_version_info = {__Pyx_NAMESTR("zmq_version_info"), (PyCFunction)__pyx_pw_3zmq_7backend_6cython_8_version_1zmq_version_info, METH_NOARGS, __Pyx_DOCSTR(__pyx_doc_3zmq_7backend_6cython_8_version_zmq_version_info)};
 ...
 * 
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_3zmq_7backend_6cython_8_version_1zmq_version_info, NULL, __pyx_n_s_5); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 32; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
