...
def main():
	...
	for leng in k_sizes:
		...
		print "Create model..",
		#solver = Solver.ParallelODESolverSharedMemory(cudaCode, constants, threads=1)
		solver = cudapyint.ParallelODESolver(cudaCode, constants, threads=2)
		print "..calculating.."
