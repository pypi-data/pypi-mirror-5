# -*- coding: utf-8 -*-
#
# clusterprocessing documentation build configuration file, created by
...
exec(
    compile(
        open(
            path.abspath(path.join(path.dirname(__file__), "../../clusterprocessing/version.py")),
            "r"
        ).read(),
        "../../clusterprocessing/version.py", "exec"
    ),
...
bitbucket_project_url = 'https://bitbucket.org/prologic/clusterprocessing'
...
project = u'clusterprocessing'
copyright = u'2013, James Mills'
url = "https://bitbucket.org/prologic/clusterprocessing"
...
htmlhelp_basename = 'clusterprocessingdoc'
...
latex_documents = [
    (
        'index', 'clusterprocessing.tex', u'clusterprocessing Documentation',
