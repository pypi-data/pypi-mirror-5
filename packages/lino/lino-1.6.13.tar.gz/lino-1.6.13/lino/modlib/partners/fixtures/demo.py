...
def objects():
    ...
    organisation = Instantiator('partners.Organisation',"name zip_code city:name street street_no",country='EE').build
    ...
    organisation = Instantiator('partners.Organisation',"name zip_code city:name street street_no",country='BE').build
    ...
    organisation = Instantiator('partners.Organisation',"name zip_code city:name street street_no",country='NL').build
    ...
    organisation = Instantiator('partners.Organisation',"name zip_code city:name street street_no",country='FR').build
    ...
    person = Instantiator("partners.Person",country='BE',city=City.objects.get(name__exact='Angleur')).build
    ...
    person = Instantiator("partners.Person",country='NL',city=City.objects.get(name__exact='Amsterdam')).build
