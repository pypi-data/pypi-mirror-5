...
// lino.js --- generated Mon May 27 21:19:14 2013 by Lino version 1.6.9.
...
Lino.status_bar = new Ext.ux.StatusBar({defaultText:'None.'});
...
Lino.main_menu = [ { "menu": { "items": [ { "text": "Products", "handler": function() {Lino.babel_tutorial.Products.grid.run(null)} } ] }, "text": "Products" }, { "menu": { "items": [ { "text": "About", "listeners": { "render": Lino.quicktip_renderer("Foo","Show information about this site.") }, "handler": function() {Lino.about.About.show.run(null,{ "record_id": -99998 })} } ] }, "text": "Site" }, { "text": "Home", "handler": function() {Lino.close_all_windows()} } ];
Ext.namespace('Lino.ui.SiteConfigs')
Ext.namespace('Lino.babel_tutorial.Products')
...
Ext.namespace('Lino.babel_tutorial.Categories')
...
// ChoiceLists: 
Lino.babel_tutorial.Categories = [ [ "01", "Hardware" ], [ "02", "Service" ], [ "03", "Accessories" ], [ "04", "Software" ] ];
...
Lino.about.Models.DetailFormPanel = Ext.extend(Lino.FormPanel,{
  ...
  initComponent : function() {
    ...
    var app_disp25 = new Ext.form.DisplayField({ "disabled": true, "fieldLabel": "app_label", "name": "app", "anchor": "-20", "value": "<br/>", "always_enabled": true });
    var name_disp26 = new Ext.form.DisplayField({ "disabled": true, "fieldLabel": "name", "name": "name", "anchor": "-20", "value": "<br/>", "always_enabled": true });
    var docstring_disp27 = new Ext.form.DisplayField({ "disabled": true, "fieldLabel": "docstring", "name": "docstring", "anchor": "-20", "value": "<br/>", "always_enabled": true });
    var rows28 = new Ext.form.NumberField({ "disabled": true, "fieldLabel": "Rows", "anchor": "-20", "name": "rows" });
    var main_1_panel29 = new Ext.Panel({ "autoScroll": false, "autoHeight": true, "border": false, "layout": "hbox", "labelWidth": 90, "hideCheckBoxLabels": true, "items": [ { "flex": 31, "autoHeight": true, "layout": "form", "xtype": "panel", "items": app_disp25, "labelAlign": "top" }, { "flex": 31, "autoHeight": true, "layout": "form", "xtype": "panel", "items": name_disp26, "labelAlign": "top" }, { "flex": 31, "autoHeight": true, "layout": "form", "xtype": "panel", "items": docstring_disp27, "labelAlign": "top" }, { "flex": 5, "autoHeight": true, "layout": "form", "xtype": "panel", "items": rows28, "labelAlign": "top" } ], "frame": false, "layoutConfig": { "align": "stretchmax" }, "labelAlign": "top" });
    var about_FieldsByModel_grid38 = new Lino.about.FieldsByModel.GridPanel({ "tools": [ Lino.show_in_own_window_button(Lino.about.FieldsByModel.grid) ], "containing_panel": this, "hide_top_toolbar": true, "master_panel": this, "flex": 62 });
    var main_panel39 = new Ext.Panel({ "autoScroll": false, "border": false, "layout": "vbox", "hideCheckBoxLabels": true, "items": [ main_1_panel29, about_FieldsByModel_grid38 ], "frame": true, "layoutConfig": { "align": "stretch" }, "bodyBorder": false, "labelAlign": "top" });
    this.items = main_panel39;
    this.before_row_edit = function(record) {
      about_FieldsByModel_grid38.on_master_changed();
    }
...
Lino.babel_tutorial.Products.DetailFormPanel = Ext.extend(Lino.FormPanel,{
  layout: 'fit',
  auto_save: true,
  initComponent : function() {
    var containing_panel = this;
    var id1 = new Ext.form.NumberField({ "selectOnFocus": true, "fieldLabel": "ID", "anchor": "-20", "name": "id" });
    var price2 = new Ext.form.NumberField({ "decimalPrecision": 2, "fieldLabel": "Price", "name": "price", "decimalSeparator": ",", "selectOnFocus": true, "anchor": "-20", "allowBlank": true });
    var category3 = new Lino.ChoicesFieldElement({ "forceSelection": true, "fieldLabel": "Category", "name": "category", "selectOnFocus": true, "anchor": "-20", "store": Lino.babel_tutorial.Categories, "hiddenName": "categoryHidden" });
    var main_1_panel4 = new Ext.Panel({ "autoHeight": true, "layout": "hbox", "items": [ { "flex": 16, "autoHeight": true, "layout": "form", "xtype": "panel", "items": id1, "labelAlign": "top" }, { "flex": 38, "autoHeight": true, "layout": "form", "xtype": "panel", "items": price2, "labelAlign": "top" }, { "flex": 45, "autoHeight": true, "layout": "form", "xtype": "panel", "items": category3, "labelAlign": "top" } ], "frame": false, "layoutConfig": { "align": "stretchmax" }, "hideCheckBoxLabels": true, "autoScroll": false, "labelWidth": 81, "border": false, "anchor": "-20", "labelAlign": "top" });
    var name8 = new Ext.form.TextField({ "fieldLabel": "Designation", "name": "name", "maxLength": 200, "selectOnFocus": true, "anchor": "-20", "allowBlank": false });
    var name_fr9 = new Ext.form.TextField({ "selectOnFocus": true, "maxLength": 200, "fieldLabel": "Designation (fr)", "anchor": "-20", "name": "name_fr" });
    var main_2_panel10 = new Ext.Panel({ "autoHeight": true, "layout": "hbox", "items": [ { "flex": 50, "autoHeight": true, "layout": "form", "xtype": "panel", "items": name8, "labelAlign": "top" }, { "flex": 50, "autoHeight": true, "layout": "form", "xtype": "panel", "items": name_fr9, "labelAlign": "top" } ], "frame": false, "layoutConfig": { "align": "stretchmax" }, "hideCheckBoxLabels": true, "autoScroll": false, "labelWidth": 153, "border": false, "anchor": "-20", "labelAlign": "top" });
    var main_panel13 = new Ext.Panel({ "hideCheckBoxLabels": true, "autoHeight": true, "border": false, "layout": "form", "autoScroll": false, "items": [ main_1_panel4, main_2_panel10 ], "frame": true, "bodyBorder": false, "labelAlign": "top" });
    this.items = main_panel13;
    this.before_row_edit = function(record) {
    }
    Lino.babel_tutorial.Products.DetailFormPanel.superclass.initComponent.call(this);
  }
});


Lino.babel_tutorial.Products.InsertFormPanel = Ext.extend(Lino.FormPanel,{
  layout: 'fit',
  auto_save: true,
  autoHeight: true,
  initComponent : function() {
    var containing_panel = this;
    var name14 = new Ext.form.TextField({ "fieldLabel": "Designation", "name": "name", "maxLength": 200, "selectOnFocus": true, "anchor": "-20", "allowBlank": false });
    var name_fr15 = new Ext.form.TextField({ "selectOnFocus": true, "maxLength": 200, "fieldLabel": "Designation (fr)", "anchor": "-20", "name": "name_fr" });
    var main_1_panel16 = new Ext.Panel({ "autoHeight": true, "layout": "hbox", "items": [ { "flex": 50, "autoHeight": true, "layout": "form", "xtype": "panel", "items": name14, "labelAlign": "top" }, { "flex": 50, "autoHeight": true, "layout": "form", "xtype": "panel", "items": name_fr15, "labelAlign": "top" } ], "frame": false, "layoutConfig": { "align": "stretchmax" }, "hideCheckBoxLabels": true, "autoScroll": false, "labelWidth": 153, "border": false, "anchor": "-20", "labelAlign": "top" });
    var category19 = new Lino.ChoicesFieldElement({ "forceSelection": true, "fieldLabel": "Category", "name": "category", "selectOnFocus": true, "anchor": "-20", "store": Lino.babel_tutorial.Categories, "hiddenName": "categoryHidden" });
    var price20 = new Ext.form.NumberField({ "decimalPrecision": 2, "fieldLabel": "Price", "name": "price", "decimalSeparator": ",", "selectOnFocus": true, "anchor": "-20", "allowBlank": true });
    var main_2_panel21 = new Ext.Panel({ "autoHeight": true, "layout": "hbox", "items": [ { "flex": 53, "autoHeight": true, "layout": "form", "xtype": "panel", "items": category19, "labelAlign": "top" }, { "flex": 46, "autoHeight": true, "layout": "form", "xtype": "panel", "items": price20, "labelAlign": "top" } ], "frame": false, "layoutConfig": { "align": "stretchmax" }, "hideCheckBoxLabels": true, "autoScroll": false, "labelWidth": 81, "border": false, "anchor": "-20", "labelAlign": "top" });
    var main_panel24 = new Ext.Panel({ "hideCheckBoxLabels": true, "autoHeight": true, "border": false, "layout": "form", "autoScroll": false, "items": [ main_1_panel16, main_2_panel21 ], "frame": true, "bodyBorder": false, "labelAlign": "top" });
    this.items = main_panel24;
    this.before_row_edit = function(record) {
    }
    Lino.babel_tutorial.Products.InsertFormPanel.superclass.initComponent.call(this);
  }
});
...
Lino.ui.Home.DetailFormPanel = Ext.extend(Lino.FormPanel,{
  ...
  initComponent : function() {
    var containing_panel = this;
    var quick_links_htmlbox42 = new Lino.HtmlBoxPanel({ "flex": 1, "layout": "fit", "name": "quick_links", "containing_panel": this, "items": new Ext.BoxComponent({autoScroll:true}), "region": "north", "master_panel": this, "value": "<br/>", "always_enabled": true, "bodyStyle": "overflow-x:hidden", "split": true });
    var welcome_htmlbox43 = new Lino.HtmlBoxPanel({ "flex": 3, "layout": "fit", "name": "welcome", "containing_panel": this, "items": new Ext.BoxComponent({autoScroll:true}), "region": "center", "title": "Welcome", "master_panel": this, "value": "<br/>", "always_enabled": true, "bodyStyle": "overflow-x:hidden", "split": true });
    var main_panel44 = new Lino.VBorderPanel({ "autoScroll": false, "border": false, "labelWidth": 72, "hideCheckBoxLabels": true, "items": [ quick_links_htmlbox42, welcome_htmlbox43 ], "frame": true, "bodyBorder": false, "labelAlign": "top" });
    this.items = main_panel44;
    this.before_row_edit = function(record) {
      quick_links_htmlbox42.refresh();
      welcome_htmlbox43.refresh();
    }
...
Lino.lino.Report.DetailFormPanel = Ext.extend(Lino.FormPanel,{
  ...
  initComponent : function() {
    var containing_panel = this;
    var body_htmlbox40 = new Lino.HtmlBoxPanel({ "layout": "fit", "name": "body", "containing_panel": this, "items": new Ext.BoxComponent({autoScroll:true}), "master_panel": this, "value": "<br/>", "always_enabled": true, "bodyStyle": "overflow-x:hidden" });
    var main_panel41 = new Ext.Panel({ "autoScroll": false, "border": false, "layout": "fit", "labelWidth": 0, "hideCheckBoxLabels": true, "items": [ body_htmlbox40 ], "frame": true, "bodyBorder": false, "labelAlign": "top" });
    this.items = main_panel41;
    this.before_row_edit = function(record) {
      body_htmlbox40.refresh();
    }
...
// js_render_GridPanel_class babel_tutorial.Products
Lino.babel_tutorial.Products.GridPanel = Ext.extend(Lino.GridPanel,{
  viewConfig : { "getRowClass": Lino.getRowClass, "forceFit": true, "emptyText": "No data to display." },
  ls_url : "/babel_tutorial/Products",
  ...
  stripeRows : true,
  ls_quick_edit : true,
  ls_store_fields : [ { "name": "name" }, { "name": "name_fr" }, { "name": "category" }, 'categoryHidden', { "name": "price" }, { "type": "int", "name": "id" }, { "name": "disabled_fields" }, { "name": "disabled_actions" }, { "name": "disable_editing" } ],
  pk_index : 5,
  ls_grid_configs : [  ],
  ls_id_property : "id",
  page_length : 20,
  ...
  initComponent : function() {
    this.ls_detail_handler = Lino.babel_tutorial.Products.detail;
    this.ls_insert_handler = Lino.babel_tutorial.Products.insert;
    var ww = this.containing_window;
    var name47 = new Ext.form.TextField({ "selectOnFocus": true, "allowBlank": false, "maxLength": 200 });
    var name_fr48 = new Ext.form.TextField({ "selectOnFocus": true, "maxLength": 200 });
    var category49 = new Lino.ChoicesFieldElement({ "selectOnFocus": true, "forceSelection": true, "store": Lino.babel_tutorial.Categories });
    var price50 = new Ext.form.NumberField({ "selectOnFocus": true, "decimalPrecision": 2, "allowBlank": true, "decimalSeparator": "," });
    var id51 = new Ext.form.NumberField({ "selectOnFocus": true });
    this.before_row_edit = function(record) {
    };
    this.ls_columns = [ { "colIndex": 0, "sortable": true, "header": "Designation", "editable": true, "filter": { "type": "string" }, "width": Lino.chars2width(22), "dataIndex": "name", "editor": name47 }, { "colIndex": 1, "sortable": true, "header": "Designation (fr)", "editable": true, "filter": { "type": "string" }, "width": Lino.chars2width(22), "dataIndex": "name_fr", "editor": name_fr48 }, { "colIndex": 2, "sortable": true, "header": "Category", "editable": true, "filter": { "type": "string" }, "width": Lino.chars2width(15), "dataIndex": "category", "editor": category49 }, new Lino.NullNumberColumn({ "colIndex": 3, "sortable": true, "header": "Price", "editable": true, "filter": { "type": "numeric" }, "width": Lino.chars2width(13), "dataIndex": "price", "editor": price50 }), new Lino.NullNumberColumn({ "colIndex": 4, "sortable": true, "format": "0", "editable": true, "filter": { "type": "numeric" }, "header": "ID", "renderer": Lino.id_renderer, "editor": id51, "width": Lino.chars2width(6), "dataIndex": "id" }) ];
    Lino.babel_tutorial.Products.GridPanel.superclass.initComponent.call(this);
  }
});


Lino.babel_tutorial.Products.insertPanel = Ext.extend(Lino.babel_tutorial.Products.InsertFormPanel,{
  ...
  initComponent : function() {
    this.ls_detail_handler = Lino.babel_tutorial.Products.detail;
    this.ls_insert_handler = Lino.babel_tutorial.Products.insert;
    Lino.babel_tutorial.Products.insertPanel.superclass.initComponent.call(this);
  }
});

Lino.babel_tutorial.Products.insert = new Lino.WindowAction({ "draggable": true, "width": Lino.chars2width(40), "autoHeight": true, "maximizable": true, "modal": true, "maximized": false },function(){
  var p = { "is_main_window": true, "hide_top_toolbar": true };
  return new Lino.babel_tutorial.Products.insertPanel(p);
});

Lino.babel_tutorial.Products.detailPanel = Ext.extend(Lino.babel_tutorial.Products.DetailFormPanel,{
  ...
  initComponent : function() {
    this.ls_detail_handler = Lino.babel_tutorial.Products.detail;
    this.ls_insert_handler = Lino.babel_tutorial.Products.insert;
    Lino.babel_tutorial.Products.detailPanel.superclass.initComponent.call(this);
  }
});

Lino.babel_tutorial.Products.detail = new Lino.WindowAction({  },function(){
  var p = { "is_main_window": true };
  return new Lino.babel_tutorial.Products.detailPanel(p);
});
Lino.babel_tutorial.Products.grid = new Lino.WindowAction({  },function(){
  var p = { "is_main_window": true };
  return new Lino.babel_tutorial.Products.GridPanel(p);
});
...
Lino.about.Models.GridPanel = Ext.extend(Lino.GridPanel,{
  ...
  initComponent : function() {
    ...
    var ww = this.containing_window;
    var app_disp53 = new Ext.form.DisplayField({ "disabled": true, "value": "<br/>", "always_enabled": true });
    var name_disp54 = new Ext.form.DisplayField({ "disabled": true, "value": "<br/>", "always_enabled": true });
    var docstring_disp55 = new Ext.form.DisplayField({ "disabled": true, "value": "<br/>", "always_enabled": true });
    var rows56 = new Ext.form.NumberField({ "disabled": true });
    var detail_action_disp57 = new Ext.form.DisplayField({ "disabled": true, "value": "<br/>", "always_enabled": true });
    this.before_row_edit = function(record) {
    };
...
Lino.about.FieldsByModel.GridPanel = Ext.extend(Lino.GridPanel,{
  ...
  initComponent : function() {
    var ww = this.containing_window;
    var name_disp34 = new Ext.form.DisplayField({ "disabled": true, "value": "<br/>", "always_enabled": true });
    var verbose_name_disp35 = new Ext.form.DisplayField({ "disabled": true, "value": "<br/>", "always_enabled": true });
    var help_text_column_disp36 = new Ext.form.DisplayField({ "disabled": true, "value": "<br/>", "always_enabled": true });
    this.before_row_edit = function(record) {
    };
...
Lino.about.SourceFiles.GridPanel = Ext.extend(Lino.GridPanel,{
  ...
  initComponent : function() {
    var ww = this.containing_window;
    var module_name59 = new Ext.form.TextField({ "disabled": true, "maxLength": null });
    var code_lines60 = new Ext.form.NumberField({ "disabled": true });
    var doc_lines61 = new Ext.form.NumberField({ "disabled": true });
    this.before_row_edit = function(record) {
    };
...
// js_render_GridPanel_class babel_tutorial.Categories
Lino.babel_tutorial.Categories.GridPanel = Ext.extend(Lino.GridPanel,{
  ls_url : "/babel_tutorial/Categories",
  ls_bbar_actions : [  ],
  title : "Categories",
  page_length : 20,
  gc_name : 0,
  ...
  initComponent : function() {
    var ww = this.containing_window;
    var value63 = new Ext.form.TextField({ "disabled": true, "maxLength": 20 });
    var name64 = new Ext.form.TextField({ "disabled": true, "maxLength": 20 });
    var text65 = new Ext.form.TextField({ "disabled": true, "maxLength": 50 });
    this.before_row_edit = function(record) {
    };
    ...
    Lino.babel_tutorial.Categories.GridPanel.superclass.initComponent.call(this);
  }
});

Lino.babel_tutorial.Categories.grid = new Lino.WindowAction({  },function(){
  var p = { "is_main_window": true };
  return new Lino.babel_tutorial.Categories.GridPanel(p);
});
...
Lino.lino.YesNo.GridPanel = Ext.extend(Lino.GridPanel,{
  ...
  initComponent : function() {
    var ww = this.containing_window;
    var value67 = new Ext.form.TextField({ "disabled": true, "maxLength": 20 });
    var name68 = new Ext.form.TextField({ "disabled": true, "maxLength": 20 });
    var text69 = new Ext.form.TextField({ "disabled": true, "maxLength": 50 });
    this.before_row_edit = function(record) {
    };
    this.ls_columns = [ { "width": Lino.chars2width(22), "colIndex": 0, "sortable": false, "dataIndex": "value", "header": "value", "editable": false }, { "width": Lino.chars2width(22), "colIndex": 1, "sortable": false, "dataIndex": "name", "header": "name", "editable": false }, { "width": Lino.chars2width(22), "colIndex": 2, "sortable": false, "dataIndex": "text", "header": "text", "editable": false } ];
...
Lino.lino.Genders.GridPanel = Ext.extend(Lino.GridPanel,{
  ...
  initComponent : function() {
    var ww = this.containing_window;
    var value71 = new Ext.form.TextField({ "disabled": true, "maxLength": 20 });
    var name72 = new Ext.form.TextField({ "disabled": true, "maxLength": 20 });
    var text73 = new Ext.form.TextField({ "disabled": true, "maxLength": 50 });
    this.before_row_edit = function(record) {
    };
    this.ls_columns = [ { "width": Lino.chars2width(22), "colIndex": 0, "sortable": false, "dataIndex": "value", "header": "value", "editable": false }, { "width": Lino.chars2width(22), "colIndex": 1, "sortable": false, "dataIndex": "name", "header": "name", "editable": false }, { "width": Lino.chars2width(22), "colIndex": 2, "sortable": false, "dataIndex": "text", "header": "text", "editable": false } ];
