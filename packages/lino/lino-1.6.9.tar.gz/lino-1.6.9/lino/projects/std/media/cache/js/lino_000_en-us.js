...
// lino.js --- generated Mon May 27 21:19:17 2013 by Lino version 1.6.9.
...
Lino.about.Models.GridPanel = Ext.extend(Lino.GridPanel,{
  ...
  initComponent : function() {
    ...
    var app_disp23 = new Ext.form.DisplayField({ "disabled": true, "value": "<br/>", "always_enabled": true });
    var name_disp24 = new Ext.form.DisplayField({ "disabled": true, "value": "<br/>", "always_enabled": true });
    var docstring_disp25 = new Ext.form.DisplayField({ "disabled": true, "value": "<br/>", "always_enabled": true });
    var rows26 = new Ext.form.NumberField({ "disabled": true });
    var detail_action_disp27 = new Ext.form.DisplayField({ "disabled": true, "value": "<br/>", "always_enabled": true });
    this.before_row_edit = function(record) {
    };
...
Lino.about.SourceFiles.GridPanel = Ext.extend(Lino.GridPanel,{
  ...
  initComponent : function() {
    var ww = this.containing_window;
    var module_name29 = new Ext.form.TextField({ "disabled": true, "maxLength": null });
    var code_lines30 = new Ext.form.NumberField({ "disabled": true });
    var doc_lines31 = new Ext.form.NumberField({ "disabled": true });
    this.before_row_edit = function(record) {
    };
...
Lino.lino.YesNo.GridPanel = Ext.extend(Lino.GridPanel,{
  ...
  initComponent : function() {
    var ww = this.containing_window;
    var value33 = new Ext.form.TextField({ "disabled": true, "maxLength": 20 });
    var name34 = new Ext.form.TextField({ "disabled": true, "maxLength": 20 });
    var text35 = new Ext.form.TextField({ "disabled": true, "maxLength": 50 });
    this.before_row_edit = function(record) {
    };
