...
// lino.js --- generated Mon May 27 13:19:22 2013 by Lino version 1.6.9.
...
Ext.namespace('Lino.quantityfield.ItemTable')
...
Lino.about.Models.DetailFormPanel = Ext.extend(Lino.FormPanel,{
  ...
  initComponent : function() {
    ...
    var app_disp1 = new Ext.form.DisplayField({ "disabled": true, "fieldLabel": "app_label", "name": "app", "anchor": "-20", "value": "<br/>", "always_enabled": true });
    var name_disp2 = new Ext.form.DisplayField({ "disabled": true, "fieldLabel": "name", "name": "name", "anchor": "-20", "value": "<br/>", "always_enabled": true });
    var docstring_disp3 = new Ext.form.DisplayField({ "disabled": true, "fieldLabel": "docstring", "name": "docstring", "anchor": "-20", "value": "<br/>", "always_enabled": true });
    var rows4 = new Ext.form.NumberField({ "disabled": true, "fieldLabel": "Rows", "anchor": "-20", "name": "rows" });
    var main_1_panel5 = new Ext.Panel({ "autoScroll": false, "autoHeight": true, "border": false, "layout": "hbox", "labelWidth": 90, "hideCheckBoxLabels": true, "items": [ { "flex": 31, "autoHeight": true, "layout": "form", "xtype": "panel", "items": app_disp1, "labelAlign": "top" }, { "flex": 31, "autoHeight": true, "layout": "form", "xtype": "panel", "items": name_disp2, "labelAlign": "top" }, { "flex": 31, "autoHeight": true, "layout": "form", "xtype": "panel", "items": docstring_disp3, "labelAlign": "top" }, { "flex": 5, "autoHeight": true, "layout": "form", "xtype": "panel", "items": rows4, "labelAlign": "top" } ], "frame": false, "layoutConfig": { "align": "stretchmax" }, "labelAlign": "top" });
    var about_FieldsByModel_grid14 = new Lino.about.FieldsByModel.GridPanel({ "tools": [ Lino.show_in_own_window_button(Lino.about.FieldsByModel.grid) ], "containing_panel": this, "hide_top_toolbar": true, "master_panel": this, "flex": 62 });
    var main_panel15 = new Ext.Panel({ "autoScroll": false, "border": false, "layout": "vbox", "hideCheckBoxLabels": true, "items": [ main_1_panel5, about_FieldsByModel_grid14 ], "frame": true, "layoutConfig": { "align": "stretch" }, "bodyBorder": false, "labelAlign": "top" });
    this.items = main_panel15;
    this.before_row_edit = function(record) {
      about_FieldsByModel_grid14.on_master_changed();
    }
...
Lino.ui.Home.DetailFormPanel = Ext.extend(Lino.FormPanel,{
  ...
  initComponent : function() {
    var containing_panel = this;
    var quick_links_htmlbox18 = new Lino.HtmlBoxPanel({ "flex": 1, "layout": "fit", "name": "quick_links", "containing_panel": this, "items": new Ext.BoxComponent({autoScroll:true}), "region": "north", "master_panel": this, "value": "<br/>", "always_enabled": true, "bodyStyle": "overflow-x:hidden", "split": true });
    var welcome_htmlbox19 = new Lino.HtmlBoxPanel({ "flex": 3, "layout": "fit", "name": "welcome", "containing_panel": this, "items": new Ext.BoxComponent({autoScroll:true}), "region": "center", "title": "Welcome", "master_panel": this, "value": "<br/>", "always_enabled": true, "bodyStyle": "overflow-x:hidden", "split": true });
    var main_panel20 = new Lino.VBorderPanel({ "autoScroll": false, "border": false, "labelWidth": 72, "hideCheckBoxLabels": true, "items": [ quick_links_htmlbox18, welcome_htmlbox19 ], "frame": true, "bodyBorder": false, "labelAlign": "top" });
    this.items = main_panel20;
    this.before_row_edit = function(record) {
      quick_links_htmlbox18.refresh();
      welcome_htmlbox19.refresh();
    }
...
Lino.lino.Report.DetailFormPanel = Ext.extend(Lino.FormPanel,{
  ...
  initComponent : function() {
    var containing_panel = this;
    var body_htmlbox16 = new Lino.HtmlBoxPanel({ "layout": "fit", "name": "body", "containing_panel": this, "items": new Ext.BoxComponent({autoScroll:true}), "master_panel": this, "value": "<br/>", "always_enabled": true, "bodyStyle": "overflow-x:hidden" });
    var main_panel17 = new Ext.Panel({ "autoScroll": false, "border": false, "layout": "fit", "labelWidth": 0, "hideCheckBoxLabels": true, "items": [ body_htmlbox16 ], "frame": true, "bodyBorder": false, "labelAlign": "top" });
    this.items = main_panel17;
    this.before_row_edit = function(record) {
      body_htmlbox16.refresh();
    }
...
// js_render_GridPanel_class quantityfield.ItemTable
Lino.quantityfield.ItemTable.GridPanel = Ext.extend(Lino.GridPanel,{
  viewConfig : { "getRowClass": Lino.getRowClass, "emptyText": "No data to display." },
  ls_url : "/quantityfield/ItemTable",
  ls_bbar_actions : [  ],
  title : "items",
  gc_name : 0,
  stripeRows : true,
  ls_quick_edit : true,
  ls_store_fields : [ { "type": "int", "name": "id" }, { "name": "name" }, { "name": "qty" }, { "name": "discount" }, { "name": "price" }, { "name": "disabled_fields" }, { "name": "disabled_actions" }, { "name": "disable_editing" } ],
  pk_index : 0,
  ls_grid_configs : [  ],
  ls_id_property : "id",
  page_length : 20,
  ...
  initComponent : function() {
    ...
    var name24 = new Ext.form.TextField({ "selectOnFocus": true, "allowBlank": false, "maxLength": 50 });
    var qty25 = new Ext.form.TextField({ "selectOnFocus": true, "boxMinWidth": Lino.chars2width(6), "allowBlank": false, "value": "1", "maxLength": 6 });
    var discount26 = new Ext.form.TextField({ "selectOnFocus": true, "boxMinWidth": Lino.chars2width(6), "allowBlank": false, "maxLength": 6 });
    var price27 = new Ext.form.NumberField({ "selectOnFocus": true, "decimalPrecision": 2, "allowBlank": false, "decimalSeparator": "," });
    this.before_row_edit = function(record) {
    };
    this.ls_columns = [ new Lino.NullNumberColumn({ "colIndex": 0, "sortable": true, "format": "0", "editable": true, "filter": { "type": "numeric" }, "header": "ID", "renderer": Lino.id_renderer, "editor": id23, "width": Lino.chars2width(6), "dataIndex": "id" }), { "colIndex": 1, "sortable": true, "header": "name", "editable": true, "filter": { "type": "string" }, "width": Lino.chars2width(22), "dataIndex": "name", "editor": name24 }, { "colIndex": 2, "sortable": true, "format": "", "align": "right", "editable": true, "filter": { "type": "string" }, "header": "qty", "dataIndex": "qty", "width": Lino.chars2width(8), "editor": qty25 }, { "colIndex": 3, "sortable": true, "format": "", "align": "right", "editable": true, "filter": { "type": "string" }, "header": "discount", "dataIndex": "discount", "width": Lino.chars2width(8), "editor": discount26 }, new Lino.NullNumberColumn({ "colIndex": 4, "sortable": true, "header": "price", "editable": true, "filter": { "type": "numeric" }, "width": Lino.chars2width(13), "dataIndex": "price", "editor": price27 }) ];
    Lino.quantityfield.ItemTable.GridPanel.superclass.initComponent.call(this);
  }
});

Lino.quantityfield.ItemTable.grid = new Lino.WindowAction({  },function(){
  var p = { "is_main_window": true };
  return new Lino.quantityfield.ItemTable.GridPanel(p);
});
...
Lino.about.Models.GridPanel = Ext.extend(Lino.GridPanel,{
  ...
  initComponent : function() {
    ...
    var ww = this.containing_window;
    var app_disp29 = new Ext.form.DisplayField({ "disabled": true, "value": "<br/>", "always_enabled": true });
    var name_disp30 = new Ext.form.DisplayField({ "disabled": true, "value": "<br/>", "always_enabled": true });
    var docstring_disp31 = new Ext.form.DisplayField({ "disabled": true, "value": "<br/>", "always_enabled": true });
    var rows32 = new Ext.form.NumberField({ "disabled": true });
    var detail_action_disp33 = new Ext.form.DisplayField({ "disabled": true, "value": "<br/>", "always_enabled": true });
    this.before_row_edit = function(record) {
    };
...
Lino.about.FieldsByModel.GridPanel = Ext.extend(Lino.GridPanel,{
  ...
  initComponent : function() {
    var ww = this.containing_window;
    var name_disp10 = new Ext.form.DisplayField({ "disabled": true, "value": "<br/>", "always_enabled": true });
    var verbose_name_disp11 = new Ext.form.DisplayField({ "disabled": true, "value": "<br/>", "always_enabled": true });
    var help_text_column_disp12 = new Ext.form.DisplayField({ "disabled": true, "value": "<br/>", "always_enabled": true });
    this.before_row_edit = function(record) {
    };
...
Lino.about.SourceFiles.GridPanel = Ext.extend(Lino.GridPanel,{
  ...
  initComponent : function() {
    var ww = this.containing_window;
    var module_name35 = new Ext.form.TextField({ "disabled": true, "maxLength": null });
    var code_lines36 = new Ext.form.NumberField({ "disabled": true });
    var doc_lines37 = new Ext.form.NumberField({ "disabled": true });
    this.before_row_edit = function(record) {
    };
...
Lino.lino.YesNo.GridPanel = Ext.extend(Lino.GridPanel,{
  ...
  initComponent : function() {
    var ww = this.containing_window;
    var value39 = new Ext.form.TextField({ "disabled": true, "maxLength": 20 });
    var name40 = new Ext.form.TextField({ "disabled": true, "maxLength": 20 });
    var text41 = new Ext.form.TextField({ "disabled": true, "maxLength": 50 });
    this.before_row_edit = function(record) {
    };
...
Lino.lino.Genders.GridPanel = Ext.extend(Lino.GridPanel,{
  ...
  initComponent : function() {
    var ww = this.containing_window;
    var value43 = new Ext.form.TextField({ "disabled": true, "maxLength": 20 });
    var name44 = new Ext.form.TextField({ "disabled": true, "maxLength": 20 });
    var text45 = new Ext.form.TextField({ "disabled": true, "maxLength": 50 });
    this.before_row_edit = function(record) {
    };
    this.ls_columns = [ { "width": Lino.chars2width(22), "colIndex": 0, "sortable": false, "dataIndex": "value", "header": "value", "editable": false }, { "width": Lino.chars2width(22), "colIndex": 1, "sortable": false, "dataIndex": "name", "header": "name", "editable": false }, { "width": Lino.chars2width(22), "colIndex": 2, "sortable": false, "dataIndex": "text", "header": "text", "editable": false } ];
