...
// lino.js --- generated Mon May 20 05:16:19 2013 by Lino version 1.6.7.
...
Lino.ui.Home.DetailFormPanel = Ext.extend(Lino.FormPanel,{
  ...
  initComponent : function() {
    var containing_panel = this;
    var quick_links_htmlbox16 = new Lino.HtmlBoxPanel({ "flex": 1, "layout": "fit", "name": "quick_links", "containing_panel": this, "items": new Ext.BoxComponent({autoScroll:true}), "region": "north", "master_panel": this, "value": "<br/>", "always_enabled": true, "bodyStyle": "overflow-x:hidden", "split": true });
    var welcome_htmlbox17 = new Lino.HtmlBoxPanel({ "flex": 3, "layout": "fit", "name": "welcome", "containing_panel": this, "items": new Ext.BoxComponent({autoScroll:true}), "region": "center", "title": "Welcome", "master_panel": this, "value": "<br/>", "always_enabled": true, "bodyStyle": "overflow-x:hidden", "split": true });
    var main_panel18 = new Lino.VBorderPanel({ "autoScroll": false, "border": false, "labelWidth": 72, "hideCheckBoxLabels": true, "items": [ quick_links_htmlbox16, welcome_htmlbox17 ], "frame": true, "bodyBorder": false, "labelAlign": "top" });
    this.items = main_panel18;
    this.before_row_edit = function(record) {
      quick_links_htmlbox16.refresh();
      welcome_htmlbox17.refresh();
    }
...
Lino.quantityfield.ItemTable.GridPanel = Ext.extend(Lino.GridPanel,{
  ...
  initComponent : function() {
    ...
    var id21 = new Ext.form.NumberField({ "selectOnFocus": true });
    var name22 = new Ext.form.TextField({ "selectOnFocus": true, "allowBlank": false, "maxLength": 50 });
    var qty23 = new Ext.form.TextField({ "selectOnFocus": true, "boxMinWidth": Lino.chars2width(6), "allowBlank": false, "value": "1", "maxLength": 6 });
    var discount24 = new Ext.form.TextField({ "selectOnFocus": true, "boxMinWidth": Lino.chars2width(6), "allowBlank": false, "maxLength": 6 });
    var price25 = new Ext.form.NumberField({ "selectOnFocus": true, "decimalPrecision": 2, "allowBlank": false, "decimalSeparator": "," });
    this.before_row_edit = function(record) {
    };
    this.ls_columns = [ new Lino.NullNumberColumn({ "colIndex": 0, "sortable": true, "format": "0", "editable": true, "filter": { "type": "numeric" }, "header": "ID", "renderer": Lino.id_renderer, "editor": id21, "width": Lino.chars2width(6), "dataIndex": "id" }), { "colIndex": 1, "sortable": true, "header": "name", "editable": true, "filter": { "type": "string" }, "width": Lino.chars2width(22), "dataIndex": "name", "editor": name22 }, { "colIndex": 2, "sortable": true, "format": "", "align": "right", "editable": true, "filter": { "type": "string" }, "header": "qty", "dataIndex": "qty", "width": Lino.chars2width(8), "editor": qty23 }, { "colIndex": 3, "sortable": true, "format": "", "align": "right", "editable": true, "filter": { "type": "string" }, "header": "discount", "dataIndex": "discount", "width": Lino.chars2width(8), "editor": discount24 }, new Lino.NullNumberColumn({ "colIndex": 4, "sortable": true, "header": "price", "editable": true, "filter": { "type": "numeric" }, "width": Lino.chars2width(13), "dataIndex": "price", "editor": price25 }) ];
...
Lino.about.Models.GridPanel = Ext.extend(Lino.GridPanel,{
  ...
  initComponent : function() {
    ...
    var ww = this.containing_window;
    var app_disp27 = new Ext.form.DisplayField({ "disabled": true, "value": "<br/>", "always_enabled": true });
    var name_disp28 = new Ext.form.DisplayField({ "disabled": true, "value": "<br/>", "always_enabled": true });
    var docstring_disp29 = new Ext.form.DisplayField({ "disabled": true, "value": "<br/>", "always_enabled": true });
    var rows30 = new Ext.form.NumberField({ "disabled": true });
    var detail_action_disp31 = new Ext.form.DisplayField({ "disabled": true, "value": "<br/>", "always_enabled": true });
    this.before_row_edit = function(record) {
    };
...
Lino.about.SourceFiles.GridPanel = Ext.extend(Lino.GridPanel,{
  ...
  initComponent : function() {
    var ww = this.containing_window;
    var module_name33 = new Ext.form.TextField({ "disabled": true, "maxLength": null });
    var code_lines34 = new Ext.form.NumberField({ "disabled": true });
    var doc_lines35 = new Ext.form.NumberField({ "disabled": true });
    this.before_row_edit = function(record) {
    };
...
Lino.lino.Genders.GridPanel = Ext.extend(Lino.GridPanel,{
  ...
  initComponent : function() {
    var ww = this.containing_window;
    var value37 = new Ext.form.TextField({ "disabled": true, "maxLength": 20 });
    var name38 = new Ext.form.TextField({ "disabled": true, "maxLength": 20 });
    var text39 = new Ext.form.TextField({ "disabled": true, "maxLength": 50 });
    this.before_row_edit = function(record) {
    };
