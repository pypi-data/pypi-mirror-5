...
finalizeATCTSchema(SchoolSchema)
        


class School(ATFolder):
    """ The School content object. """
    ...
    def initializeArchetype(self, **kwargs):
        ...
        deftext = self.restrictedTraverse('@@school_view')
...
registerATCT(School, PROJECTNAME)
