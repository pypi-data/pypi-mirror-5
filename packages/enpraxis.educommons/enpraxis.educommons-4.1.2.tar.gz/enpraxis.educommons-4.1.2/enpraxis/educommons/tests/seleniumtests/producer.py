...
class NewTest(unittest.TestCase):
	...
	#Moves content through workflow limitation and ims checks("folder_delete:method"))
	...
	sel.wait_for_page_to_load("30000")
        sel.click("cb_test")
	#verification
	try: self.failUnless(not sel.is_text_present("Release Content for Publication  "))
	except AssertionError, e: self.verificationErrors.append(str(e))
	...
	#verification
	try: self.failUnless(not sel.is_text_present("IMS"))
	except AssertionError, e: self.verificationErrors.append(str(e))
