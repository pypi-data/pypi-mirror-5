...
def setup_product():
    ...
    import xhostplus.social
    zcml.load_config('configure.zcml', xhostplus.social)
    ...
    ztc.installPackage('xhostplus.social')
...
setup_product()
ptc.setupPloneSite(products=['xhostplus.social'])
