...
(function() {
  ...
  window.Controls.dashboard__dash = (function(_super) {
    ...
    dashboard__dash.prototype.createDom = function() {
      ...
      return this.dom.find('.container').sortable({
        ...
        tolerance: 'pointer',
        start: function() {
          return $(_this.dom).find('.trash').show();
        },
        stop: function() {
          var r;
          r = {};
          $(_this.dom).find('.trash').hide();
          $(_this.dom).find('.trash .control').remove();
          $(_this.dom).find('>.widget-container').each(function(i, c) {
            var index;
            index = parseInt($(c).attr('data-index'));
            r[index] = [];
            return $(c).find('>*').each(function(i, e) {
    ...
    dashboard__dash.prototype.append = function(child) {
      this.dom.find(".container-" + child.properties.container).append(child.dom);
  ...
  window.Controls.dashboard__widget = (function(_super) {
    ...
    dashboard__widget.prototype.createDom = function() {
      this.dom = $("<div data-uid=\"" + this.properties.uid + "\" class=\"control dashboard-widget\">\n    <div class=\"handle\"></div>\n    <div class=\"content\"></div>\n</div>");
      return this.childContainer = this.dom.find('.content');
    };
