...
(function() {
  ...
  window.Terminal = (function() {
    ...
    Terminal.prototype.draw = function(data) {
      ...
      return this.term.css({
        left: (window.innerWidth / 2 - this.term.width() / 2) + 'px',
        top: (20 + window.innerHeight / 2 - this.term.height() / 2) + 'px'
      });
    };
    ...
    Terminal.prototype.cells = function(row, idx) {
      var bg, bold, cell, ch, fg, i, iidx, it, misc, r, sty, und, _i, _ref;
      r = '<pre>';
      fg = 0;
      bg = 0;
      bold = 0;
      ...
      for (i = _i = 0, _ref = row.length; 0 <= _ref ? _i < _ref : _i > _ref; i = 0 <= _ref ? ++_i : --_i) {
        cell = row[i];
        iidx = parseInt(idx);
        if (true || bg !== cell[2] || fg !== cell[1] || (iidx === this.cursy && i === this.cursx) || (iidx === this.cursy && i === this.cursx + 1)) {
          misc = '';
          sty = '';
