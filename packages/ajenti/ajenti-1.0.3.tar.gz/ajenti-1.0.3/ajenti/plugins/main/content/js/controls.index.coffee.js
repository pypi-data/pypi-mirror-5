...
(function() {
  ...
  window.Controls.main__page = (function(_super) {
    ...
    main__page.prototype.createDom = function() {
      ...
      this.feedback = this.dom.find('.feedback');
      this.feedback.find('.box').hide();
      this.feedback.find('.activate').click(function() {
        return _this.feedback.find('.box').toggle();
      });
      return this.feedback.find('.box a').click(function() {
        _this.feedback.find('.box').hide();
        return _this.event('feedback', {
          email: _this.feedback.find('input').val(),
          text: _this.feedback.find('textarea').val()
        });
      });
    };
