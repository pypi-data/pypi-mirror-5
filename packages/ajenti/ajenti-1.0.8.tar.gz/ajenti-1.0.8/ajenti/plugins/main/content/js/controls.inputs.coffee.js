...
(function() {
  ...
  window.Controls.textbox = (function(_super) {
    ...
    textbox.prototype.createDom = function() {
      this.dom = $("<div>\n    <input class=\"control textbox " + this.properties.style + "\" \n        type=\"text\" />\n</div>");
      this.input = this.dom.find('input');
      return this.input.val(this.properties.value);
    };
  ...
  window.Controls.dropdown = (function(_super) {
    ...
    dropdown.prototype.createDom = function() {
      var i, _fn, _i, _ref,
        _this = this;
      this.dom = $("<div><select class=\"control dropdown\" /></div>");
      this.input = this.dom.find('select');
      this.data = [];
      _fn = function(i) {
        return _this.input.append("<option value=\"" + _this.properties.values[i] + "\" " + (_this.properties.values[i] === _this.properties.value ? 'selected' : '') + ">" + _this.properties.labels[i] + "</option>");
      };
  ...
  window.Controls.combobox = (function(_super) {
    ...
    combobox.prototype.createDom = function() {
      var i, _fn, _i, _ref,
        _this = this;
      this.dom = $("<div><input class=\"control combobox\" type=\"text\" value=\"" + this.properties.value + "\" /></div>");
      this.input = this.dom.find('input');
      this.data = [];
      _fn = function(i) {
