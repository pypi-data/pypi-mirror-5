# -*- coding: utf-8 -*-
#
# spyda documentation build configuration file, created by
...
exec(
    compile(
        open(
            path.abspath(path.join(path.dirname(__file__), "../../spyda/version.py")),
            "r"
        ).read(),
        "../../spyda/version.py", "exec"
    ),
...
bitbucket_project_url = 'https://bitbucket.org/prologic/spyda'
...
latex_documents = [
    (
        'index', 'spyda.tex', u'spyda Documentation',
