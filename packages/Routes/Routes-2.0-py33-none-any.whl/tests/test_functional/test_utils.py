...
class TestUtils(unittest.TestCase):
    ...
    def test_url_for_with_nongen(self):
        ...
        eq_('/blog?q=fred&q=here%20now', url_for('/blog', q=['fred', 'here now']))
    ...
    def test_url_for_with_unicode(self):
        ...
        eq_('/blog/view/umulat', url_for(controller='blog', action='view', id='umulat'))
        eq_('/blog/view/umulat?other=%CE%B1%CF%83%CE%B4%CE%B3', 
            url_for(controller='blog', action='view', id='umulat', other='\u03b1\u03c3\u03b4\u03b3'))
        
        url = URLGenerator(con.mapper, {})
        for urlobj in [url_for, url]:
            def raise_url():
                return urlobj('/some/st\xc3rng')
