...
class TestUtils(unittest.TestCase):
    ...
    def test_subdomain_screen(self):
        ...
        url = URLGenerator(m, environ)
        eq_('http://home.localhost.com/hi/smith', url(fred='smith', sub_domain='home', qualified=True))
        ...
        url = URLGenerator(m, {})
        eq_('/hi/smith', url(fred='smith', sub_domain='home'))
    ...
    def test_static_args(self):
        ...
        eq_('/here?q=fred&q=here%20now', url('/here', q=['fred', 'here now']))
