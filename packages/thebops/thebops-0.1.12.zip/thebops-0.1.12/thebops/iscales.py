...
__version__ = (0,
               ...
               4, # more formats (qHD, DSVGA, UWXGA ...); HUXGA changed/corrected
               'rev-%s' % '$Rev: 1008 $'[6:-2],
               )
...
for tup in (
        ...
        (3200, 1800, 'WQXGA+', 0),  # http://en.wikipedia.org/wiki/Graphics_display_resolution#WQXGA.2B_.283200x1800.29
