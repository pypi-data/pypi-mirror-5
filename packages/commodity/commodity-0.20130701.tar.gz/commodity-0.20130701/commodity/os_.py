...
#        self.outsink = kargs.pop('stdout', None)
#        self.errsink = kargs.pop('stderr', None)
#        self.shell   = kargs.pop('shell', None)
#        self.log     = checked_type(logging.Logger, kargs.pop('logger', log))
#        self._start  = checked_type(bool, kargs.pop('start', True))
#        self.signal  = checked_type(int, kargs.pop('signal', signal.SIGTERM))
#        self.close_outs = checked_type(bool, kargs.pop('close_outs', False))
