...
function refreshDatetimeTo(view)
{
	...
	$("input[id*='"+view+"_datepicker_to_']").datetimepicker('option', 'minDateTime', $("input[id*='"+view+"_datepicker_from_']").datetimepicker('getDate') );
...
function refreshDatetimeFrom(view)
{
	...
	$("input[id*='"+view+"_datepicker_from_']").datetimepicker('option', 'maxDateTime', $("input[id*='"+view+"_datepicker_to_']").datetimepicker('getDate') );
