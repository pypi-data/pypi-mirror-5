...
class Salida_Grid:
    ...
    def result_to_json(self,cube,result,database_cube_dict=[],isfilter=False,rowNum=500,page=0,total=False,complete_name=False):
    ...
    def mdx (self,cube,part_rows=[],range_rows=[],exclude_rows={},part_columns=[],part_from='',part_where={},part_order=[],part_filter={},part_NON_EMPTY=True,total_data=False,request_data={},part_ranking=[]):
        ...
        """
          ...
          **Args:**
                ...
                #. part_ranking: A list with differents values. An example is part_rank=["DESC","10",('Measure','Calls')]. The first value indicates how we want the order, the second how many rows will be return and the third the measure on which will do the ranking.
