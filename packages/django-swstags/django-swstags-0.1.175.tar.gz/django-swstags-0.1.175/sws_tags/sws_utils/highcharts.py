...
def paletteColor(name,spectrum):
	...
	dic_colors2={
		'combi0'	:['#FF00D1','#FF8CEA','#FFA200'],#pink
		'combi1'	:['#FFA200','#FFCD78','#9BF50A'],#orange
		'combi2'	:['#D0FF86','#FF00D1','#00FFD1'],#green
		'combi3'	:['#FFFFFF','#BEBEBE','#FF0000'],#white
		'combi4'	:['#0066FF','#8FBCFF','#FFFFFF'],#blue
		'combi5'	:['#01FE2A','#A9FFB7','#0066FF'],#green
		'combi6'	:['#048000','#5A8C59','#FF00D1'],#green2
		'combi7'	:['#00FFD1','#00FFD1','#048000'],#blue2
		'combi8'	:['#FF0000','#FF8484','#F3FF00'],#red
		'combi9'	:['#F3FF00','#FBFF9A','#01FE2A']#yellow
	}
...
def get_series(v_name,v_type,v_yAxis,v_data,v_color=[]):
	series = []
...
def requestSeriesHighcharts(dict_higcharts,list_color):
	...
	try:
		for i in range(0,len(dict_higcharts['v_name'])):
			...
			# dict_higcharts['v_yAxis'] = [0,1]
			# dict_higcharts['v_type'] = ['spline', 'areaspline']
...
def toMuchDataControl(request_data,dict_response):
	...
	# print 'total_data2--->',total_data
	# print 'agrupation data',request_data['agrupation_data']
	if num_column > 75:
		# dict_response = {}

		# print 'control Much data'
	...
	# if num_column > 50 and num_data > 1:
		...
		# print 'new agrupation data-->',request_data['agrupation_data']
		# time.sleep(5)
