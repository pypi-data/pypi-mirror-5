...
def updateDateTz(request_data):
    ...
    #### part datetime stonework from to
    from_dsn = stonework_tz.normalize(request_data ['from_Date_tz'])
    to_dsn = stonework_tz.normalize(request_data ['to_Date_tz'])
    # print 'FROM DSD',from_dsn
    # print 'TO DSD',to_dsn


    request_data ['from_Date_sw'] = datetime( from_dsn.year,from_dsn.month,from_dsn.day,from_dsn.hour,from_dsn.minute,from_dsn.second,tzinfo=stonework_tz)
    request_data ['to_Date_sw'] = datetime( to_dsn.year,to_dsn.month,to_dsn.day,to_dsn.hour,to_dsn.minute,to_dsn.second,tzinfo=stonework_tz)
    
    request_data ['from_Date_sw']=strToDatetime(str(request_data ['from_Date_sw'])[0:19])
    request_data ['to_Date_sw'] = strToDatetime(str(request_data ['to_Date_sw'])[0:19])
    ...
    # print 'stonework_tz',stonework_tz
    ...
    # print 'FROM DATE request_data_user--->',request_data['from_Date_tz'].replace(tzinfo=selected_tz)
    # print 'TO DATE request_data_user----->',request_data['to_Date_tz'].replace(tzinfo=selected_tz)
    # print 'from_Date_tz_sw',request_data ['from_Date_tz_sw']
    # print 'to_Date_tz_sw',request_data ['to_Date_tz_sw']
...
#     # print 'FROM DATE request_data--->',request_data['from_Date']
#     # print 'TO DATE request_data----->',request_data['to_Date']
#     # print 'FROM DATE request_data_user--->',request_data['from_Date_tz']
#     # print 'TO DATE request_data_user----->',request_data['to_Date_tz']
#     print '************************************************************************************************************'
