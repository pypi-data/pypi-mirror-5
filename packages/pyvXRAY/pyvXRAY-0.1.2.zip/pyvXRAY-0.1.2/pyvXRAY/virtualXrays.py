...
from cythonMods import createElementMap, LinearTetSF, QuadTetSF
...
def createVirtualXrays(bPartName,bSetName,BMDfoname,showImplant,iPartName,iSetName,
    ...
    if bElemType=='C3D4' : tetShapeFunction = LinearTetSF
    if bElemType=='C3D10': tetShapeFunction = QuadTetSF
    if showImplant: 
