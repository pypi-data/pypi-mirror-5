...
class SCIPAMPL(SystemCallSolver):
    ...
    pyutilib.component.core.alias('scip', doc='The SCIP LP/MIP solver')
    ...
    def executable(self):
        ...
        if executable is None:
            pyutilib.component.core.PluginGlobals.env().log.warning("Could not locate the 'scipampl' executable, which is required for solver %s" % self.name)
            self.enable = False
            return None
