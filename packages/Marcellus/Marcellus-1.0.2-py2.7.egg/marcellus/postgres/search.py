                ...
                if operador in ['#', '!']:
                    ...
                    # texto (o cualquier otra cosa)
                        ...
                        # es nulo
                            ...
                            sql.append('TRIM(COALESCE(CAST("%s" as Text), \'\')) = \'%s\'' % (c.encode('utf-8'), campos[1]))
                    ...
                    for termino2 in terminos2:
                        ...
                        # texto (o cualquier otra cosa)
                            ...
                            if operador == '=':
                                expresion = "UPPER(CAST(\"%s\" as Text)) ~ UPPER('%%%s%%')" % \
                            ...
                            # rest of types
                                ...
                                if col_name != 'id' and not col_name.startswith('id_') and not col_name.startswith('_') and not is_date and not is_time:
                                    try:
                                        ...
                                        texto  = "(CAST(\"%s\" as Text) <> '' AND UPPER(CAST(\"%s\" as Text)) ~ UPPER('%%%s%%'))" % args_
