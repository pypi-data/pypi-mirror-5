...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CorreiosCarrier.esedex_code'
        db.add_column('shipping_correioscarrier', 'esedex_code',
                      self.gf('django.db.models.fields.CharField')(max_length=5, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CorreiosCarrier.esedex_code'
        db.delete_column('shipping_correioscarrier', 'esedex_code')
    ...
    models = {
        ...
        'shipping.correioscarrier': {
            ...
            'esedex_code': ('django.db.models.fields.CharField', [], {'max_length': '5', 'null': 'True'}),
