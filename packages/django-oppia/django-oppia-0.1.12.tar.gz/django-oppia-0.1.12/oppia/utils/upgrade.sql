...
INSERT INTO oppia_coursedownload (id,user_id, course_id,download_date,course_version) SELECT id,user_id, module_id,download_date,course_version FROM learning_modules_moduledownload;
