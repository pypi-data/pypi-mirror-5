...
def setup_product():
    ...
    import zettwerk.clickmap
    zcml.load_config('configure.zcml', zettwerk.clickmap)
    ...
    ztc.installPackage('zettwerk.clickmap')
...
setup_product()
ptc.setupPloneSite(products=['zettwerk.clickmap'])
